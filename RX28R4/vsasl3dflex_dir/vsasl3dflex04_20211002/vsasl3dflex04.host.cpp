...
#include "vsasl3dflex04.hostdecl.h"
#include "vsasl3dflex04.exportstr.h"
#include "vsasl3dflex04.runtime.h"
...
int cveval()
{
	...
	cvdef(opuser6, 2.1);
	opuser6  = _opuser6.fixedflag ?  ((void)(2.1), opuser6) : 2.1;
	cvmin(opuser6, 0);
	cvmax(opuser6, 4);
	spiralGmax  = _spiralGmax.fixedflag ?  ((void)(opuser6), spiralGmax) : opuser6;

	gtype  = _gtype.fixedflag ?  ((void)(0), gtype) : 0;
	...
	if(((int)opuser12) == 1)  {
		...
		pwrf2  = _pwrf2.fixedflag ?  ((void)(3200), pwrf2) : 3200;
	...
	cvmin(opuser16, 0.);
	cvmax(opuser16, 1.0);
	doBS  = _doBS.fixedflag ?  ((void)(opuser16), doBS) : opuser16;


	cvdesc(opuser17, "Target Velocity of the blood to be labeled. (cm/s)");
	cvdef(opuser17, 0);
	opuser17  = _opuser17.fixedflag ?  ((void)(0), opuser17) : 0;
	cvmin(opuser17, -300);
	cvmax(opuser17, 300);
	vel_target  = _vel_target.fixedflag ?  ((void)(opuser17), vel_target) : opuser17;
	...
	cvmax(opuser20, 1);
	cvdef(opuser20,0);
	opuser20  = _opuser20.fixedflag ?  ((void)(0), opuser20) : 0;
	doArtSup  = _doArtSup.fixedflag ?  ((void)(opuser20), doArtSup) : opuser20;
	...
	cvmax(opuser22, 200);
	cvdef(opuser22,100);
	opuser22  = _opuser22.fixedflag ?  ((void)(100), opuser22) : 100;
	AStime  = _AStime.fixedflag ?  ((void)(RUP_GRD(opuser22*1000)), AStime) : RUP_GRD(opuser22*1000);
	...
	delta_y = _delta_y.fixedflag ?  ((void)(opuser25), delta_y) : opuser25;

	cvdesc(opuser26,"Stripe width (cm) ");
	cvmin(opuser26,0);
	cvmax(opuser26, 100);
	cvdef(opuser26,10);
	opuser26  = _opuser26.fixedflag ?  ((void)(10), opuser26) : 10;
	yfov = _yfov.fixedflag ?  ((void)(opuser26), yfov) : opuser26;

	cvdesc(opuser27,"Stripe axis: 0=no stripe , 1=Y, 2=X, 3=Z ");
	cvmin(opuser27,0);
	cvmax(opuser27, 3);
	cvdef(opuser27,1);
	opuser27  = _opuser27.fixedflag ?  ((void)(0), opuser27) : 0;
	doRotated90  = _doRotated90.fixedflag ?  ((void)(opuser27), doRotated90) : opuser27;
	...
	astseqtime  = _astseqtime.fixedflag ?      ((void)(pw_vsitag1+mytpre+timessi), astseqtime) : pw_vsitag1+mytpre+timessi;
	t_tag  = _t_tag.fixedflag ?     ((void)(vsi_Ncycles*(vsi_timegap+astseqtime)), t_tag) : vsi_Ncycles*(vsi_timegap+astseqtime);
	...
	t_tag  = _t_tag.fixedflag ?       ((void)(vsi_Ncycles*(vsi_timegap+astseqtime)-vsi_timegap), t_tag) : vsi_Ncycles*(vsi_timegap+astseqtime)-vsi_timegap;
	...
	*/
	...
	my_maxB1Seq  = _my_maxB1Seq.fixedflag ?    ((void)(1000*maxB1Seq), my_maxB1Seq) : 1000*maxB1Seq;// convert from Gauss to mGauss
	...
	if(opuser12 == 1){
		my_maxB1Seq  = _my_maxB1Seq.fixedflag ?  ((void)(2*my_maxB1Seq), my_maxB1Seq) : 2*my_maxB1Seq;
		maxB1Seq = 2*maxB1Seq;
	}
	fprintf(stderr, "\nmy_maxB1Seq=%.4f\n", my_maxB1Seq);
	...
	pw_gzrf1  = _pw_gzrf1.fixedflag ?  ((void)(pwrf1), pw_gzrf1) : pwrf1;
	pw_gzrf2  = _pw_gzrf2.fixedflag ?  ((void)(pwrf2), pw_gzrf2) : pwrf2;
	...
	pw_gzrf2a  = _pw_gzrf2a.fixedflag ?  ((void)(myramptime), pw_gzrf2a) : myramptime;
	pw_gzrf2d  = _pw_gzrf2d.fixedflag ?  ((void)(myramptime), pw_gzrf2d) : myramptime;

	pw_rf1  = _pw_rf1.fixedflag ?  ((void)(pwrf1), pw_rf1) : pwrf1;
	pw_rf2  = _pw_rf2.fixedflag ?  ((void)(pwrf2), pw_rf2) : pwrf2;
	/*------*/
	...
	if (doArtSup)
	{
		 a_ASrf_mag   = _a_ASrf_mag.fixedflag ?   ((void)((ArtSup_B1max/my_maxB1Seq)), a_ASrf_mag) : (ArtSup_B1max/my_maxB1Seq);
		 ia_ASrf_mag  = _ia_ASrf_mag.fixedflag ?    ((void)(a_ASrf_mag*max_pg_iamp), ia_ASrf_mag) : a_ASrf_mag*max_pg_iamp;
		 a_ASrf_grad   = _a_ASrf_grad.fixedflag ?  ((void)(ArtSup_Gmax), a_ASrf_grad) : ArtSup_Gmax;
		 ia_ASrf_grad  = _ia_ASrf_grad.fixedflag ?    ((void)(a_ASrf_grad*max_pg_iamp), ia_ASrf_grad) : a_ASrf_grad*max_pg_iamp;
	}


	/* ----------------------------------------------------------------------------------------*/
	/* Calculate the  z phase-encode gradient params */
	zfov  = _zfov.fixedflag ?  ((void)((double)opslquant*opslthick/10), zfov) : (double)opslquant*opslthick/10;  /* in cm ! */
	if (doRotated90==0) yfov  = _yfov.fixedflag ?  ((void)(zfov), yfov) : zfov;  /* if we are not rotating the 90, then the slab thickness should be the same as for the 180*/
	...
	ampGzstep  = _ampGzstep.fixedflag ?  ((void)(0), ampGzstep) : 0;
	...
	a_BS0rf  = _a_BS0rf.fixedflag ?  ((void)(0), a_BS0rf) : 0;
	a_gzBS0rfspoiler  = _a_gzBS0rfspoiler.fixedflag ?  ((void)(0), a_gzBS0rfspoiler) : 0;
	...
	pw_gz180crush1  = _pw_gz180crush1.fixedflag ?  ((void)(20), pw_gz180crush1) : 20;
	pw_gz180crush2  = _pw_gz180crush2.fixedflag ?  ((void)(pw_gz180crush1), pw_gz180crush2) : pw_gz180crush1;


	pw_gz180crush1a  = _pw_gz180crush1a.fixedflag ?  ((void)(myramptime), pw_gz180crush1a) : myramptime;
	pw_gz180crush2a  = _pw_gz180crush2a.fixedflag ?  ((void)(pw_gz180crush1a), pw_gz180crush2a) : pw_gz180crush1a;


	pw_gz180crush1d  = _pw_gz180crush1d.fixedflag ?  ((void)(myramptime), pw_gz180crush1d) : myramptime;
	pw_gz180crush2d  = _pw_gz180crush2d.fixedflag ?  ((void)(pw_gz180crush1d), pw_gz180crush2d) : pw_gz180crush1d;


	/*---------------------------*/
	if (mrf_mode) doBS  = _doBS.fixedflag ?  ((void)(0), doBS) : 0;

	if (doBS==0){
		BS1_time  = _BS1_time.fixedflag ?  ((void)(10000), BS1_time) : 10000;
		BS2_time  = _BS2_time.fixedflag ?  ((void)(10000), BS2_time) : 10000;
	}

	BStime  = _BStime.fixedflag ?       ((void)(BS1_time+BS2_time+pw_BS2rf/2), BStime) : BS1_time+BS2_time+pw_BS2rf/2; /* + pw_BS0rf + pw_gzBS0 + 2*pw_gzBS0a; */
	/*---------------------------*/
	...
	t_tipdown_core  = _t_tipdown_core.fixedflag ?        ((void)(RUP_GRD(opte/2-pw_gz180crush1-2*pw_gz180crush1a+timessi)), t_tipdown_core) : RUP_GRD(opte/2-pw_gz180crush1-2*pw_gz180crush1a+timessi);

	t_refocus_core  = _t_refocus_core.fixedflag ?  
		 
		   
		   
		  
		 ((void)(RUP_GRD(tlead+pw_gz180crush1+2*pw_gz180crush1a+pw_gz180crush2+2*pw_gz180crush2a+pw_gzrf2+2*pw_gzrf2a+timessi)), t_refocus_core) : RUP_GRD(tlead+pw_gz180crush1+2*pw_gz180crush1a+pw_gz180crush2+2*pw_gz180crush2a+pw_gzrf2+2*pw_gzrf2a+timessi);

	t_seqcore  = _t_seqcore.fixedflag ?  
		             ((void)(RUP_GRD(opte-2*(pw_gz180crush2+2*pw_gz180crush2a)-(pw_gzrf2+2*pw_gzrf2a)+timessi)), t_seqcore) : RUP_GRD(opte-2*(pw_gz180crush2+2*pw_gz180crush2a)-(pw_gzrf2+2*pw_gzrf2a)+timessi);

	/* duration of the whole readout  */
	seqtr  = _seqtr.fixedflag ?        ((void)(t_tipdown_core+(t_refocus_core+t_seqcore)*opslquant), seqtr) : t_tipdown_core+(t_refocus_core+t_seqcore)*opslquant;

	/* duration of the whole sequence */
	psdseqtime  = _psdseqtime.fixedflag ?            ((void)(seqtr+t_tag+t_delay+AStime+textra_astcore+textra_delaycore), psdseqtime) : seqtr+t_tag+t_delay+AStime+textra_astcore+textra_delaycore;

	/* Left over time to fille the TR */
	t_adjust  = _t_adjust.fixedflag ?    ((void)(RUP_GRD(optr-psdseqtime)), t_adjust) : RUP_GRD(optr-psdseqtime);                 /* LHG 7.18.18 */

	readpos  = _readpos.fixedflag ?   
			   
			    
			 ((void)(RUP_GRD(opte/2.0-pw_gzrf2/2.0-pw_gzrf2a-pw_gz180crush2-2*pw_gz180crush2a-FID_dur/2)), readpos) : RUP_GRD(opte/2.0-pw_gzrf2/2.0-pw_gzrf2a-pw_gz180crush2-2*pw_gz180crush2a-FID_dur/2);
	...
	flip_rf2  = _flip_rf2.fixedflag ?  ((void)(myflip_rf2), flip_rf2) : myflip_rf2;
	a_vsitag1  = _a_vsitag1.fixedflag ?   ((void)(vsi_RFmax/my_maxB1Seq), a_vsitag1) : vsi_RFmax/my_maxB1Seq;
	a_vsictl1  = _a_vsictl1.fixedflag ?   ((void)(vsi_RFmax/my_maxB1Seq), a_vsictl1) : vsi_RFmax/my_maxB1Seq;

	a_rf1  = _a_rf1.fixedflag ?   ((void)(opflip/180), a_rf1) : opflip/180;
	a_rf2  = _a_rf2.fixedflag ?   ((void)(myflip_rf2/180), a_rf2) : myflip_rf2/180;
	...
	ia_vsitag1  = _ia_vsitag1.fixedflag ?    ((void)(a_vsitag1*max_pg_iamp), ia_vsitag1) : a_vsitag1*max_pg_iamp;
	ia_vsictl1  = _ia_vsictl1.fixedflag ?    ((void)(a_vsictl1*max_pg_iamp), ia_vsictl1) : a_vsictl1*max_pg_iamp;
...
int predownload()
{
	...
	Npoints  = _Npoints.fixedflag ?     ((void)(read_vsi_pulse(ArtSup_mag,ArtSup_phs,ArtSup_grad,ArtSup_len)), Npoints) : read_vsi_pulse(ArtSup_mag,ArtSup_phs,ArtSup_grad,ArtSup_len);

	/* LHG 9.27.16 : Timing calculation from the VSI sequence... */
	/* Npoints and vsi_train_len should come out the same ... good sanity check */
	Npoints  = _Npoints.fixedflag ?     ((void)(read_vsi_pulse(vsi_pulse_mag,vsi_pulse_phs,vsi_pulse_grad,vsi_train_len)), Npoints) : read_vsi_pulse(vsi_pulse_mag,vsi_pulse_phs,vsi_pulse_grad,vsi_train_len);
...
2*pw_gzspoila);
	...
	*/
	...
	gfov  = _gfov.fixedflag ?  ((void)(opfov*.1), gfov) : opfov*.1;   /*gfov is in cm, opfov is in mm */
	...
	Kmax  = _Kmax.fixedflag ?   ((void)(opxres/gfov), Kmax) : opxres/gfov;  /* cm^-1*/
	deltaK  = _deltaK.fixedflag ?   ((void)(1/gfov), deltaK) : 1/gfov;
	FID_len  = _FID_len.fixedflag ?   ((void)((int)(Kmax*Kmax/deltaK/deltaK/4)), FID_len) : (int)(Kmax*Kmax/deltaK/deltaK/4);
	/* covering a circle, not a square:
	area of square= X^2
	area of circle inside:  (X/2)^2 * PI
	so .... */
	FID_len  = _FID_len.fixedflag ?   ((void)((int)(FID_len/(3.14259*0.5*0.5))), FID_len) : (int)(FID_len/(3.14259*0.5*0.5));
	/*now adjust for number of interleaves */
	FID_len  = _FID_len.fixedflag ?  ((void)(FID_len/nl), FID_len) : FID_len/nl;
	FID_dur  = _FID_dur.fixedflag ?  ((void)((int)(FID_len*tsp)), FID_dur) : (int)(FID_len*tsp); /* microseconds*/
	...
	while(slowDown>1.0)
	{
		...
		Grad_len  = _Grad_len.fixedflag ?  ((void)((int)(FID_dur/4.0)), Grad_len) : (int)(FID_dur/4.0); /* n. samples for gradient waveform */
		...
		FID_dur  = _FID_dur.fixedflag ?    ((void)(FID_dur*slowDown), FID_dur) : FID_dur*slowDown;
		FID_len  = _FID_len.fixedflag ?   ((void)((int)(FID_dur/tsp)), FID_len) : (int)(FID_dur/tsp);
	...
	pw_gx  = _pw_gx.fixedflag ?  ((void)((int)(FID_dur)), pw_gx) : (int)(FID_dur);
	pw_gy  = _pw_gy.fixedflag ?  ((void)((int)(FID_dur)), pw_gy) : (int)(FID_dur);
	pw_gz  = _pw_gz.fixedflag ?  ((void)((int)(FID_dur)), pw_gz) : (int)(FID_dur);
	...
	for (i=0; i<Grad_len; i++)  {
		if (fabs(pfGx[i])>spiralGxmax) spiralGxmax  = _spiralGxmax.fixedflag ?  ((void)(fabs(pfGx[i])), spiralGxmax) : fabs(pfGx[i]);
		if (fabs(pfGy[i])>spiralGymax) spiralGymax  = _spiralGymax.fixedflag ?  ((void)(fabs(pfGy[i])), spiralGymax) : fabs(pfGy[i]);
		if (fabs(pfGz[i])>spiralGzmax) spiralGzmax  = _spiralGzmax.fixedflag ?  ((void)(fabs(pfGz[i])), spiralGzmax) : fabs(pfGz[i]);
...
#include "predownload.in"
	...
	******/
	...
	/*LHG 11/155555/2018 */
	a_rf0  = _a_rf0.fixedflag ?  ((void)(0.14), a_rf0) : 0.14;
	...
	if ((exist(opcgate) == PSD_ON) && existcv(opcgate))
	{
		...
		pitscan  = _pitscan.fixedflag ?  ((void)((float)(optr)*nbang), pitscan) : (float)(optr)*nbang;
	...
	/*-------------------------------------------------*/
	minte  = _minte.fixedflag ?    ((void)(pw_gzrf2+2*pw_gzrf2d), minte) : pw_gzrf2+2*pw_gzrf2d;
	minte  = _minte.fixedflag ?    ((void)(pw_gz180crush1+2*pw_gz180crush1d), minte) : minte+pw_gz180crush1+2*pw_gz180crush1d;
	minte  = _minte.fixedflag ?    ((void)(pw_gz180crush2+2*pw_gz180crush2d), minte) : minte+pw_gz180crush2+2*pw_gz180crush2d;
	minte  = _minte.fixedflag ?  ((void)(FID_dur), minte) : minte+FID_dur;
	minte  = _minte.fixedflag ?    ((void)(4), minte) : minte+4;
	minte  = _minte.fixedflag ?  ((void)(2*timessi), minte) : minte+2*timessi; /*allow time for the SSI packets in 3 cores */
...
*/
	...
	rhfrsize  = _rhfrsize.fixedflag ?  ((void)((res_gx)*4/tsp), rhfrsize) : (res_gx)*4/tsp;      /* num points sampled */
...
{ /* Start of code inlined from Prescan.e PSpredownload */
	...
	if (mrf_mode)
	{
		M0frames  = _M0frames.fixedflag ?  ((void)(0), M0frames) : 0;
		doBS  = _doBS.fixedflag ?  ((void)(0), doBS) : 0;
		...
		if(fpin=fopen("/usr/g/bin/t_delays.txt", "r")) {     /* look for ext. file */
			...
			mrf_mode = _mrf_mode.fixedflag ? ((void)(0), mrf_mode) : 0;
		}
...
#include "vsasl3dflex04.cvcopy.cpp"
