...
#ifndef h_vsasl3dflex04_allcv_h
#define h_vsasl3dflex04_allcv_h
...
int t_refocus_core = 0;	/*time it takes to play out the 180 core: spoilers and 180 */
int t_seqcore = 0; 	/* time it takes to play the readout only  */
...
int 	t_adjust= 1500000;           /*delay before ast pulse to make up the rest of the TR */
int 	t_adjust_fudge = 14000;     /* error in the t_adjust (not clear yet why) */
...
float	vsi_RFmax = 234 ; /* 234 mGauss. Peak B1 of the pulse train
...
float 	ArtSup_Gmax = 1.0; /* default gradient max aplitude in arterial suppression pulse train */
float 	ArtSup_B1max = 200; /* default B1 max aplitude in arterial suppressin pulse train */
