...
int cveval()
{
	...
	if(((int)opuser12) == 1)  {
		...
		cycrf2  = _cycrf2.fixedflag ?  ((void)(2), cycrf2) : 2;
		...
		cycrf2  = _cycrf2.fixedflag ?  ((void)(4), cycrf2) : 4;
		pwrf1  = _pwrf1.fixedflag ?  ((void)(6400), pwrf1) : 6400;
		pwrf2  = _pwrf2.fixedflag ?  ((void)(6400), pwrf2) : 6400;
	}
...
// No need for this scaling?
	...
	*/
	...
	a_gz180crush1  = _a_gz180crush1.fixedflag ?  ((void)(1.5), a_gz180crush1) : 1.5;
...
2*pw_gzspoila);
	...
	*/
	...
	while( (slowDown-1.0)*(slowDown-1.0) >  0.0001 )
	{
		...
		if( (slowDown-1)*(slowDown-1) >  0.0001 )	FID_dur  = _FID_dur.fixedflag ?    ((void)(FID_dur*slowDown), FID_dur) : FID_dur*slowDown;
