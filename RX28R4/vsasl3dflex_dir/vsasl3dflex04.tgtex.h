...
#ifndef h_vsasl3dflex04_tgtex_h
#define h_vsasl3dflex04_tgtex_h
...
int Gz[GRESMAX]= {0};
float pfGx[GRESMAX]= {0};
float pfGy[GRESMAX]= {0};
float pfGz[GRESMAX]= {0};
