 ...
 * these variables.
 *
 * Generated on Fri Dec 17 10:13:54 2021 
 */

#ifndef h_vsasl3dflex05_cvcopy_cpp
#define h_vsasl3dflex05_cvcopy_cpp

#include "cvcopy_proto.h"

#if defined(PSD_HW) && defined(HOST_TGT)
/* Include endian converter functions */
#include "vsasl3dflex05.cnvendian.globalvar.h"
#include "vsasl3dflex05.cnvendian.c"
...
static const cvcopy_table_entry cvcopy_table[] = {
    ...
    { &pfGy, sizeof(pfGy) },
    { &pfGz, sizeof(pfGz) },
    { &kzfraction, sizeof(kzfraction) },
    { &kzorder, sizeof(kzorder) },
...
void cvcopy_cnv_endian( char * data )
{
    ...
    cv_cnv_endian_myFID_dur( data );
    data += sizeof(myFID_dur);
    ...
    cv_cnv_endian_kzfraction( data );
    data += sizeof(kzfraction);

    cv_cnv_endian_kzorder( data );
    data += sizeof(kzorder);
...
#endif /* h_vsasl3dflex05_cvcopy_cpp */
