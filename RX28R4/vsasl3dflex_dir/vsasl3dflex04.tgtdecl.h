...
#ifndef h_vsasl3dflex04_tgtdecl_h
#define h_vsasl3dflex04_tgtdecl_h
...
extern PSD_EXIT_ARG psdexitarg;
  ...
  SEQUENCE_ENTRIES  off_refocus_core;
  WF_PULSE refocus_core;
#if defined(HOST_TGT)
  int idx_refocus_core;   /* sequence entry index */
#endif
  ...
  SEQUENCE_ENTRIES  off_art_fat_suppress_core;
  WF_PULSE art_fat_suppress_core;
#if defined(HOST_TGT)
  int idx_art_fat_suppress_core;   /* sequence entry index */
#endif
...
#endif /* h_vsasl3dflex04_tgtdecl_h */
