...
int gating = 0x07 ;
int psdseqtime = 0;
int t_tipdown_core = 0;
int t_refocus_core = 0;
int t_seqcore = 0;
int timessi=120 ;
int trerror = 0;
int nerror = 0;
...
int pwrf2 = 6400 ;
int cycrf2 = 4;
float myflip_rf2 = 180;
float start_rf2 = 120;
float phs_rf2 = 1.5708;
int domap = 1 ;
int mapdel = 2000;
int bmapnav = 1 ;
int off_fov = 1 ;
float tsp = 4.0 ;
float bandwidth = 85.0 ;
...
int astseqtime = 0;
int astseqtime2 = 0;
int t_adjust= 1500000;
int t_adjust_fudge = 14000;
int delta1 = 0 ;
int isLabel=0;
int mycontrol=0;
int xres=64;
int mrf_mode = 0;
int vsi_controlmode = 5 ;
...
int myramptime = 260;
float vsi_Gmax = 1.5;
float vsi_Gcontrol = 3.0 ;
float vel_target = 0;
int vsi_Ncycles = 1;
int M0frames = 2;
int isOdd = 0;
float vsi_RFmax = 234 ;
float vsi_RFmax_calstep = 10;
float my_maxB1Seq = 0 ;
int vsi_train_len = 250;
int Npoints = 0;
float vsi_velocity = 0;
int vsi_timegap = 1150000;
float ArtSup_Gmax = 1.5;
float ArtSup_B1max = 234;
int ArtSup_len = 6850;
int multiFlipFlag = 0;
int multiphsFlag = 0;
int nfr_phs = 2;
...
s32 savrot[2*(2048)][9]= {{0}};
float xi[1000]= {0};
float psi[1000]= {0};
float phi[1000]= {0};
float kzf[1000]= {0};
float rotmatrices[1000][9]= {{0}};
...
int ArtSup_mag[50000]= {0};
int ArtSup_phs[50000]= {0};
int ArtSup_grad[50000]= {0};
float t_delay_array[1000]= {0};
float t_adjust_array[1000]= {0};
float AStime_array[1000]= {0};
int isVelocitySelective_array[1000]= {0};
int doArtSuppression_array[1000]= {0};
long out_t_delay_array[1000]= {0};
long out_t_adjust_array[1000]= {0};
long out_t_aq_array[1000]= {0};
long out_isVelocitySelective[1000]= {0};
long ctrl_word= {0};
int tcounter = 0;
long _lasttgtex = 0;
