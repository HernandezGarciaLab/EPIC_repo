 ...
 * these variables.
 *
 * Generated on Mon Apr 25 19:27:57 2022 
 */

#ifndef h_vsasl3dflex04_cvcopy_cpp
#define h_vsasl3dflex04_cvcopy_cpp

#include "cvcopy_proto.h"

#if defined(PSD_HW) && defined(HOST_TGT)
/* Include endian converter functions */
#include "vsasl3dflex04.cnvendian.globalvar.h"
#include "vsasl3dflex04.cnvendian.c"
...
static const cvcopy_table_entry cvcopy_table[] = {
    ...
    { &t_refocus_core, sizeof(t_refocus_core) },
    ...
    { &pwrf2, sizeof(pwrf2) },
    { &cycrf2, sizeof(cycrf2) },
    { &myflip_rf2, sizeof(myflip_rf2) },
    { &start_rf2, sizeof(start_rf2) },
    { &phs_rf2, sizeof(phs_rf2) },
    { &domap, sizeof(domap) },
    ...
    { &t_adjust_fudge, sizeof(t_adjust_fudge) },
    { &delta1, sizeof(delta1) },
    { &isLabel, sizeof(isLabel) },
    { &mycontrol, sizeof(mycontrol) },
    { &xres, sizeof(xres) },
    { &mrf_mode, sizeof(mrf_mode) },
    { &vsi_controlmode, sizeof(vsi_controlmode) },
    { &vsi_axis_default, sizeof(vsi_axis_default) },
    { &vsi_axis, sizeof(vsi_axis) },
    { &vsi_rotax, sizeof(vsi_rotax) },
    { &vsi_rfdelay, sizeof(vsi_rfdelay) },
    { &vsi_flip, sizeof(vsi_flip) },
    { &myramptime, sizeof(myramptime) },
    { &vsi_Gmax, sizeof(vsi_Gmax) },
    { &vsi_Gcontrol, sizeof(vsi_Gcontrol) },
    { &vel_target, sizeof(vel_target) },
    { &vsi_Ncycles, sizeof(vsi_Ncycles) },
    { &M0frames, sizeof(M0frames) },
    { &isOdd, sizeof(isOdd) },
    { &vsi_RFmax, sizeof(vsi_RFmax) },
    { &vsi_RFmax_calstep, sizeof(vsi_RFmax_calstep) },
    { &my_maxB1Seq, sizeof(my_maxB1Seq) },
    { &vsi_train_len, sizeof(vsi_train_len) },
    { &Npoints, sizeof(Npoints) },
    { &vsi_velocity, sizeof(vsi_velocity) },
    { &vsi_timegap, sizeof(vsi_timegap) },
    { &ArtSup_Gmax, sizeof(ArtSup_Gmax) },
    { &ArtSup_B1max, sizeof(ArtSup_B1max) },
    { &ArtSup_len, sizeof(ArtSup_len) },
    { &multiFlipFlag, sizeof(multiFlipFlag) },
    { &multiphsFlag, sizeof(multiphsFlag) },
    { &nfr_phs, sizeof(nfr_phs) },
    { &vsi_TrigType, sizeof(vsi_TrigType) },
    ...
    { &Kmax, sizeof(Kmax) },
    { &deltaK, sizeof(deltaK) },
    { &FID_len, sizeof(FID_len) },
    { &Grad_len, sizeof(Grad_len) },
    { &FID_dur, sizeof(FID_dur) },
    ...
    { &spiralGmax, sizeof(spiralGmax) },
    { &myGmax_check, sizeof(myGmax_check) },
    { &spiralGxmax, sizeof(spiralGxmax) },
    { &spiralGymax, sizeof(spiralGymax) },
    { &spiralGzmax, sizeof(spiralGzmax) },
    { &kill_rx_phase, sizeof(kill_rx_phase) },
    { &doRotated90, sizeof(doRotated90) },
    { &yfov, sizeof(yfov) },
    { &delta_y, sizeof(delta_y) },
    { &fillrotations, sizeof(fillrotations) },
    ...
    { &doBS, sizeof(doBS) },
    { &doArtSup, sizeof(doArtSup) },
    { &t_preBS, sizeof(t_preBS) },
    { &AStime, sizeof(AStime) },
    ...
    { &textra_vsi_gapcore, sizeof(textra_vsi_gapcore) },
    { &textra, sizeof(textra) },
    { &fat_chemshift, sizeof(fat_chemshift) },
    { &flip_vsitag1, sizeof(flip_vsitag1) },
    { &wg_vsitag1, sizeof(wg_vsitag1) },
    { &xmtaddScan, sizeof(xmtaddScan) },
    { &TX_scale, sizeof(TX_scale) },
    ...
    { &a_vsitag1, sizeof(a_vsitag1) },
    { &ia_vsitag1, sizeof(ia_vsitag1) },
    { &pw_vsitag1, sizeof(pw_vsitag1) },
    { &res_vsitag1, sizeof(res_vsitag1) },
    { &a_vsitag1_theta, sizeof(a_vsitag1_theta) },
    { &ia_vsitag1_theta, sizeof(ia_vsitag1_theta) },
    { &pw_vsitag1_theta, sizeof(pw_vsitag1_theta) },
    { &res_vsitag1_theta, sizeof(res_vsitag1_theta) },
    { &a_gztag1, sizeof(a_gztag1) },
    { &ia_gztag1, sizeof(ia_gztag1) },
    { &pw_gztag1, sizeof(pw_gztag1) },
    { &res_gztag1, sizeof(res_gztag1) },
    { &a_vsictl1, sizeof(a_vsictl1) },
    { &ia_vsictl1, sizeof(ia_vsictl1) },
    { &pw_vsictl1, sizeof(pw_vsictl1) },
    { &res_vsictl1, sizeof(res_vsictl1) },
    { &a_vsictl1_theta, sizeof(a_vsictl1_theta) },
    { &ia_vsictl1_theta, sizeof(ia_vsictl1_theta) },
    { &pw_vsictl1_theta, sizeof(pw_vsictl1_theta) },
    { &res_vsictl1_theta, sizeof(res_vsictl1_theta) },
    { &a_gzctl1, sizeof(a_gzctl1) },
    { &ia_gzctl1, sizeof(ia_gzctl1) },
    { &pw_gzctl1, sizeof(pw_gzctl1) },
    { &res_gzctl1, sizeof(res_gzctl1) },
    ...
    { &a_ASrf_mag, sizeof(a_ASrf_mag) },
    { &ia_ASrf_mag, sizeof(ia_ASrf_mag) },
    { &pw_ASrf_mag, sizeof(pw_ASrf_mag) },
    { &res_ASrf_mag, sizeof(res_ASrf_mag) },
    { &a_ASrf_theta, sizeof(a_ASrf_theta) },
    { &ia_ASrf_theta, sizeof(ia_ASrf_theta) },
    { &pw_ASrf_theta, sizeof(pw_ASrf_theta) },
    { &res_ASrf_theta, sizeof(res_ASrf_theta) },
    { &a_ASrf_grad, sizeof(a_ASrf_grad) },
    { &ia_ASrf_grad, sizeof(ia_ASrf_grad) },
    { &pw_ASrf_grad, sizeof(pw_ASrf_grad) },
    { &res_ASrf_grad, sizeof(res_ASrf_grad) },
    { &a_rf0, sizeof(a_rf0) },
    ...
    { &pfGy, sizeof(pfGy) },
    { &pfGz, sizeof(pfGz) },
    { &vsi_pulse_mag, sizeof(vsi_pulse_mag) },
    { &vsi_pulse_phs, sizeof(vsi_pulse_phs) },
    { &vsi_pulse_ctl_phs, sizeof(vsi_pulse_ctl_phs) },
    { &vsi_pulse_grad, sizeof(vsi_pulse_grad) },
    { &vsi_pulse_ctl_grad, sizeof(vsi_pulse_ctl_grad) },
    { &ArtSup_mag, sizeof(ArtSup_mag) },
    { &ArtSup_phs, sizeof(ArtSup_phs) },
    { &ArtSup_grad, sizeof(ArtSup_grad) },
    { &t_delay_array, sizeof(t_delay_array) },
    { &t_adjust_array, sizeof(t_adjust_array) },
    { &AStime_array, sizeof(AStime_array) },
    { &isVelocitySelective_array, sizeof(isVelocitySelective_array) },
    { &doArtSuppression_array, sizeof(doArtSuppression_array) },
    { &out_t_delay_array, sizeof(out_t_delay_array) },
    { &out_t_adjust_array, sizeof(out_t_adjust_array) },
    { &out_t_aq_array, sizeof(out_t_aq_array) },
    { &out_isVelocitySelective, sizeof(out_isVelocitySelective) },
    { &ctrl_word, sizeof(ctrl_word) },
    { &tcounter, sizeof(tcounter) },
    { NULL, 0 }
};
...
void cvcopy_cnv_endian( char * data )
{
    ...
    cv_cnv_endian_t_refocus_core( data );
    data += sizeof(t_refocus_core);
    ...
    cv_cnv_endian_pwrf2( data );
    data += sizeof(pwrf2);

    cv_cnv_endian_cycrf2( data );
    data += sizeof(cycrf2);

    cv_cnv_endian_myflip_rf2( data );
    data += sizeof(myflip_rf2);

    cv_cnv_endian_start_rf2( data );
    data += sizeof(start_rf2);

    cv_cnv_endian_phs_rf2( data );
    data += sizeof(phs_rf2);
    ...
    cv_cnv_endian_t_adjust_fudge( data );
    data += sizeof(t_adjust_fudge);

    cv_cnv_endian_delta1( data );
    data += sizeof(delta1);

    cv_cnv_endian_isLabel( data );
    data += sizeof(isLabel);
    ...
    cv_cnv_endian_mrf_mode( data );
    data += sizeof(mrf_mode);

    cv_cnv_endian_vsi_controlmode( data );
    data += sizeof(vsi_controlmode);

    cv_cnv_endian_vsi_axis_default( data );
    data += sizeof(vsi_axis_default);

    cv_cnv_endian_vsi_axis( data );
    data += sizeof(vsi_axis);

    cv_cnv_endian_vsi_rotax( data );
    data += sizeof(vsi_rotax);

    cv_cnv_endian_vsi_rfdelay( data );
    data += sizeof(vsi_rfdelay);

    cv_cnv_endian_vsi_flip( data );
    data += sizeof(vsi_flip);

    cv_cnv_endian_myramptime( data );
    data += sizeof(myramptime);

    cv_cnv_endian_vsi_Gmax( data );
    data += sizeof(vsi_Gmax);

    cv_cnv_endian_vsi_Gcontrol( data );
    data += sizeof(vsi_Gcontrol);

    cv_cnv_endian_vel_target( data );
    data += sizeof(vel_target);

    cv_cnv_endian_vsi_Ncycles( data );
    data += sizeof(vsi_Ncycles);
    ...
    cv_cnv_endian_vsi_RFmax( data );
    data += sizeof(vsi_RFmax);

    cv_cnv_endian_vsi_RFmax_calstep( data );
    data += sizeof(vsi_RFmax_calstep);

    cv_cnv_endian_my_maxB1Seq( data );
    data += sizeof(my_maxB1Seq);

    cv_cnv_endian_vsi_train_len( data );
    data += sizeof(vsi_train_len);

    cv_cnv_endian_Npoints( data );
    data += sizeof(Npoints);

    cv_cnv_endian_vsi_velocity( data );
    data += sizeof(vsi_velocity);

    cv_cnv_endian_vsi_timegap( data );
    data += sizeof(vsi_timegap);

    cv_cnv_endian_ArtSup_Gmax( data );
    data += sizeof(ArtSup_Gmax);

    cv_cnv_endian_ArtSup_B1max( data );
    data += sizeof(ArtSup_B1max);

    cv_cnv_endian_ArtSup_len( data );
    data += sizeof(ArtSup_len);

    cv_cnv_endian_multiFlipFlag( data );
    data += sizeof(multiFlipFlag);
    ...
    cv_cnv_endian_vsi_TrigType( data );
    data += sizeof(vsi_TrigType);
    ...
    cv_cnv_endian_Kmax( data );
    data += sizeof(Kmax);

    cv_cnv_endian_deltaK( data );
    data += sizeof(deltaK);

    cv_cnv_endian_FID_len( data );
    data += sizeof(FID_len);

    cv_cnv_endian_Grad_len( data );
    data += sizeof(Grad_len);

    cv_cnv_endian_FID_dur( data );
    data += sizeof(FID_dur);
    ...
    cv_cnv_endian_spiralGmax( data );
    data += sizeof(spiralGmax);

    cv_cnv_endian_myGmax_check( data );
    data += sizeof(myGmax_check);

    cv_cnv_endian_spiralGxmax( data );
    data += sizeof(spiralGxmax);

    cv_cnv_endian_spiralGymax( data );
    data += sizeof(spiralGymax);

    cv_cnv_endian_spiralGzmax( data );
    data += sizeof(spiralGzmax);

    cv_cnv_endian_kill_rx_phase( data );
    data += sizeof(kill_rx_phase);

    cv_cnv_endian_doRotated90( data );
    data += sizeof(doRotated90);

    cv_cnv_endian_yfov( data );
    data += sizeof(yfov);

    cv_cnv_endian_delta_y( data );
    data += sizeof(delta_y);

    cv_cnv_endian_fillrotations( data );
    data += sizeof(fillrotations);

    cv_cnv_endian_rf_sign( data );
    data += sizeof(rf_sign);

    cv_cnv_endian_rf2_fraction( data );
    data += sizeof(rf2_fraction);

    cv_cnv_endian_variable_fa( data );
    data += sizeof(variable_fa);
    ...
    cv_cnv_endian_doArtSup( data );
    data += sizeof(doArtSup);

    cv_cnv_endian_t_preBS( data );
    data += sizeof(t_preBS);

    cv_cnv_endian_AStime( data );
    data += sizeof(AStime);
    ...
    cv_cnv_endian_textra_vsi_gapcore( data );
    data += sizeof(textra_vsi_gapcore);
    ...
    cv_cnv_endian_flip_vsitag1( data );
    data += sizeof(flip_vsitag1);

    cv_cnv_endian_wg_vsitag1( data );
    data += sizeof(wg_vsitag1);

    cv_cnv_endian_xmtaddScan( data );
    data += sizeof(xmtaddScan);

    cv_cnv_endian_TX_scale( data );
    data += sizeof(TX_scale);
    ...
    cv_cnv_endian_a_gz( data );
    data += sizeof(a_gz);

    cv_cnv_endian_ia_gz( data );
    data += sizeof(ia_gz);

    cv_cnv_endian_pw_gz( data );
    data += sizeof(pw_gz);

    cv_cnv_endian_res_gz( data );
    data += sizeof(res_gz);
    ...
    cv_cnv_endian_a_vsitag1( data );
    data += sizeof(a_vsitag1);

    cv_cnv_endian_ia_vsitag1( data );
    data += sizeof(ia_vsitag1);

    cv_cnv_endian_pw_vsitag1( data );
    data += sizeof(pw_vsitag1);

    cv_cnv_endian_res_vsitag1( data );
    data += sizeof(res_vsitag1);

    cv_cnv_endian_a_vsitag1_theta( data );
    data += sizeof(a_vsitag1_theta);

    cv_cnv_endian_ia_vsitag1_theta( data );
    data += sizeof(ia_vsitag1_theta);

    cv_cnv_endian_pw_vsitag1_theta( data );
    data += sizeof(pw_vsitag1_theta);

    cv_cnv_endian_res_vsitag1_theta( data );
    data += sizeof(res_vsitag1_theta);

    cv_cnv_endian_a_gztag1( data );
    data += sizeof(a_gztag1);

    cv_cnv_endian_ia_gztag1( data );
    data += sizeof(ia_gztag1);

    cv_cnv_endian_pw_gztag1( data );
    data += sizeof(pw_gztag1);

    cv_cnv_endian_res_gztag1( data );
    data += sizeof(res_gztag1);

    cv_cnv_endian_a_vsictl1( data );
    data += sizeof(a_vsictl1);

    cv_cnv_endian_ia_vsictl1( data );
    data += sizeof(ia_vsictl1);

    cv_cnv_endian_pw_vsictl1( data );
    data += sizeof(pw_vsictl1);

    cv_cnv_endian_res_vsictl1( data );
    data += sizeof(res_vsictl1);

    cv_cnv_endian_a_vsictl1_theta( data );
    data += sizeof(a_vsictl1_theta);

    cv_cnv_endian_ia_vsictl1_theta( data );
    data += sizeof(ia_vsictl1_theta);

    cv_cnv_endian_pw_vsictl1_theta( data );
    data += sizeof(pw_vsictl1_theta);

    cv_cnv_endian_res_vsictl1_theta( data );
    data += sizeof(res_vsictl1_theta);

    cv_cnv_endian_a_gzctl1( data );
    data += sizeof(a_gzctl1);

    cv_cnv_endian_ia_gzctl1( data );
    data += sizeof(ia_gzctl1);

    cv_cnv_endian_pw_gzctl1( data );
    data += sizeof(pw_gzctl1);

    cv_cnv_endian_res_gzctl1( data );
    data += sizeof(res_gzctl1);
    ...
    cv_cnv_endian_a_ASrf_mag( data );
    data += sizeof(a_ASrf_mag);

    cv_cnv_endian_ia_ASrf_mag( data );
    data += sizeof(ia_ASrf_mag);

    cv_cnv_endian_pw_ASrf_mag( data );
    data += sizeof(pw_ASrf_mag);

    cv_cnv_endian_res_ASrf_mag( data );
    data += sizeof(res_ASrf_mag);

    cv_cnv_endian_a_ASrf_theta( data );
    data += sizeof(a_ASrf_theta);

    cv_cnv_endian_ia_ASrf_theta( data );
    data += sizeof(ia_ASrf_theta);

    cv_cnv_endian_pw_ASrf_theta( data );
    data += sizeof(pw_ASrf_theta);

    cv_cnv_endian_res_ASrf_theta( data );
    data += sizeof(res_ASrf_theta);

    cv_cnv_endian_a_ASrf_grad( data );
    data += sizeof(a_ASrf_grad);

    cv_cnv_endian_ia_ASrf_grad( data );
    data += sizeof(ia_ASrf_grad);

    cv_cnv_endian_pw_ASrf_grad( data );
    data += sizeof(pw_ASrf_grad);

    cv_cnv_endian_res_ASrf_grad( data );
    data += sizeof(res_ASrf_grad);
    ...
    cv_cnv_endian_Gz( data );
    data += sizeof(Gz);

    cv_cnv_endian_pfGx( data );
    data += sizeof(pfGx);

    cv_cnv_endian_pfGy( data );
    data += sizeof(pfGy);

    cv_cnv_endian_pfGz( data );
    data += sizeof(pfGz);

    cv_cnv_endian_vsi_pulse_mag( data );
    data += sizeof(vsi_pulse_mag);

    cv_cnv_endian_vsi_pulse_phs( data );
    data += sizeof(vsi_pulse_phs);

    cv_cnv_endian_vsi_pulse_ctl_phs( data );
    data += sizeof(vsi_pulse_ctl_phs);

    cv_cnv_endian_vsi_pulse_grad( data );
    data += sizeof(vsi_pulse_grad);

    cv_cnv_endian_vsi_pulse_ctl_grad( data );
    data += sizeof(vsi_pulse_ctl_grad);

    cv_cnv_endian_ArtSup_mag( data );
    data += sizeof(ArtSup_mag);

    cv_cnv_endian_ArtSup_phs( data );
    data += sizeof(ArtSup_phs);

    cv_cnv_endian_ArtSup_grad( data );
    data += sizeof(ArtSup_grad);

    cv_cnv_endian_t_delay_array( data );
    data += sizeof(t_delay_array);

    cv_cnv_endian_t_adjust_array( data );
    data += sizeof(t_adjust_array);

    cv_cnv_endian_AStime_array( data );
    data += sizeof(AStime_array);

    cv_cnv_endian_isVelocitySelective_array( data );
    data += sizeof(isVelocitySelective_array);

    cv_cnv_endian_doArtSuppression_array( data );
    data += sizeof(doArtSuppression_array);

    cv_cnv_endian_out_t_delay_array( data );
    data += sizeof(out_t_delay_array);

    cv_cnv_endian_out_t_adjust_array( data );
    data += sizeof(out_t_adjust_array);

    cv_cnv_endian_out_t_aq_array( data );
    data += sizeof(out_t_aq_array);

    cv_cnv_endian_out_isVelocitySelective( data );
    data += sizeof(out_isVelocitySelective);

    cv_cnv_endian_ctrl_word( data );
    data += sizeof(ctrl_word);

    cv_cnv_endian_tcounter( data );
    data += sizeof(tcounter);
...
static const char * cvcopy_table_names[] = {
    ...
    "t_adjust_array", 
    "AStime_array", 
    "isVelocitySelective_array", 
    "doArtSuppression_array", 
    "out_t_delay_array", 
    "out_t_adjust_array", 
    "out_t_aq_array", 
    "out_isVelocitySelective", 
    "ctrl_word", 
    "tcounter", 
};
...
#endif /* h_vsasl3dflex04_cvcopy_cpp */
