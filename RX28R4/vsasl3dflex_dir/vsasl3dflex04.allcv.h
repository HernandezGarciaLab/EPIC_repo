...
float 	ArtSup_Gmax = 1.5; /* default gradient max aplitude in arterial suppression pulse train */
float 	ArtSup_B1max = 234; /* default B1 max aplitude in arterial suppressin pulse train */
