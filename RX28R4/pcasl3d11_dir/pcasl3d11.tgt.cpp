...
STATUS pulsegen(void)
{
			...
			
  {
	...
	createinstr( &rf1,(long)(RUP_GRD(tlead+pw_gzrf1a)) + psd_rf_wait, 
		    pw_rf1,ia_rf1);
	addrfbits(&rf1,off_rf1,(long)(RUP_GRD(tlead+pw_gzrf1a)) + psd_rf_wait,
		  pw_rf1);
      }
    else
      {
	createinstr( &rf1,(long)(RUP_GRD(tlead+pw_gzrf1a)), 
		    pw_rf1,ia_rf1);
      }
  }
		         ...
		         
  {
    ...
    trapezoid((WF_PROCESSOR)wg_gzrf1r, "gzrf1r", &gzrf1r, &gzrf1ra,
              ...
              ia_gzrf1r, 0, 0, 0, 0, pendall(&gzrf1,0)+pw_gzrf1ra-pw_gzrf1ra, TRAP_ALL,
              &loggrd);
			...
			
  {
	...
	(wg_rftag1==TYPTHETA)||(wg_rftag1==TYPOMEGA))
      {
	createinstr( &rftag1,(long)(RUP_GRD(pw_gzrftag1a+0)) + psd_rf_wait, 
		    pw_rftag1,ia_rftag1);
	addrfbits(&rftag1,off_rftag1,(long)(RUP_GRD(pw_gzrftag1a+0)) + psd_rf_wait,
		  pw_rftag1);
      }
    else
      {
	createinstr( &rftag1,(long)(RUP_GRD(pw_gzrftag1a+0)), 
		    pw_rftag1,ia_rftag1);
      }
  }
			...
			
  {
	...
	(wg_rftag2==TYPTHETA)||(wg_rftag2==TYPOMEGA))
      {
	createinstr( &rftag2,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2a+0)) + psd_rf_wait, 
		    pw_rftag2,ia_rftag2);
	addrfbits(&rftag2,off_rftag2,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2a+0)) + psd_rf_wait,
		  pw_rftag2);
      }
    else
      {
	createinstr( &rftag2,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2a+0)), 
		    pw_rftag2,ia_rftag2);
      }
  }
			...
			
  {
	...
	addrfbits(&rftag1c,off_rftag1c,(long)(RUP_GRD(pw_gzrftag1ca)) + psd_rf_wait,
		  pw_rftag1c);
      }
    else
      {
	createinstr( &rftag1c,(long)(RUP_GRD(pw_gzrftag1ca)), 
		    pw_rftag1c,ia_rftag1c);
      }
  }
			...
			
  {
	...
	addrfbits(&rftag2c,off_rftag2c,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2ca)) + psd_rf_wait,
		  pw_rftag2c);
      }
    else
      {
	createinstr( &rftag2c,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2ca)), 
		    pw_rftag2c,ia_rftag2c);
      }
  }
		...
		
  {
	...
	createinstr( &BS1rf,(long)(RUP_RF(BS1_time-pw_BS1rf/2)) + psd_rf_wait, 
		    pw_BS1rf,ia_BS1rf);
	addrfbits(&BS1rf,off_BS1rf,(long)(RUP_RF(BS1_time-pw_BS1rf/2)) + psd_rf_wait,
		  pw_BS1rf);
      }
    else
      {
	createinstr( &BS1rf,(long)(RUP_RF(BS1_time-pw_BS1rf/2)), 
		    pw_BS1rf,ia_BS1rf);
      }
  }
		...
		
  {
	...
	addrfbits(&BS1rf_theta,off_BS1rf_theta,(long)(RUP_RF(BS1_time-pw_BS1rf/2)) + psd_rf_wait,
		  pw_BS1rf_theta);
      }
    else
      {
	createinstr( &BS1rf_theta,(long)(RUP_RF(BS1_time-pw_BS1rf/2)), 
		    pw_BS1rf_theta,ia_BS1rf_theta);
      }
  }
		...
		
  {
	...
	createinstr( &BS2rf,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2)) + psd_rf_wait, 
		    pw_BS2rf,ia_BS2rf);
	addrfbits(&BS2rf,off_BS2rf,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2)) + psd_rf_wait,
		  pw_BS2rf);
      }
    else
      {
	createinstr( &BS2rf,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2)), 
		    pw_BS2rf,ia_BS2rf);
      }
  }
		...
		
  {
	...
	addrfbits(&BS2rf_theta,off_BS2rf_theta,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2)) + psd_rf_wait,
		  pw_BS2rf_theta);
      }
    else
      {
	createinstr( &BS2rf_theta,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2)), 
		    pw_BS2rf_theta,ia_BS2rf_theta);
      }
  }
			...
			
  {
    ...
    if ((wg_rf0==TYPRHO1)||(wg_rf0==TYPRHO2) ||
      ...
      {
        createinstr( &rf0,(long)(RUP_GRD(t_delay-fatsattime)),
                    pw_rf0,ia_rf0);
        addrfbits(&rf0,off_rf0,(long)(RUP_GRD(t_delay-fatsattime)),
                  pw_rf0);
      }
    else
      {
