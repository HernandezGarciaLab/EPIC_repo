...
#include "pcasl3d11.hostdecl.h"
#include "pcasl3d11.exportstr.h"
#include "pcasl3d11.runtime.h"
...
int cveval()
{
	...
	cvmax(opuser21, 5000);
	cvdef(opuser21,1200);
	opuser21  = _opuser21.fixedflag ?  ((void)(1800), opuser21) : 1800;
	...
	/* JS 03/14/2018: Parameters for BS0 pulses*/
        ...
        a_gzBS0rfspoiler  = _a_gzBS0rfspoiler.fixedflag ?  ((void)(2*(float)doBS), a_gzBS0rfspoiler) : 2*(float)doBS;
...
2*pw_gzspoila);
	...
	t_adjust  = _t_adjust.fixedflag ?            ((void)(RUP_GRD(optr-psdseqtime*opslquant-t_tag-t_delay-tpre-t_preBS)), t_adjust) : RUP_GRD(optr-psdseqtime*opslquant-t_tag-t_delay-tpre-t_preBS);                 /* LHG 11.29.10 */
