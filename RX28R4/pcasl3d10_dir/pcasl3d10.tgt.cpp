...
STATUS pulsegen(void)
{
  ...
  {
    pulsename(&rf1,"rf1");
    createextwave(&rf1,(WF_PROCESSOR)wg_rf1,
                  res_rf1,fileloc_rf1);
    if ((wg_rf1==TYPRHO1)||(wg_rf1==TYPRHO2) ||
	(wg_rf1==TYPTHETA)||(wg_rf1==TYPOMEGA))
      {
	createinstr( &rf1,(long)(RUP_GRD(tlead+pw_gzrf1a+psd_rf_wait)) + psd_rf_wait, 
		    pw_rf1,ia_rf1);
	addrfbits(&rf1,off_rf1,(long)(RUP_GRD(tlead+pw_gzrf1a+psd_rf_wait)) + psd_rf_wait,
		  pw_rf1);
      }
    else
      {
	createinstr( &rf1,(long)(RUP_GRD(tlead+pw_gzrf1a+psd_rf_wait)), 
		    pw_rf1,ia_rf1);
      }
  }
    ...
    setWaveformPurpose(gzrf1a, gzrf1.purpose);
    setWaveformPurpose(gzrf1d, gzrf1.purpose);
    trapezoid((WF_PROCESSOR)wg_gzrf1, "gzrf1", &gzrf1, &gzrf1a,
              &gzrf1d, pw_gzrf1, pw_gzrf1a, pw_gzrf1d,
              ia_gzrf1, 0, 0, 0, 0, RUP_GRD(tlead+pw_gzrf1a)-pw_gzrf1a, TRAP_ALL,
              &loggrd);
		         ...
		         
  {
    ...
    createsinusoid(&gxpre,(WF_PROCESSOR)wg_gxpre,res_gxpre,
		   ...
		   off_gxpre);
    createinstr(&gxpre,(long)(readpos-pwgpre),pw_gxpre,ia_gxpre);
     
    if ((wg_gxpre==TYPRHO1)||(wg_gxpre==TYPRHO2))
      {
	addrfbits(&gxpre,0,(long)(readpos-pwgpre),pw_gxpre);
      }
  }
		         ...
		         
  {
    ...
    createsinusoid(&gypre,(WF_PROCESSOR)wg_gypre,res_gypre,
		   ...
		   off_gypre);
    createinstr(&gypre,(long)(readpos-pwgpre),pw_gypre,ia_gypre);
     
    if ((wg_gypre==TYPRHO1)||(wg_gypre==TYPRHO2))
      {
	addrfbits(&gypre,0,(long)(readpos-pwgpre),pw_gypre);
      }
  }
    ...
    setWaveformPurpose(gxsp3a, gxsp3.purpose);
    setWaveformPurpose(gxsp3d, gxsp3.purpose);
    trapezoid((WF_PROCESSOR)wg_gxsp3, "gxsp3", &gxsp3, &gxsp3a,
              &gxsp3d, pw_gxsp3, pw_gxsp3a, pw_gxsp3d,
              ia_gxsp3, 0, 0, 0, 0, RUP_GRD(pend(&gzrf1rd,"gzrf1rd",0)+pw_gxsp3a)-pw_gxsp3a, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gxsp4a, gxsp4.purpose);
    setWaveformPurpose(gxsp4d, gxsp4.purpose);
    trapezoid((WF_PROCESSOR)wg_gxsp4, "gxsp4", &gxsp4, &gxsp4a,
              &gxsp4d, pw_gxsp4, pw_gxsp4a, pw_gxsp4d,
              ia_gxsp4, 0, 0, 0, 0, RUP_GRD(pend(&gxsp3d,"gxsp3d",0)+pw_gxsp4a+delta1)-pw_gxsp4a, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gysp3a, gysp3.purpose);
    setWaveformPurpose(gysp3d, gysp3.purpose);
    trapezoid((WF_PROCESSOR)wg_gysp3, "gysp3", &gysp3, &gysp3a,
              &gysp3d, pw_gysp3, pw_gysp3a, pw_gysp3d,
              ia_gysp3, 0, 0, 0, 0, RUP_GRD(pend(&gzrf1rd,"gzrf1rd",0)+pw_gysp3a)-pw_gysp3a, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gysp4a, gysp4.purpose);
    setWaveformPurpose(gysp4d, gysp4.purpose);
    trapezoid((WF_PROCESSOR)wg_gysp4, "gysp4", &gysp4, &gysp4a,
              &gysp4d, pw_gysp4, pw_gysp4a, pw_gysp4d,
              ia_gysp4, 0, 0, 0, 0, RUP_GRD(pend(&gysp3d,"gysp3d",0)+pw_gysp4a+delta1)-pw_gysp4a, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gzsp3a, gzsp3.purpose);
    setWaveformPurpose(gzsp3d, gzsp3.purpose);
    trapezoid((WF_PROCESSOR)wg_gzsp3, "gzsp3", &gzsp3, &gzsp3a,
              &gzsp3d, pw_gzsp3, pw_gzsp3a, pw_gzsp3d,
              ia_gzsp3, 0, 0, 0, 0, RUP_GRD(pend(&gzrf1rd,"gzrf1rd",0)+pw_gzsp3a)-pw_gzsp3a, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gzsp4a, gzsp4.purpose);
    setWaveformPurpose(gzsp4d, gzsp4.purpose);
    trapezoid((WF_PROCESSOR)wg_gzsp4, "gzsp4", &gzsp4, &gzsp4a,
              &gzsp4d, pw_gzsp4, pw_gzsp4a, pw_gzsp4d,
              ia_gzsp4, 0, 0, 0, 0, RUP_GRD(pend(&gzsp3d,"gzsp3d",0)+pw_gzsp4a+delta1)-pw_gzsp4a, TRAP_ALL,
              &loggrd);
    ...
    trapezoid((WF_PROCESSOR)wg_gzphase1, "gzphase1", &gzphase1, &gzphase1a,
              ...
              ia_gzphase1, 0, 0, 0, 0, RUP_GRD(pend(&gzrf1rd,"gzrf1rd",0)+pw_gzphase1a)-pw_gzphase1a, TRAP_ALL,
              &loggrd);
	   ...
	   
  {
    ...
    setWaveformPurpose(gzspoila, gzspoil.purpose);
    setWaveformPurpose(gzspoild, gzspoil.purpose);
    trapezoid((WF_PROCESSOR)wg_gzspoil, "gzspoil", &gzspoil, &gzspoila,
              &gzspoild, pw_gzspoil, pw_gzspoila, pw_gzspoild,
              ia_gzspoil, 0, 0, 0, 0, RUP_GRD(pendall(&gzphase2,0)+pw_gzspoila)-pw_gzspoila, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gxspoila, gxspoil.purpose);
    setWaveformPurpose(gxspoild, gxspoil.purpose);
    trapezoid((WF_PROCESSOR)wg_gxspoil, "gxspoil", &gxspoil, &gxspoila,
              &gxspoild, pw_gxspoil, pw_gxspoila, pw_gxspoild,
              ia_gxspoil, 0, 0, 0, 0, RUP_GRD(pend(&gzspoild,"gzspoild",0)+pw_gxspoila)-pw_gxspoila, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gyspoila, gyspoil.purpose);
    setWaveformPurpose(gyspoild, gyspoil.purpose);
    trapezoid((WF_PROCESSOR)wg_gyspoil, "gyspoil", &gyspoil, &gyspoila,
              &gyspoild, pw_gyspoil, pw_gyspoila, pw_gyspoild,
              ia_gyspoil, 0, 0, 0, 0, RUP_GRD(pend(&gzspoild,"gzspoild",0)+pw_gxspoila)-pw_gyspoila, TRAP_ALL,
              &loggrd);
	 ...
	 
  {
    ...
    createseq(&seqcore,psdseqtime-timessi+textra, off_seqcore);
#if defined(HOST_TGT)
  ...
  {
    pulsename(&BS3rf,"BS3rf");
    createextwave(&BS3rf,(WF_PROCESSOR)wg_BS3rf,
                  res_BS3rf,fileloc_BS3rf);
    if ((wg_BS3rf==TYPRHO1)||(wg_BS3rf==TYPRHO2) ||
	(wg_BS3rf==TYPTHETA)||(wg_BS3rf==TYPOMEGA))
      {
	createinstr( &BS3rf,(long)(RUP_RF(psd_rf_wait)) + psd_rf_wait, 
		    pw_BS3rf,ia_BS3rf);
	addrfbits(&BS3rf,off_BS3rf,(long)(RUP_RF(psd_rf_wait)) + psd_rf_wait,
		  pw_BS3rf);
      }
    else
      {
	createinstr( &BS3rf,(long)(RUP_RF(psd_rf_wait)), 
		    pw_BS3rf,ia_BS3rf);
      }
  }
  ...
  {
    pulsename(&BS3rf_theta,"BS3rf_theta");
    createextwave(&BS3rf_theta,(WF_PROCESSOR)wg_BS3rf_theta,
                  res_BS3rf_theta,fileloc_BS3rf_theta);
    if ((wg_BS3rf_theta==TYPRHO1)||(wg_BS3rf_theta==TYPRHO2) ||
	(wg_BS3rf_theta==TYPTHETA)||(wg_BS3rf_theta==TYPOMEGA))
      {
	createinstr( &BS3rf_theta,(long)(RUP_RF(psd_rf_wait)) + psd_rf_wait, 
		    pw_BS3rf_theta,ia_BS3rf_theta);
	addrfbits(&BS3rf_theta,off_BS3rf_theta,(long)(RUP_RF(psd_rf_wait)) + psd_rf_wait,
		  pw_BS3rf_theta);
      }
    else
      {
	createinstr( &BS3rf_theta,(long)(RUP_RF(psd_rf_wait)), 
		    pw_BS3rf_theta,ia_BS3rf_theta);
      }
  }
			...
			
  {
	...
	(wg_rftag1==TYPTHETA)||(wg_rftag1==TYPOMEGA))
      {
	createinstr( &rftag1,(long)(RUP_GRD(pw_gzrftag1a+psd_rf_wait)) + psd_rf_wait, 
		    pw_rftag1,ia_rftag1);
	addrfbits(&rftag1,off_rftag1,(long)(RUP_GRD(pw_gzrftag1a+psd_rf_wait)) + psd_rf_wait,
		  pw_rftag1);
      }
    else
      {
			...
			
  {
	...
	(wg_rftag2==TYPTHETA)||(wg_rftag2==TYPOMEGA))
      {
	createinstr( &rftag2,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2a+psd_rf_wait)) + psd_rf_wait, 
		    pw_rftag2,ia_rftag2);
	addrfbits(&rftag2,off_rftag2,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2a+psd_rf_wait)) + psd_rf_wait,
		  pw_rftag2);
      }
    else
      {
			...
			
  {
	...
	(wg_rftag1c==TYPTHETA)||(wg_rftag1c==TYPOMEGA))
      {
	createinstr( &rftag1c,(long)(RUP_GRD(pw_gzrftag1ca+psd_rf_wait)) + psd_rf_wait, 
		    pw_rftag1c,ia_rftag1c);
	addrfbits(&rftag1c,off_rftag1c,(long)(RUP_GRD(pw_gzrftag1ca+psd_rf_wait)) + psd_rf_wait,
		  pw_rftag1c);
      }
    else
      {
	createinstr( &rftag1c,(long)(RUP_GRD(pw_gzrftag1ca+psd_rf_wait)), 
		    pw_rftag1c,ia_rftag1c);
      }
  }
			...
			
  {
	...
	(wg_rftag2c==TYPTHETA)||(wg_rftag2c==TYPOMEGA))
      {
	createinstr( &rftag2c,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2ca+psd_rf_wait)) + psd_rf_wait, 
		    pw_rftag2c,ia_rftag2c);
	addrfbits(&rftag2c,off_rftag2c,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2ca+psd_rf_wait)) + psd_rf_wait,
		  pw_rftag2c);
      }
    else
      {
	createinstr( &rftag2c,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2ca+psd_rf_wait)), 
		    pw_rftag2c,ia_rftag2c);
      }
  }
			...
			
  {
    ...
    createsinc(&BS0rf,(WF_PROCESSOR)wg_BS0rf,res_BS0rf,
               MAX_PG_WAMP,cyc_BS0rf,alpha_BS0rf);
    if ((wg_BS0rf==TYPRHO1)||(wg_BS0rf==TYPRHO2) ||
        (wg_BS0rf==TYPTHETA)||(wg_BS0rf==TYPOMEGA))
      {
        createinstr( &BS0rf,(long)(RUP_GRD(psd_rf_wait)),
                    pw_BS0rf,ia_BS0rf);
        addrfbits(&BS0rf,off_BS0rf,(long)(RUP_GRD(psd_rf_wait)),
                  pw_BS0rf);
      }
    else
      {
    ...
    setWaveformPurpose(gzBS0a, gzBS0.purpose);
    setWaveformPurpose(gzBS0d, gzBS0.purpose);
    trapezoid((WF_PROCESSOR)wg_gzBS0, "gzBS0", &gzBS0, &gzBS0a,
              &gzBS0d, pw_gzBS0, pw_gzBS0a, pw_gzBS0d,
              ia_gzBS0, 0, 0, 0, 0, RUP_GRD(pw_BS0rf+pw_gzBS0a)-pw_gzBS0a, TRAP_ALL,
              &loggrd);
		...
		
  {
	...
	(wg_BS1rf==TYPTHETA)||(wg_BS1rf==TYPOMEGA))
      {
	createinstr( &BS1rf,(long)(RUP_RF(BS1_time-pw_BS1rf/2+psd_rf_wait)) + psd_rf_wait, 
		    pw_BS1rf,ia_BS1rf);
	addrfbits(&BS1rf,off_BS1rf,(long)(RUP_RF(BS1_time-pw_BS1rf/2+psd_rf_wait)) + psd_rf_wait,
		  pw_BS1rf);
      }
    else
      {
	createinstr( &BS1rf,(long)(RUP_RF(BS1_time-pw_BS1rf/2+psd_rf_wait)), 
		    pw_BS1rf,ia_BS1rf);
      }
  }
		...
		
  {
	...
	(wg_BS1rf_theta==TYPTHETA)||(wg_BS1rf_theta==TYPOMEGA))
      {
	createinstr( &BS1rf_theta,(long)(RUP_RF(BS1_time-pw_BS1rf/2+psd_rf_wait)) + psd_rf_wait, 
		    pw_BS1rf_theta,ia_BS1rf_theta);
	addrfbits(&BS1rf_theta,off_BS1rf_theta,(long)(RUP_RF(BS1_time-pw_BS1rf/2+psd_rf_wait)) + psd_rf_wait,
		  pw_BS1rf_theta);
      }
    else
      {
	createinstr( &BS1rf_theta,(long)(RUP_RF(BS1_time-pw_BS1rf/2+psd_rf_wait)), 
		    pw_BS1rf_theta,ia_BS1rf_theta);
      }
  }
		...
		
  {
	...
	(wg_BS2rf==TYPTHETA)||(wg_BS2rf==TYPOMEGA))
      {
	createinstr( &BS2rf,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2+psd_rf_wait)) + psd_rf_wait, 
		    pw_BS2rf,ia_BS2rf);
	addrfbits(&BS2rf,off_BS2rf,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2+psd_rf_wait)) + psd_rf_wait,
		  pw_BS2rf);
      }
    else
      {
	createinstr( &BS2rf,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2+psd_rf_wait)), 
		    pw_BS2rf,ia_BS2rf);
      }
  }
		...
		
  {
	...
	(wg_BS2rf_theta==TYPTHETA)||(wg_BS2rf_theta==TYPOMEGA))
      {
	createinstr( &BS2rf_theta,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2+psd_rf_wait)) + psd_rf_wait, 
		    pw_BS2rf_theta,ia_BS2rf_theta);
	addrfbits(&BS2rf_theta,off_BS2rf_theta,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2+psd_rf_wait)) + psd_rf_wait,
		  pw_BS2rf_theta);
      }
    else
      {
	createinstr( &BS2rf_theta,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2+psd_rf_wait)), 
		    pw_BS2rf_theta,ia_BS2rf_theta);
      }
  }
			...
			
  {
    ...
    if ((wg_rf0==TYPRHO1)||(wg_rf0==TYPRHO2) ||
      ...
      {
        createinstr( &rf0,(long)(RUP_GRD(t_delay-fatsattime+psd_rf_wait)),
                    pw_rf0,ia_rf0);
        addrfbits(&rf0,off_rf0,(long)(RUP_GRD(t_delay-fatsattime+psd_rf_wait)),
                  pw_rf0);
      }
    else
      {
...
void get_rfamp(int ntab, int *rfamp)
{
	...
	E1 = exp(-(float)psdseqtime/(float)1300000);
	fprintf(stderr,"\nget_rfamp: E1 = %f", E1);
