 ...
 * these variables.
 *
 * Generated on Tue Jun 22 14:38:22 2021 
 */

#ifndef h_pcasl3d10_cvcopy_cpp
#define h_pcasl3d10_cvcopy_cpp

#include "cvcopy_proto.h"

#if defined(PSD_HW) && defined(HOST_TGT)
/* Include endian converter functions */
#include "pcasl3d10.cnvendian.globalvar.h"
#include "pcasl3d10.cnvendian.c"
...
static const cvcopy_table_entry cvcopy_table[] = {
    ...
    { &a_gxsp3, sizeof(a_gxsp3) },
    { &ia_gxsp3, sizeof(ia_gxsp3) },
    { &pw_gxsp3a, sizeof(pw_gxsp3a) },
    { &pw_gxsp3d, sizeof(pw_gxsp3d) },
    { &pw_gxsp3, sizeof(pw_gxsp3) },
    { &wg_gxsp3, sizeof(wg_gxsp3) },
    { &a_gxsp4, sizeof(a_gxsp4) },
    { &ia_gxsp4, sizeof(ia_gxsp4) },
    { &pw_gxsp4a, sizeof(pw_gxsp4a) },
    { &pw_gxsp4d, sizeof(pw_gxsp4d) },
    { &pw_gxsp4, sizeof(pw_gxsp4) },
    { &wg_gxsp4, sizeof(wg_gxsp4) },
    { &a_gysp3, sizeof(a_gysp3) },
    { &ia_gysp3, sizeof(ia_gysp3) },
    { &pw_gysp3a, sizeof(pw_gysp3a) },
    { &pw_gysp3d, sizeof(pw_gysp3d) },
    { &pw_gysp3, sizeof(pw_gysp3) },
    { &wg_gysp3, sizeof(wg_gysp3) },
    { &a_gysp4, sizeof(a_gysp4) },
    { &ia_gysp4, sizeof(ia_gysp4) },
    { &pw_gysp4a, sizeof(pw_gysp4a) },
    { &pw_gysp4d, sizeof(pw_gysp4d) },
    { &pw_gysp4, sizeof(pw_gysp4) },
    { &wg_gysp4, sizeof(wg_gysp4) },
    { &a_gzsp3, sizeof(a_gzsp3) },
    { &ia_gzsp3, sizeof(ia_gzsp3) },
    { &pw_gzsp3a, sizeof(pw_gzsp3a) },
    { &pw_gzsp3d, sizeof(pw_gzsp3d) },
    { &pw_gzsp3, sizeof(pw_gzsp3) },
    { &wg_gzsp3, sizeof(wg_gzsp3) },
    { &a_gzsp4, sizeof(a_gzsp4) },
    { &ia_gzsp4, sizeof(ia_gzsp4) },
    { &pw_gzsp4a, sizeof(pw_gzsp4a) },
    { &pw_gzsp4d, sizeof(pw_gzsp4d) },
    { &pw_gzsp4, sizeof(pw_gzsp4) },
    { &wg_gzsp4, sizeof(wg_gzsp4) },
    ...
    { &a_gzspoil, sizeof(a_gzspoil) },
    { &ia_gzspoil, sizeof(ia_gzspoil) },
    { &pw_gzspoila, sizeof(pw_gzspoila) },
    { &pw_gzspoild, sizeof(pw_gzspoild) },
    { &pw_gzspoil, sizeof(pw_gzspoil) },
    { &wg_gzspoil, sizeof(wg_gzspoil) },
    { &a_gxspoil, sizeof(a_gxspoil) },
    { &ia_gxspoil, sizeof(ia_gxspoil) },
    { &pw_gxspoila, sizeof(pw_gxspoila) },
    { &pw_gxspoild, sizeof(pw_gxspoild) },
    { &pw_gxspoil, sizeof(pw_gxspoil) },
    { &wg_gxspoil, sizeof(wg_gxspoil) },
    { &a_gyspoil, sizeof(a_gyspoil) },
    { &ia_gyspoil, sizeof(ia_gyspoil) },
    { &pw_gyspoila, sizeof(pw_gyspoila) },
    { &pw_gyspoild, sizeof(pw_gyspoild) },
    { &pw_gyspoil, sizeof(pw_gyspoil) },
    { &wg_gyspoil, sizeof(wg_gyspoil) },
    { &a_BS3rf, sizeof(a_BS3rf) },
    { &ia_BS3rf, sizeof(ia_BS3rf) },
    { &pw_BS3rf, sizeof(pw_BS3rf) },
    { &res_BS3rf, sizeof(res_BS3rf) },
    { &off_BS3rf, sizeof(off_BS3rf) },
    { &wg_BS3rf, sizeof(wg_BS3rf) },
    { &a_BS3rf_theta, sizeof(a_BS3rf_theta) },
    { &ia_BS3rf_theta, sizeof(ia_BS3rf_theta) },
    { &pw_BS3rf_theta, sizeof(pw_BS3rf_theta) },
    { &res_BS3rf_theta, sizeof(res_BS3rf_theta) },
    { &off_BS3rf_theta, sizeof(off_BS3rf_theta) },
    { &wg_BS3rf_theta, sizeof(wg_BS3rf_theta) },
    ...
    { &cyc_BS0rf, sizeof(cyc_BS0rf) },
    { &off_BS0rf, sizeof(off_BS0rf) },
    { &alpha_BS0rf, sizeof(alpha_BS0rf) },
    { &wg_BS0rf, sizeof(wg_BS0rf) },
    { &a_gzBS0, sizeof(a_gzBS0) },
    { &ia_gzBS0, sizeof(ia_gzBS0) },
    { &pw_gzBS0a, sizeof(pw_gzBS0a) },
    { &pw_gzBS0d, sizeof(pw_gzBS0d) },
    { &pw_gzBS0, sizeof(pw_gzBS0) },
    { &wg_gzBS0, sizeof(wg_gzBS0) },
...
void cvcopy_cnv_endian( char * data )
{
    ...
    cv_cnv_endian_wg_gzrf1( data );
    data += sizeof(wg_gzrf1);
    ...
    cv_cnv_endian_a_gxsp3( data );
    data += sizeof(a_gxsp3);

    cv_cnv_endian_ia_gxsp3( data );
    data += sizeof(ia_gxsp3);

    cv_cnv_endian_pw_gxsp3a( data );
    data += sizeof(pw_gxsp3a);

    cv_cnv_endian_pw_gxsp3d( data );
    data += sizeof(pw_gxsp3d);

    cv_cnv_endian_pw_gxsp3( data );
    data += sizeof(pw_gxsp3);

    cv_cnv_endian_wg_gxsp3( data );
    data += sizeof(wg_gxsp3);

    cv_cnv_endian_a_gxsp4( data );
    data += sizeof(a_gxsp4);

    cv_cnv_endian_ia_gxsp4( data );
    data += sizeof(ia_gxsp4);

    cv_cnv_endian_pw_gxsp4a( data );
    data += sizeof(pw_gxsp4a);

    cv_cnv_endian_pw_gxsp4d( data );
    data += sizeof(pw_gxsp4d);

    cv_cnv_endian_pw_gxsp4( data );
    data += sizeof(pw_gxsp4);

    cv_cnv_endian_wg_gxsp4( data );
    data += sizeof(wg_gxsp4);

    cv_cnv_endian_a_gysp3( data );
    data += sizeof(a_gysp3);

    cv_cnv_endian_ia_gysp3( data );
    data += sizeof(ia_gysp3);

    cv_cnv_endian_pw_gysp3a( data );
    data += sizeof(pw_gysp3a);

    cv_cnv_endian_pw_gysp3d( data );
    data += sizeof(pw_gysp3d);

    cv_cnv_endian_pw_gysp3( data );
    data += sizeof(pw_gysp3);

    cv_cnv_endian_wg_gysp3( data );
    data += sizeof(wg_gysp3);

    cv_cnv_endian_a_gysp4( data );
    data += sizeof(a_gysp4);

    cv_cnv_endian_ia_gysp4( data );
    data += sizeof(ia_gysp4);

    cv_cnv_endian_pw_gysp4a( data );
    data += sizeof(pw_gysp4a);

    cv_cnv_endian_pw_gysp4d( data );
    data += sizeof(pw_gysp4d);

    cv_cnv_endian_pw_gysp4( data );
    data += sizeof(pw_gysp4);

    cv_cnv_endian_wg_gysp4( data );
    data += sizeof(wg_gysp4);

    cv_cnv_endian_a_gzsp3( data );
    data += sizeof(a_gzsp3);

    cv_cnv_endian_ia_gzsp3( data );
    data += sizeof(ia_gzsp3);

    cv_cnv_endian_pw_gzsp3a( data );
    data += sizeof(pw_gzsp3a);

    cv_cnv_endian_pw_gzsp3d( data );
    data += sizeof(pw_gzsp3d);

    cv_cnv_endian_pw_gzsp3( data );
    data += sizeof(pw_gzsp3);

    cv_cnv_endian_wg_gzsp3( data );
    data += sizeof(wg_gzsp3);

    cv_cnv_endian_a_gzsp4( data );
    data += sizeof(a_gzsp4);

    cv_cnv_endian_ia_gzsp4( data );
    data += sizeof(ia_gzsp4);

    cv_cnv_endian_pw_gzsp4a( data );
    data += sizeof(pw_gzsp4a);

    cv_cnv_endian_pw_gzsp4d( data );
    data += sizeof(pw_gzsp4d);

    cv_cnv_endian_pw_gzsp4( data );
    data += sizeof(pw_gzsp4);

    cv_cnv_endian_wg_gzsp4( data );
    data += sizeof(wg_gzsp4);
    ...
    cv_cnv_endian_a_gzspoil( data );
    data += sizeof(a_gzspoil);

    cv_cnv_endian_ia_gzspoil( data );
    data += sizeof(ia_gzspoil);

    cv_cnv_endian_pw_gzspoila( data );
    data += sizeof(pw_gzspoila);

    cv_cnv_endian_pw_gzspoild( data );
    data += sizeof(pw_gzspoild);

    cv_cnv_endian_pw_gzspoil( data );
    data += sizeof(pw_gzspoil);

    cv_cnv_endian_wg_gzspoil( data );
    data += sizeof(wg_gzspoil);

    cv_cnv_endian_a_gxspoil( data );
    data += sizeof(a_gxspoil);

    cv_cnv_endian_ia_gxspoil( data );
    data += sizeof(ia_gxspoil);

    cv_cnv_endian_pw_gxspoila( data );
    data += sizeof(pw_gxspoila);

    cv_cnv_endian_pw_gxspoild( data );
    data += sizeof(pw_gxspoild);

    cv_cnv_endian_pw_gxspoil( data );
    data += sizeof(pw_gxspoil);

    cv_cnv_endian_wg_gxspoil( data );
    data += sizeof(wg_gxspoil);

    cv_cnv_endian_a_gyspoil( data );
    data += sizeof(a_gyspoil);

    cv_cnv_endian_ia_gyspoil( data );
    data += sizeof(ia_gyspoil);

    cv_cnv_endian_pw_gyspoila( data );
    data += sizeof(pw_gyspoila);

    cv_cnv_endian_pw_gyspoild( data );
    data += sizeof(pw_gyspoild);

    cv_cnv_endian_pw_gyspoil( data );
    data += sizeof(pw_gyspoil);

    cv_cnv_endian_wg_gyspoil( data );
    data += sizeof(wg_gyspoil);

    cv_cnv_endian_a_BS3rf( data );
    data += sizeof(a_BS3rf);

    cv_cnv_endian_ia_BS3rf( data );
    data += sizeof(ia_BS3rf);

    cv_cnv_endian_pw_BS3rf( data );
    data += sizeof(pw_BS3rf);

    cv_cnv_endian_res_BS3rf( data );
    data += sizeof(res_BS3rf);

    cv_cnv_endian_off_BS3rf( data );
    data += sizeof(off_BS3rf);

    cv_cnv_endian_wg_BS3rf( data );
    data += sizeof(wg_BS3rf);

    cv_cnv_endian_a_BS3rf_theta( data );
    data += sizeof(a_BS3rf_theta);

    cv_cnv_endian_ia_BS3rf_theta( data );
    data += sizeof(ia_BS3rf_theta);

    cv_cnv_endian_pw_BS3rf_theta( data );
    data += sizeof(pw_BS3rf_theta);

    cv_cnv_endian_res_BS3rf_theta( data );
    data += sizeof(res_BS3rf_theta);

    cv_cnv_endian_off_BS3rf_theta( data );
    data += sizeof(off_BS3rf_theta);

    cv_cnv_endian_wg_BS3rf_theta( data );
    data += sizeof(wg_BS3rf_theta);
    ...
    cv_cnv_endian_cyc_BS0rf( data );
    data += sizeof(cyc_BS0rf);

    cv_cnv_endian_off_BS0rf( data );
    data += sizeof(off_BS0rf);

    cv_cnv_endian_alpha_BS0rf( data );
    data += sizeof(alpha_BS0rf);

    cv_cnv_endian_wg_BS0rf( data );
    data += sizeof(wg_BS0rf);

    cv_cnv_endian_a_gzBS0( data );
    data += sizeof(a_gzBS0);

    cv_cnv_endian_ia_gzBS0( data );
    data += sizeof(ia_gzBS0);

    cv_cnv_endian_pw_gzBS0a( data );
    data += sizeof(pw_gzBS0a);

    cv_cnv_endian_pw_gzBS0d( data );
    data += sizeof(pw_gzBS0d);

    cv_cnv_endian_pw_gzBS0( data );
    data += sizeof(pw_gzBS0);

    cv_cnv_endian_wg_gzBS0( data );
    data += sizeof(wg_gzBS0);
