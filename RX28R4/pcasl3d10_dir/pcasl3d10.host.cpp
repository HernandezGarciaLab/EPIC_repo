...
#include "pcasl3d10.hostdecl.h"
#include "pcasl3d10.exportstr.h"
#include "pcasl3d10.runtime.h"
...
int cveval()
{
	...
	cvdef(opuser1, 1);
	opuser1  = _opuser1.fixedflag ?  ((void)(4), opuser1) : 4;
	cvmin(opuser1, 1);
	cvmax(opuser1, 16384);
	...
	cvdef(opuser12, 0);
	opuser12  = _opuser12.fixedflag ?  ((void)(0), opuser12) : 0;
	cvmin(opuser12, 0);
	cvmax(opuser12, 1);
	if(((int)opuser12) == 1)  {
	...
	cvmax(opuser21, 5000);
	cvdef(opuser21,1200);
	opuser21  = _opuser21.fixedflag ?  ((void)(1400), opuser21) : 1400;

	cvdesc(opuser22,"Dist. from landmark to tagging plane (cm)");
	cvmin(opuser22,-50);
	cvmax(opuser22, 50);
	cvdef(opuser22,8);
	opuser22  = _opuser22.fixedflag ?  ((void)(8), opuser22) : 8;
	...
	cvmax(opuser25, 1);
	cvdef(opuser25,1);
	opuser25  = _opuser25.fixedflag ?  ((void)(1), opuser25) : 1;
	...
	a_rftag1  = _a_rftag1.fixedflag ?    ((void)((3.5592)*(pcasl_flip/180)*500/pw_rftag1), a_rftag1) : (3.5592)*(pcasl_flip/180)*500/pw_rftag1;
	...
	/* refocusers:  */
	pw_gzrftag1r  = _pw_gzrftag1r.fixedflag ?  ((void)(100), pw_gzrftag1r) : 100;  
	pw_gzrftag1r  = _pw_gzrftag1r.fixedflag ?  ((void)(200), pw_gzrftag1r) : 200;  
	pw_gzrftag1ra  = _pw_gzrftag1ra.fixedflag ?  ((void)(myramptime), pw_gzrftag1ra) : myramptime;  
	...
	myphase_increment  = _myphase_increment.fixedflag ?          ((void)(-GAMMA_H1*pcasl_Gave*t_rfrepeat*1e-6*B1tag_distance), myphase_increment) : -GAMMA_H1*pcasl_Gave*t_rfrepeat*1e-6*B1tag_distance;
	...
	res_rf1  = _res_rf1.fixedflag ?  ((void)(500), res_rf1) : 500;
	/* calculate the bandwidth of the min phase pulse: LHG 11/22/2010 */
	/* the rf3dmin pulse has 18 lobes */
	rf1_bw  = _rf1_bw.fixedflag ?     ((void)(1000000.0*18.0/(float)(pw_rf1)), rf1_bw) : 1000000.0*18.0/(float)(pw_rf1);
	pw_gzrf1  = _pw_gzrf1.fixedflag ?  ((void)(pw_rf1), pw_gzrf1) : pw_rf1;
	pw_gzrf1a  = _pw_gzrf1a.fixedflag ?  ((void)(myramptime), pw_gzrf1a) : myramptime;
	pw_gzrf1d  = _pw_gzrf1d.fixedflag ?  ((void)(myramptime), pw_gzrf1d) : myramptime;
	pw_gzrf1r  = _pw_gzrf1r.fixedflag ?  ((void)(200), pw_gzrf1r) : 200;   /* LHG 11.30.12 - changing the duration of the refocuser */
	pw_gzrf1ra  = _pw_gzrf1ra.fixedflag ?  ((void)(myramptime), pw_gzrf1ra) : myramptime;
	pw_gzrf1rd  = _pw_gzrf1rd.fixedflag ?  ((void)(myramptime), pw_gzrf1rd) : myramptime;
	zfov  = _zfov.fixedflag ?  ((void)((double)opslquant*opslthick/10), zfov) : (double)opslquant*opslthick/10;

	if(doZgrappa) slab_fraction  = _slab_fraction.fixedflag ?  ((void)(0.75), slab_fraction) : 0.75;

	a_gzrf1  = _a_gzrf1.fixedflag ?     ((void)(rf1_bw/(slab_fraction*zfov*GAMMA_H1/(2*3.14159))), a_gzrf1) : rf1_bw/(slab_fraction*zfov*GAMMA_H1/(2*3.14159));
	area_gzrf1  = _area_gzrf1.fixedflag ?      ((void)((double)a_gzrf1*(pw_gzrf1+pw_gzrf1d)), area_gzrf1) : (double)a_gzrf1*(pw_gzrf1+pw_gzrf1d);
	area_gzrf1r  = _area_gzrf1r.fixedflag ?    ((void)(-(double)area_gzrf1*(1-rf1maxTime)), area_gzrf1r) : -(double)area_gzrf1*(1-rf1maxTime);
	...
	ampGzstep  = _ampGzstep.fixedflag ?          ((void)(1/((pwGzstep+myramptime)*1e-6*GAMMA_H1/(2*PI)*zfov)), ampGzstep) : 1/((pwGzstep+myramptime)*1e-6*GAMMA_H1/(2*PI)*zfov);  /* z phase-ecncode readout gradient for this zfov G/cm*/

	if (doZgrappa) 
		ampGzstep  = _ampGzstep.fixedflag ?  ((void)(2), ampGzstep) : ampGzstep*2;
	
	areaGzstep  = _areaGzstep.fixedflag ?       ((void)(ampGzstep*(pwGzstep+myramptime)), areaGzstep) : ampGzstep*(pwGzstep+myramptime);        /* max area of z encoding gradient in G/cm*usec */
	...
	pw_gzphase1a = _pw_gzphase1a.fixedflag ?  ((void)(myramptime), pw_gzphase1a) : myramptime;
	pw_gzphase1d = _pw_gzphase1d.fixedflag ?  ((void)(myramptime), pw_gzphase1d) : myramptime;
	pw_gzphase2 = _pw_gzphase2.fixedflag ?  ((void)(pwGzstep), pw_gzphase2) : pwGzstep;
	pw_gzphase2a = _pw_gzphase2a.fixedflag ?  ((void)(myramptime), pw_gzphase2a) : myramptime;
	pw_gzphase2d = _pw_gzphase2d.fixedflag ?  ((void)(myramptime), pw_gzphase2d) : myramptime;

	fprintf(stderr, "predownload(): ampGzstep = %.3f, iampGzstep = %d \n", ampGzstep, iampGzstep);
	/* ----------------------------------------------------------------------------------------*/
	pw_gz0 = _pw_gz0.fixedflag ? ((void)(4000), pw_gz0) : 4000;
	...
	pw_gzBS0 = _pw_gzBS0.fixedflag ? ((void)(4000), pw_gzBS0) : 4000;
	pw_gzBS0a = _pw_gzBS0a.fixedflag ? ((void)(400), pw_gzBS0a) : 400;
	pw_gzBS0d = _pw_gzBS0d.fixedflag ? ((void)(400), pw_gzBS0d) : 400;
	a_gzBS0  = _a_gzBS0.fixedflag ?  ((void)(2.0), a_gzBS0) : 2.0;
	a_gzBS0  = _a_gzBS0.fixedflag ?  ((void)(0), a_gzBS0) : 0;  /* LHG 1/9/13:  simulations indicate that this doesnt' help much. */
	...
	rfscalesech  = _rfscalesech.fixedflag ?  ((void)(0.75), rfscalesech) : 0.75;  /* Empirically on sphere phantom, I didn't get an inversion unutl 0.65) */
	...
	pw_BS3rf  = _pw_BS3rf.fixedflag ?  ((void)(pw_BS1rf), pw_BS3rf) : pw_BS1rf;;
	a_BS3rf  = _a_BS3rf.fixedflag ?  ((void)(a_BS1rf), a_BS3rf) : a_BS1rf;
	res_BS3rf  = _res_BS3rf.fixedflag ?  ((void)(res_BS1rf), res_BS3rf) : res_BS1rf;
...
2*pw_gzspoila);
	...
	tmin  = _tmin.fixedflag ?   
			...
			((void)(RUP_GRD(tlead+tdel+tpre+0.5*pw_gzrf1+pw_gzrf1a+opte+pw_gx+mapdel+2*pw_gzphase1+4*pw_gzphase1a+pw_gzspoil+2*pw_gzspoila+timessi)), tmin) : RUP_GRD(tlead+tdel+tpre+0.5*pw_gzrf1+pw_gzrf1a+opte+pw_gx+mapdel+2*pw_gzphase1+4*pw_gzphase1a+pw_gzspoil+2*pw_gzspoila+timessi);

	psdseqtime  = _psdseqtime.fixedflag ?    ((void)(RUP_GRD(tmin)), psdseqtime) : RUP_GRD(tmin);

	seqtr  = _seqtr.fixedflag ?    ((void)(tmin*opslquant), seqtr) : tmin*opslquant;

	fprintf(stderr, "\npw_gzphase1=%d , pw_gzphase1a = %d", pw_gzphase1, pw_gzphase1a);
	fprintf(stderr, "\npsdseqtime, seqtr, tmin, optr=  %d   %d  %d  %d\n", psdseqtime,  seqtr,tmin,optr);

	t_adjust  = _t_adjust.fixedflag ?            ((void)(RUP_GRD(optr-psdseqtime*opslquant-t_tag-t_delay-tpre-pw_BS3rf)), t_adjust) : RUP_GRD(optr-psdseqtime*opslquant-t_tag-t_delay-tpre-pw_BS3rf);                 /* LHG 11.29.10 */
	...
	if(nl>1) tmin  = _tmin.fixedflag ?    ((void)(pw_gxspoil+2*pw_gxspoila), tmin) : tmin+pw_gxspoil+2*pw_gxspoila; 
...
so don't change the duration of pw_rf1 without adjusting this calculation ...*/
	...
	a_rf1  = _a_rf1.fixedflag ?   ((void)(opflip*1.3125/180), a_rf1) : opflip*1.3125/180;
	...
	a_rf0  = _a_rf0.fixedflag ?  ((void)(arf0), a_rf0) : arf0;		
        ...
        a_rf0  = _a_rf0.fixedflag ?  ((void)(0.25), a_rf0) : 0.25;
	 ...
	 */
	pw_BS0rf  = _pw_BS0rf.fixedflag ?  ((void)(pw_rf0), pw_BS0rf) : pw_rf0;
	a_BS0rf  = _a_BS0rf.fixedflag ?    ((void)(a_rf0*(float)doBS), a_BS0rf) : a_rf0*(float)doBS;
	a_BS0rf  = _a_BS0rf.fixedflag ?  ((void)(0), a_BS0rf) : 0; /* LHG 1/1/13: siimulations indicate that this pulse is not useful */ 		

	/*  spoilers to return the readout grads to a constant state  */

	if(nl>1)  {		/* used to be only if interleaving (nl>1)*/
		pw_gxspoila  = _pw_gxspoila.fixedflag ?  ((void)(2*cfrmp2xfs), pw_gxspoila) : 2*cfrmp2xfs;
		pw_gxspoild  = _pw_gxspoild.fixedflag ?  ((void)(2*cfrmp2xfs), pw_gxspoild) : 2*cfrmp2xfs;
		pw_gxspoil  = _pw_gxspoil.fixedflag ?    ((void)(500), pw_gxspoil) : 500;
		a_gxspoil  = _a_gxspoil.fixedflag ?  ((void)(0.5*loggrd.yfs), a_gxspoil) : 0.5*loggrd.yfs;
		pw_gyspoila  = _pw_gyspoila.fixedflag ?  ((void)(2*cfrmp2yfs), pw_gyspoila) : 2*cfrmp2yfs;
		pw_gyspoild  = _pw_gyspoild.fixedflag ?  ((void)(2*cfrmp2yfs), pw_gyspoild) : 2*cfrmp2yfs;
		pw_gyspoil  = _pw_gyspoil.fixedflag ?    ((void)(500), pw_gyspoil) : 500;
		a_gyspoil  = _a_gyspoil.fixedflag ?  ((void)(0.5*loggrd.yfs), a_gyspoil) : 0.5*loggrd.yfs;
	}
	...
	if ((exist(opcgate) == PSD_ON) && existcv(opcgate))
	{
		...
		pitslice  = _pitslice.fixedflag ?  ((void)(psdseqtime), pitslice) : psdseqtime;
	}
	else
	{
	 ...
	 */
	pw_gzspoil  = _pw_gzspoil.fixedflag ?  ((void)(1000), pw_gzspoil) : 1000;
	a_gzspoil  = _a_gzspoil.fixedflag ?  ((void)(0.7*loggrd.zfs), a_gzspoil) : 0.7*loggrd.zfs;
	pw_gzspoila  = _pw_gzspoila.fixedflag ?  ((void)(cfrmp2zfs), pw_gzspoila) : cfrmp2zfs;
	pw_gzspoild  = _pw_gzspoild.fixedflag ?  ((void)(cfrmp2zfs), pw_gzspoild) : cfrmp2zfs;


	/*-------------------------------------------------*/
	minte  = _minte.fixedflag ?    ((void)(pw_rf1/2+pw_gzrf1d+pw_gzrf1r+2*pw_gzrf1ra), minte) : pw_rf1/2+pw_gzrf1d+pw_gzrf1r+2*pw_gzrf1ra;
	minte  = _minte.fixedflag ?    ((void)(2*pw_gzphase1a+pw_gzphase1), minte) : minte+2*pw_gzphase1a+pw_gzphase1;

	/* LHG 6.29.12 - these are the flow spoilers: */
	if(mycrush==1){
		fprintf(stderr, "\nSetting Flow Crusher parameters ...");
		pw_gzsp3  = _pw_gzsp3.fixedflag ?  ((void)(3000), pw_gzsp3) : 3000;
		pw_gzsp3a  = _pw_gzsp3a.fixedflag ?    ((void)(500), pw_gzsp3a) : 500;
		pw_gzsp3d  = _pw_gzsp3d.fixedflag ?   ((void)(pw_gzsp3a), pw_gzsp3d) : pw_gzsp3a;
		pw_gzsp4  = _pw_gzsp4.fixedflag ?  ((void)(pw_gzsp3), pw_gzsp4) : pw_gzsp3;
		pw_gzsp4a  = _pw_gzsp4a.fixedflag ?  ((void)(pw_gzsp3a), pw_gzsp4a) : pw_gzsp3a;
		pw_gzsp4d  = _pw_gzsp4d.fixedflag ?  ((void)(pw_gzsp3a), pw_gzsp4d) : pw_gzsp3a;
		a_gzsp3  = _a_gzsp3.fixedflag ?  ((void)(2.0), a_gzsp3) : 2.0;
		a_gzsp4  = _a_gzsp4.fixedflag ?  ((void)(-a_gzsp3), a_gzsp4) : -a_gzsp3;

		pw_gxsp3  = _pw_gxsp3.fixedflag ?  ((void)(pw_gzsp3), pw_gxsp3) : pw_gzsp3;
		pw_gxsp3a  = _pw_gxsp3a.fixedflag ?  ((void)(pw_gzsp3a), pw_gxsp3a) : pw_gzsp3a;
		pw_gxsp3d  = _pw_gxsp3d.fixedflag ?  ((void)(pw_gzsp3a), pw_gxsp3d) : pw_gzsp3a;
		pw_gxsp4  = _pw_gxsp4.fixedflag ?  ((void)(pw_gzsp3), pw_gxsp4) : pw_gzsp3;
		pw_gxsp4a  = _pw_gxsp4a.fixedflag ?  ((void)(pw_gzsp3a), pw_gxsp4a) : pw_gzsp3a;
		pw_gxsp4d  = _pw_gxsp4d.fixedflag ?  ((void)(pw_gzsp3a), pw_gxsp4d) : pw_gzsp3a;
		a_gxsp3  = _a_gxsp3.fixedflag ?  ((void)(2.0), a_gxsp3) : 2.0;
		a_gxsp4  = _a_gxsp4.fixedflag ?  ((void)(-a_gxsp3), a_gxsp4) : -a_gxsp3;

		pw_gysp3  = _pw_gysp3.fixedflag ?  ((void)(pw_gzsp3), pw_gysp3) : pw_gzsp3;
		pw_gysp3a  = _pw_gysp3a.fixedflag ?  ((void)(pw_gzsp3a), pw_gysp3a) : pw_gzsp3a;
		pw_gysp3d  = _pw_gysp3d.fixedflag ?  ((void)(pw_gzsp3a), pw_gysp3d) : pw_gzsp3a;
		pw_gysp4  = _pw_gysp4.fixedflag ?  ((void)(pw_gzsp3), pw_gysp4) : pw_gzsp3;
		pw_gysp4a  = _pw_gysp4a.fixedflag ?  ((void)(pw_gzsp3a), pw_gysp4a) : pw_gzsp3a;
		pw_gysp4d  = _pw_gysp4d.fixedflag ?  ((void)(pw_gzsp3a), pw_gysp4d) : pw_gzsp3a;
		a_gysp3  = _a_gysp3.fixedflag ?  ((void)(2.0), a_gysp3) : 2.0;
		a_gysp4  = _a_gysp4.fixedflag ?  ((void)(-a_gysp3), a_gysp4) : -a_gysp3;


		delta1  = _delta1.fixedflag ?    ((void)(1000), delta1) : 1000;

		/* LHG 2/1/11  adjust minte to account for the flow crushers */
		minte  = _minte.fixedflag ?      ((void)(2*pw_gzsp3+4*pw_gzsp3a+delta1), minte) : minte+2*pw_gzsp3+4*pw_gzsp3a+delta1;
