...
#include "pcasl3dgrase01.tgtdecl.h"
...
STATUS pulsegen(void)
{
			...
			
    {
        ...
        createinstr( &gzrf1a,(long)(RUP_GRD(tlead+pw_gzrf1a+0)-pw_gzrf1a),
                     pw_gzrf1a,ia_gzrf1);
        createconst(&gzrf1,ZGRAD,pw_gzrf1,MAX_PG_WAMP);
        createinstr( &gzrf1,(long)(RUP_GRD(tlead+pw_gzrf1a+0)),
                     pw_gzrf1,ia_gzrf1);
        createramp(&gzrf1d,ZGRAD,pw_gzrf1d,MAX_PG_WAMP,
                   (short)0,(short)(maxGradRes*(pw_gzrf1d/GRAD_UPDATE_TIME)),
                   pg_beta);
        createinstr( &gzrf1d,(long)(RUP_GRD(tlead+pw_gzrf1a+0)+pw_gzrf1),
                     pw_gzrf1d,ia_gzrf1);

        /* Now create the rf pulse */
        createsinc(&rf1,(WF_PROCESSOR)wg_rf1,res_rf1,
                   MAX_PG_WAMP,cyc_rf1, alpha_rf1);
        createinstr( &rf1,(long)(RUP_GRD(tlead+pw_gzrf1a+0)) + psd_rf_wait,
                     pw_rf1,ia_rf1);
        linkpulses(4,&rf1,&gzrf1,&gzrf1a,
                   &gzrf1d);
        addrfbits(&rf1,off_rf1,(long)(RUP_GRD(tlead+pw_gzrf1a+0)) + psd_rf_wait,
                  pw_rf1);
    }
    ...
    setWaveformPurpose(gzrf1ra, gzrf1r.purpose);
    setWaveformPurpose(gzrf1rd, gzrf1r.purpose);
    trapezoid((WF_PROCESSOR)wg_gzrf1r, "gzrf1r", &gzrf1r, &gzrf1ra,
              &gzrf1rd, pw_gzrf1r, pw_gzrf1ra, pw_gzrf1rd,
              ia_gzrf1r, 0, 0, 0, 0, pend(&gzrf1d,"gzrf1d",0)+pw_gzrf1ra-pw_gzrf1ra, TRAP_ALL,
              &loggrd);
  ...
  {
    pulsename(&tipdown_core,"tipdown_core");
    createseq(&tipdown_core,RUP_GRD(t_tipdown_core), off_tipdown_core);
#if defined(HOST_TGT)
    /* Update sequence counter and get current sequence entry index */
    updateIndex( &idx_tipdown_core );
    ...
    setWaveformPurpose(gz180crush1a, gz180crush1.purpose);
    setWaveformPurpose(gz180crush1d, gz180crush1.purpose);
    trapezoid((WF_PROCESSOR)wg_gz180crush1, "gz180crush1", &gz180crush1, &gz180crush1a,
              &gz180crush1d, pw_gz180crush1, pw_gz180crush1a, pw_gz180crush1d,
              ia_gz180crush1, 0, 0, 0, 0, RUP_GRD(tlead+pw_gz180crush1a+0)-pw_gz180crush1a, TRAP_ALL,
              &loggrd);
	...
	fprintf(stderr, "\npulsegen: generating RF2 pulse for FSE train   ... ");
			 ...
			 /* use the same pulse as the 90, but double it */ 
			      /* (mm) */
			 /*flip angle should be a 180*/
			...
			
    {
        ...
        setWaveformPurpose(gzrf2a, RF_SELECT_GRAD);
        pulsename(&gzrf2,"gzrf2");
        setWaveformPurpose(gzrf2, RF_SELECT_GRAD);
        pulsename(&gzrf2d,"gzrf2d");
        setWaveformPurpose(gzrf2d, RF_SELECT_GRAD);
        pulsename(&rf2,"rf2");
        ...
        createramp(&gzrf2a,ZGRAD,pw_gzrf2a,(short)0,
                   MAX_PG_WAMP,(short)(maxGradRes*(pw_gzrf2a/
                       GRAD_UPDATE_TIME)),pg_beta);
        createinstr( &gzrf2a,(long)(pend(&gz180crush1d,"gz180crush1d",0)+pw_gzrf2a-pw_gzrf2a),
                     pw_gzrf2a,ia_gzrf2);
        createconst(&gzrf2,ZGRAD,pw_gzrf2,MAX_PG_WAMP);
        createinstr( &gzrf2,(long)(pend(&gz180crush1d,"gz180crush1d",0)+pw_gzrf2a),
                     pw_gzrf2,ia_gzrf2);
        createramp(&gzrf2d,ZGRAD,pw_gzrf2d,MAX_PG_WAMP,
                   (short)0,(short)(maxGradRes*(pw_gzrf2d/GRAD_UPDATE_TIME)),
                   pg_beta);
        createinstr( &gzrf2d,(long)(pend(&gz180crush1d,"gz180crush1d",0)+pw_gzrf2a+pw_gzrf2),
                     pw_gzrf2d,ia_gzrf2);

        /* Now create the rf pulse */
        createsinc(&rf2,(WF_PROCESSOR)wg_rf2,res_rf2,
                   MAX_PG_WAMP,cyc_rf2, alpha_rf2);
        createinstr( &rf2,(long)(pend(&gz180crush1d,"gz180crush1d",0)+pw_gzrf2a) + psd_rf_wait,
                     pw_rf2,ia_rf2);
        linkpulses(4,&rf2,&gzrf2,&gzrf2a,
                   &gzrf2d);
        addrfbits(&rf2,off_rf2,(long)(pend(&gz180crush1d,"gz180crush1d",0)+pw_gzrf2a) + psd_rf_wait,
                  pw_rf2);
    }
    ...
    setWaveformPurpose(gz180crush2a, gz180crush2.purpose);
    setWaveformPurpose(gz180crush2d, gz180crush2.purpose);
    trapezoid((WF_PROCESSOR)wg_gz180crush2, "gz180crush2", &gz180crush2, &gz180crush2a,
              &gz180crush2d, pw_gz180crush2, pw_gz180crush2a, pw_gz180crush2d,
              ia_gz180crush2, 0, 0, 0, 0, pend(&gzrf2d,"gzrf2d",0)+pw_gz180crush2a-pw_gz180crush2a, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gzphase1a, gzphase1.purpose);
    setWaveformPurpose(gzphase1d, gzphase1.purpose);
    trapezoid((WF_PROCESSOR)wg_gzphase1, "gzphase1", &gzphase1, &gzphase1a,
              &gzphase1d, pw_gzphase1, pw_gzphase1a, pw_gzphase1d,
              ia_gzphase1, 0, 0, 0, 0, RUP_GRD(pend(&gz180crush2d,"gz180crush2d",0)+pw_gzphase1a)-pw_gzphase1a, TRAP_ALL,
              &loggrd);
	...
	readpos = RUP_GRD(pend(&gzphase1d,"gzphase1d",0) + 4   );
  ...
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_mapx || TYPYGRAD == (WF_PROCESSOR)wg_mapx || TYPZGRAD == (WF_PROCESSOR)wg_mapx
          || TYPBXGRAD == (WF_PROCESSOR)wg_mapx || TYPBYGRAD == (WF_PROCESSOR)wg_mapx || TYPBZGRAD == (WF_PROCESSOR)wg_mapx )
      {
          setWaveformPurpose(mapx, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_mapx || TYPRHO2 == (WF_PROCESSOR)wg_mapx || TYPTHETA == (WF_PROCESSOR)wg_mapx
               || TYPBRHO1 == (WF_PROCESSOR)wg_mapx || TYPBRHO2 == (WF_PROCESSOR)wg_mapx || TYPBTHETA == (WF_PROCESSOR)wg_mapx
               || TYPOMEGA == (WF_PROCESSOR)wg_mapx || TYPBOMEGA == (WF_PROCESSOR)wg_mapx )
      {
          setWaveformPurpose(mapx, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_mapx || TYPBSSP == (WF_PROCESSOR)wg_mapx )
      {
          setWaveformPurpose(mapx, WAIT_SSP);
      }
    pulsename(&mapx,"mapx");
    createconst(&mapx,(WF_PROCESSOR)wg_mapx,pw_mapx,(short)0); 
    createinstr( &mapx,(long)(waitloc),pw_mapx,0);
  }

		   
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_mapy || TYPYGRAD == (WF_PROCESSOR)wg_mapy || TYPZGRAD == (WF_PROCESSOR)wg_mapy
          || TYPBXGRAD == (WF_PROCESSOR)wg_mapy || TYPBYGRAD == (WF_PROCESSOR)wg_mapy || TYPBZGRAD == (WF_PROCESSOR)wg_mapy )
      {
          setWaveformPurpose(mapy, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_mapy || TYPRHO2 == (WF_PROCESSOR)wg_mapy || TYPTHETA == (WF_PROCESSOR)wg_mapy
               || TYPBRHO1 == (WF_PROCESSOR)wg_mapy || TYPBRHO2 == (WF_PROCESSOR)wg_mapy || TYPBTHETA == (WF_PROCESSOR)wg_mapy
               || TYPOMEGA == (WF_PROCESSOR)wg_mapy || TYPBOMEGA == (WF_PROCESSOR)wg_mapy )
      {
          setWaveformPurpose(mapy, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_mapy || TYPBSSP == (WF_PROCESSOR)wg_mapy )
      {
          setWaveformPurpose(mapy, WAIT_SSP);
      }
    pulsename(&mapy,"mapy");
    createconst(&mapy,(WF_PROCESSOR)wg_mapy,pw_mapy,(short)0); 
    createinstr( &mapy,(long)(waitloc),pw_mapy,0);
  }

		   
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_mapz || TYPYGRAD == (WF_PROCESSOR)wg_mapz || TYPZGRAD == (WF_PROCESSOR)wg_mapz
          || TYPBXGRAD == (WF_PROCESSOR)wg_mapz || TYPBYGRAD == (WF_PROCESSOR)wg_mapz || TYPBZGRAD == (WF_PROCESSOR)wg_mapz )
      {
          setWaveformPurpose(mapz, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_mapz || TYPRHO2 == (WF_PROCESSOR)wg_mapz || TYPTHETA == (WF_PROCESSOR)wg_mapz
               || TYPBRHO1 == (WF_PROCESSOR)wg_mapz || TYPBRHO2 == (WF_PROCESSOR)wg_mapz || TYPBTHETA == (WF_PROCESSOR)wg_mapz
               || TYPOMEGA == (WF_PROCESSOR)wg_mapz || TYPBOMEGA == (WF_PROCESSOR)wg_mapz )
      {
          setWaveformPurpose(mapz, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_mapz || TYPBSSP == (WF_PROCESSOR)wg_mapz )
      {
          setWaveformPurpose(mapz, WAIT_SSP);
      }
    pulsename(&mapz,"mapz");
    createconst(&mapz,(WF_PROCESSOR)wg_mapz,pw_mapz,(short)0); 
    createinstr( &mapz,(long)(waitloc),pw_mapz,0);
  }

		   
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_mapt || TYPYGRAD == (WF_PROCESSOR)wg_mapt || TYPZGRAD == (WF_PROCESSOR)wg_mapt
          || TYPBXGRAD == (WF_PROCESSOR)wg_mapt || TYPBYGRAD == (WF_PROCESSOR)wg_mapt || TYPBZGRAD == (WF_PROCESSOR)wg_mapt )
      {
          setWaveformPurpose(mapt, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_mapt || TYPRHO2 == (WF_PROCESSOR)wg_mapt || TYPTHETA == (WF_PROCESSOR)wg_mapt
               || TYPBRHO1 == (WF_PROCESSOR)wg_mapt || TYPBRHO2 == (WF_PROCESSOR)wg_mapt || TYPBTHETA == (WF_PROCESSOR)wg_mapt
               || TYPOMEGA == (WF_PROCESSOR)wg_mapt || TYPBOMEGA == (WF_PROCESSOR)wg_mapt )
      {
          setWaveformPurpose(mapt, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_mapt || TYPBSSP == (WF_PROCESSOR)wg_mapt )
      {
          setWaveformPurpose(mapt, WAIT_SSP);
      }
    pulsename(&mapt,"mapt");
    createconst(&mapt,(WF_PROCESSOR)wg_mapt,pw_mapt,(short)0); 
    createinstr( &mapt,(long)(waitloc),pw_mapt,0);
  }
  ...
  {
	  pulsename(&gx,"gx");
	  createreserve(&gx, XGRAD, res_gx);
	  if(1>0) 		/* load normal */
		  for (i=0; i<res_gx; i++)
			  ibuf[i] = Gx[i];
	  else 			/* load reversed */
		  for (i=0; i<res_gx; i++)
			  ibuf[i] = -Gx[(res_gx-i-1)];
	  movewaveimm(ibuf,&gx,(int)0,res_gx,TOHARDWARE);
	  setweos(EOS_DEAD,&gx,res_gx-1);



	  /* LHG 10.26.15  */
	  createinstr(&gx, (LONG)(readpos) , pw_gx, ia_gx);
	  if ((XGRAD==TYPRHO1)) 
			/* || ($[int_wgname]==TYPRHO2) || ($[int_wgname]==TYPTHETA) || ($[int_wgname]==TYPOMEGA))*/
	  {
		  addrfbits(&gx, 0 , (LONG)(readpos) , pw_gx);
	  }
  }
  ...
  {
	  pulsename(&gy,"gy");
	  createreserve(&gy, YGRAD, res_gy);
	  if(1>0) 		/* load normal */
		  for (i=0; i<res_gy; i++)
			  ibuf[i] = Gy[i];
	  else 			/* load reversed */
		  for (i=0; i<res_gy; i++)
			  ibuf[i] = -Gy[(res_gy-i-1)];
	  movewaveimm(ibuf,&gy,(int)0,res_gy,TOHARDWARE);
	  setweos(EOS_DEAD,&gy,res_gy-1);



	  /* LHG 10.26.15  */
	  createinstr(&gy, (LONG)(readpos) , pw_gy, ia_gy);
	  if ((YGRAD==TYPRHO1)) 
			/* || ($[int_wgname]==TYPRHO2) || ($[int_wgname]==TYPTHETA) || ($[int_wgname]==TYPOMEGA))*/
	  {
		  addrfbits(&gy, 0 , (LONG)(readpos) , pw_gy);
	  }
  }
  ...
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_maps1 || TYPYGRAD == (WF_PROCESSOR)wg_maps1 || TYPZGRAD == (WF_PROCESSOR)wg_maps1
          || TYPBXGRAD == (WF_PROCESSOR)wg_maps1 || TYPBYGRAD == (WF_PROCESSOR)wg_maps1 || TYPBZGRAD == (WF_PROCESSOR)wg_maps1 )
      {
          setWaveformPurpose(maps1, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_maps1 || TYPRHO2 == (WF_PROCESSOR)wg_maps1 || TYPTHETA == (WF_PROCESSOR)wg_maps1
               || TYPBRHO1 == (WF_PROCESSOR)wg_maps1 || TYPBRHO2 == (WF_PROCESSOR)wg_maps1 || TYPBTHETA == (WF_PROCESSOR)wg_maps1
               || TYPOMEGA == (WF_PROCESSOR)wg_maps1 || TYPBOMEGA == (WF_PROCESSOR)wg_maps1 )
      {
          setWaveformPurpose(maps1, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_maps1 || TYPBSSP == (WF_PROCESSOR)wg_maps1 )
      {
          setWaveformPurpose(maps1, WAIT_SSP);
      }
    pulsename(&maps1,"maps1");
    createconst(&maps1,(WF_PROCESSOR)wg_maps1,pw_maps1,(short)0); 
    createinstr( &maps1,(long)(waitloc),pw_maps1,0);
  }
	  ...
	  
    {
        ...
        acqq(&echo1, (long)(readpos+daqdel),(long)(DEFAULTPOS),
  ...
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_mapx2 || TYPYGRAD == (WF_PROCESSOR)wg_mapx2 || TYPZGRAD == (WF_PROCESSOR)wg_mapx2
          || TYPBXGRAD == (WF_PROCESSOR)wg_mapx2 || TYPBYGRAD == (WF_PROCESSOR)wg_mapx2 || TYPBZGRAD == (WF_PROCESSOR)wg_mapx2 )
      {
          setWaveformPurpose(mapx2, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_mapx2 || TYPRHO2 == (WF_PROCESSOR)wg_mapx2 || TYPTHETA == (WF_PROCESSOR)wg_mapx2
               || TYPBRHO1 == (WF_PROCESSOR)wg_mapx2 || TYPBRHO2 == (WF_PROCESSOR)wg_mapx2 || TYPBTHETA == (WF_PROCESSOR)wg_mapx2
               || TYPOMEGA == (WF_PROCESSOR)wg_mapx2 || TYPBOMEGA == (WF_PROCESSOR)wg_mapx2 )
      {
          setWaveformPurpose(mapx2, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_mapx2 || TYPBSSP == (WF_PROCESSOR)wg_mapx2 )
      {
          setWaveformPurpose(mapx2, WAIT_SSP);
      }
    pulsename(&mapx2,"mapx2");
    createconst(&mapx2,(WF_PROCESSOR)wg_mapx2,pw_mapx2,(short)0); 
    createinstr( &mapx2,(long)(waitloc2),pw_mapx2,0);
  }

		   
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_mapy2 || TYPYGRAD == (WF_PROCESSOR)wg_mapy2 || TYPZGRAD == (WF_PROCESSOR)wg_mapy2
          || TYPBXGRAD == (WF_PROCESSOR)wg_mapy2 || TYPBYGRAD == (WF_PROCESSOR)wg_mapy2 || TYPBZGRAD == (WF_PROCESSOR)wg_mapy2 )
      {
          setWaveformPurpose(mapy2, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_mapy2 || TYPRHO2 == (WF_PROCESSOR)wg_mapy2 || TYPTHETA == (WF_PROCESSOR)wg_mapy2
               || TYPBRHO1 == (WF_PROCESSOR)wg_mapy2 || TYPBRHO2 == (WF_PROCESSOR)wg_mapy2 || TYPBTHETA == (WF_PROCESSOR)wg_mapy2
               || TYPOMEGA == (WF_PROCESSOR)wg_mapy2 || TYPBOMEGA == (WF_PROCESSOR)wg_mapy2 )
      {
          setWaveformPurpose(mapy2, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_mapy2 || TYPBSSP == (WF_PROCESSOR)wg_mapy2 )
      {
          setWaveformPurpose(mapy2, WAIT_SSP);
      }
    pulsename(&mapy2,"mapy2");
    createconst(&mapy2,(WF_PROCESSOR)wg_mapy2,pw_mapy2,(short)0); 
    createinstr( &mapy2,(long)(waitloc2),pw_mapy2,0);
  }

		   
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_mapz2 || TYPYGRAD == (WF_PROCESSOR)wg_mapz2 || TYPZGRAD == (WF_PROCESSOR)wg_mapz2
          || TYPBXGRAD == (WF_PROCESSOR)wg_mapz2 || TYPBYGRAD == (WF_PROCESSOR)wg_mapz2 || TYPBZGRAD == (WF_PROCESSOR)wg_mapz2 )
      {
          setWaveformPurpose(mapz2, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_mapz2 || TYPRHO2 == (WF_PROCESSOR)wg_mapz2 || TYPTHETA == (WF_PROCESSOR)wg_mapz2
               || TYPBRHO1 == (WF_PROCESSOR)wg_mapz2 || TYPBRHO2 == (WF_PROCESSOR)wg_mapz2 || TYPBTHETA == (WF_PROCESSOR)wg_mapz2
               || TYPOMEGA == (WF_PROCESSOR)wg_mapz2 || TYPBOMEGA == (WF_PROCESSOR)wg_mapz2 )
      {
          setWaveformPurpose(mapz2, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_mapz2 || TYPBSSP == (WF_PROCESSOR)wg_mapz2 )
      {
          setWaveformPurpose(mapz2, WAIT_SSP);
      }
    pulsename(&mapz2,"mapz2");
    createconst(&mapz2,(WF_PROCESSOR)wg_mapz2,pw_mapz2,(short)0); 
    createinstr( &mapz2,(long)(waitloc2),pw_mapz2,0);
  }

		   
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_mapt2 || TYPYGRAD == (WF_PROCESSOR)wg_mapt2 || TYPZGRAD == (WF_PROCESSOR)wg_mapt2
          || TYPBXGRAD == (WF_PROCESSOR)wg_mapt2 || TYPBYGRAD == (WF_PROCESSOR)wg_mapt2 || TYPBZGRAD == (WF_PROCESSOR)wg_mapt2 )
      {
          setWaveformPurpose(mapt2, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_mapt2 || TYPRHO2 == (WF_PROCESSOR)wg_mapt2 || TYPTHETA == (WF_PROCESSOR)wg_mapt2
               || TYPBRHO1 == (WF_PROCESSOR)wg_mapt2 || TYPBRHO2 == (WF_PROCESSOR)wg_mapt2 || TYPBTHETA == (WF_PROCESSOR)wg_mapt2
               || TYPOMEGA == (WF_PROCESSOR)wg_mapt2 || TYPBOMEGA == (WF_PROCESSOR)wg_mapt2 )
      {
          setWaveformPurpose(mapt2, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_mapt2 || TYPBSSP == (WF_PROCESSOR)wg_mapt2 )
      {
          setWaveformPurpose(mapt2, WAIT_SSP);
      }
    pulsename(&mapt2,"mapt2");
    createconst(&mapt2,(WF_PROCESSOR)wg_mapt2,pw_mapt2,(short)0); 
    createinstr( &mapt2,(long)(pend(&thetrec,"thetrec",0)),pw_mapt2,0);
  }
  ...
  {
	  pulsename(&gx2,"gx2");
	  createreserve(&gx2, XGRAD, res_gx2);
	  if(-1>0) 		/* load normal */
		  for (i=0; i<res_gx2; i++)
			  ibuf[i] = Gx[i];
	  else 			/* load reversed */
		  for (i=0; i<res_gx2; i++)
			  ibuf[i] = -Gx[(res_gx2-i-1)];
	  movewaveimm(ibuf,&gx2,(int)0,res_gx2,TOHARDWARE);
	  setweos(EOS_DEAD,&gx2,res_gx2-1);



	  /* LHG 10.26.15  */
	  createinstr(&gx2, (LONG)(readpos) , pw_gx2, ia_gx2);
	  if ((XGRAD==TYPRHO1)) 
			/* || ($[int_wgname]==TYPRHO2) || ($[int_wgname]==TYPTHETA) || ($[int_wgname]==TYPOMEGA))*/
	  {
		  addrfbits(&gx2, 0 , (LONG)(readpos) , pw_gx2);
	  }
  }
  ...
  {
	  pulsename(&gy2,"gy2");
	  createreserve(&gy2, YGRAD, res_gy2);
	  if(-1>0) 		/* load normal */
		  for (i=0; i<res_gy2; i++)
			  ibuf[i] = Gy[i];
	  else 			/* load reversed */
		  for (i=0; i<res_gy2; i++)
			  ibuf[i] = -Gy[(res_gy2-i-1)];
	  movewaveimm(ibuf,&gy2,(int)0,res_gy2,TOHARDWARE);
	  setweos(EOS_DEAD,&gy2,res_gy2-1);



	  /* LHG 10.26.15  */
	  createinstr(&gy2, (LONG)(readpos) , pw_gy2, ia_gy2);
	  if ((YGRAD==TYPRHO1)) 
			/* || ($[int_wgname]==TYPRHO2) || ($[int_wgname]==TYPTHETA) || ($[int_wgname]==TYPOMEGA))*/
	  {
		  addrfbits(&gy2, 0 , (LONG)(readpos) , pw_gy2);
	  }
  }

		   
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_maps2 || TYPYGRAD == (WF_PROCESSOR)wg_maps2 || TYPZGRAD == (WF_PROCESSOR)wg_maps2
          || TYPBXGRAD == (WF_PROCESSOR)wg_maps2 || TYPBYGRAD == (WF_PROCESSOR)wg_maps2 || TYPBZGRAD == (WF_PROCESSOR)wg_maps2 )
      {
          setWaveformPurpose(maps2, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_maps2 || TYPRHO2 == (WF_PROCESSOR)wg_maps2 || TYPTHETA == (WF_PROCESSOR)wg_maps2
               || TYPBRHO1 == (WF_PROCESSOR)wg_maps2 || TYPBRHO2 == (WF_PROCESSOR)wg_maps2 || TYPBTHETA == (WF_PROCESSOR)wg_maps2
               || TYPOMEGA == (WF_PROCESSOR)wg_maps2 || TYPBOMEGA == (WF_PROCESSOR)wg_maps2 )
      {
          setWaveformPurpose(maps2, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_maps2 || TYPBSSP == (WF_PROCESSOR)wg_maps2 )
      {
          setWaveformPurpose(maps2, WAIT_SSP);
      }
    pulsename(&maps2,"maps2");
    createconst(&maps2,(WF_PROCESSOR)wg_maps2,pw_maps2,(short)0); 
    createinstr( &maps2,(long)(waitloc2),pw_maps2,0);
  }

		  
    {
        pulsename(&echo2,"echo2");
        acqq(&echo2, (long)(readpos+daqdel),(long)(DEFAULTPOS),
             (long)(DEFAULTPOS),(long)filter_echo2,
             (TYPDAB_PACKETS)DABNORM);
    }
  ...
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_maps3 || TYPYGRAD == (WF_PROCESSOR)wg_maps3 || TYPZGRAD == (WF_PROCESSOR)wg_maps3
          || TYPBXGRAD == (WF_PROCESSOR)wg_maps3 || TYPBYGRAD == (WF_PROCESSOR)wg_maps3 || TYPBZGRAD == (WF_PROCESSOR)wg_maps3 )
      {
          setWaveformPurpose(maps3, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_maps3 || TYPRHO2 == (WF_PROCESSOR)wg_maps3 || TYPTHETA == (WF_PROCESSOR)wg_maps3
               || TYPBRHO1 == (WF_PROCESSOR)wg_maps3 || TYPBRHO2 == (WF_PROCESSOR)wg_maps3 || TYPBTHETA == (WF_PROCESSOR)wg_maps3
               || TYPOMEGA == (WF_PROCESSOR)wg_maps3 || TYPBOMEGA == (WF_PROCESSOR)wg_maps3 )
      {
          setWaveformPurpose(maps3, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_maps3 || TYPBSSP == (WF_PROCESSOR)wg_maps3 )
      {
          setWaveformPurpose(maps3, WAIT_SSP);
      }
    pulsename(&maps3,"maps3");
    createconst(&maps3,(WF_PROCESSOR)wg_maps3,pw_maps3,(short)0); 
    createinstr( &maps3,(long)(waitloc2+daqdel),pw_maps3,0);
  }
    ...
    setWaveformPurpose(gzphase2a, gzphase2.purpose);
    setWaveformPurpose(gzphase2d, gzphase2.purpose);
    trapezoid((WF_PROCESSOR)wg_gzphase2, "gzphase2", &gzphase2, &gzphase2a,
              &gzphase2d, pw_gzphase2, pw_gzphase2a, pw_gzphase2d,
              ia_gzphase2, 0, 0, 0, 0, RUP_GRD(pend(&gx,"gx",0)+pw_gzphase2a)-pw_gzphase2a, TRAP_ALL,
              &loggrd);
  ...
  {
    pulsename(&gxpre,"gxpre");
    createsinusoid(&gxpre,(WF_PROCESSOR)wg_gxpre,res_gxpre,
		   ia_gxprew,phs_gxpre,phl_gxpre,
		   off_gxpre);
    createinstr(&gxpre,(long)(RUP_GRD(pend(&gx,"gx",0))),pw_gxpre,ia_gxpre);
     
    if ((wg_gxpre==TYPRHO1)||(wg_gxpre==TYPRHO2))
      {
	addrfbits(&gxpre,0,(long)(RUP_GRD(pend(&gx,"gx",0))),pw_gxpre);
      }
  }
  ...
  {
    pulsename(&gypre,"gypre");
    createsinusoid(&gypre,(WF_PROCESSOR)wg_gypre,res_gypre,
		   ia_gyprew,phs_gypre,phl_gypre,
		   off_gypre);
    createinstr(&gypre,(long)(RUP_GRD(pend(&gx,"gx",0))),pw_gypre,ia_gypre);
     
    if ((wg_gypre==TYPRHO1)||(wg_gypre==TYPRHO2))
      {
	addrfbits(&gypre,0,(long)(RUP_GRD(pend(&gx,"gx",0))),pw_gypre);
      }
  }
	     ...
	     
  {
    ...
    createseq(&seqcore,t_seqcore+textra, off_seqcore);
#if defined(HOST_TGT)
    /* Update sequence counter and get current sequence entry index */
  ...
  {
    pulsename(&BS0rf,"BS0rf");
    createextwave(&BS0rf,(WF_PROCESSOR)wg_BS0rf,
                  res_BS0rf,fileloc_BS0rf);
    if ((wg_BS0rf==TYPRHO1)||(wg_BS0rf==TYPRHO2) ||
	(wg_BS0rf==TYPTHETA)||(wg_BS0rf==TYPOMEGA))
      {
	createinstr( &BS0rf,(long)(RUP_RF(psd_rf_wait)) + psd_rf_wait, 
		    pw_BS0rf,ia_BS0rf);
	addrfbits(&BS0rf,off_BS0rf,(long)(RUP_RF(psd_rf_wait)) + psd_rf_wait,
		  pw_BS0rf);
      }
    else
      {
	createinstr( &BS0rf,(long)(RUP_RF(psd_rf_wait)), 
		    pw_BS0rf,ia_BS0rf);
      }
  }
  ...
  {
    pulsename(&BS0rf_theta,"BS0rf_theta");
    createextwave(&BS0rf_theta,(WF_PROCESSOR)wg_BS0rf_theta,
                  res_BS0rf_theta,fileloc_BS0rf_theta);
    if ((wg_BS0rf_theta==TYPRHO1)||(wg_BS0rf_theta==TYPRHO2) ||
	(wg_BS0rf_theta==TYPTHETA)||(wg_BS0rf_theta==TYPOMEGA))
      {
	createinstr( &BS0rf_theta,(long)(RUP_RF(psd_rf_wait)) + psd_rf_wait, 
		    pw_BS0rf_theta,ia_BS0rf_theta);
	addrfbits(&BS0rf_theta,off_BS0rf_theta,(long)(RUP_RF(psd_rf_wait)) + psd_rf_wait,
		  pw_BS0rf_theta);
      }
    else
      {
	createinstr( &BS0rf_theta,(long)(RUP_RF(psd_rf_wait)), 
		    pw_BS0rf_theta,ia_BS0rf_theta);
      }
  }
    ...
    setWaveformPurpose(gzBS0rfspoilera, gzBS0rfspoiler.purpose);
    setWaveformPurpose(gzBS0rfspoilerd, gzBS0rfspoiler.purpose);
    trapezoid((WF_PROCESSOR)wg_gzBS0rfspoiler, "gzBS0rfspoiler", &gzBS0rfspoiler, &gzBS0rfspoilera,
              &gzBS0rfspoilerd, pw_gzBS0rfspoiler, pw_gzBS0rfspoilera, pw_gzBS0rfspoilerd,
              ia_gzBS0rfspoiler, 0, 0, 0, 0, RUP_GRD(pendall(&BS0rf,0)+pw_gzBS0rfspoilera)-pw_gzBS0rfspoilera, TRAP_ALL,
              &loggrd);
  ...
  {
    pulsename(&preBScore,"preBScore");
    createseq(&preBScore,RUP_RF(t_preBS-timessi), off_preBScore);
#if defined(HOST_TGT)
    /* Update sequence counter and get current sequence entry index */
    updateIndex( &idx_preBScore );
    printDebug( DBLEVEL1, (dbLevel_t)seg_debug, "SEQLENGTH",
                "idx_preBScore = %d\n", idx_preBScore );
#endif
  }
  ...
  {
    pulsename(&rftag1,"rftag1");
    createextwave(&rftag1,(WF_PROCESSOR)wg_rftag1,
                  res_rftag1,fileloc_rftag1);
    if ((wg_rftag1==TYPRHO1)||(wg_rftag1==TYPRHO2) ||
	(wg_rftag1==TYPTHETA)||(wg_rftag1==TYPOMEGA))
      {
	createinstr( &rftag1,(long)(RUP_GRD(pw_gzrftag1a)) + psd_rf_wait, 
		    pw_rftag1,ia_rftag1);
	addrfbits(&rftag1,off_rftag1,(long)(RUP_GRD(pw_gzrftag1a)) + psd_rf_wait,
		  pw_rftag1);
      }
    else
      {
	createinstr( &rftag1,(long)(RUP_GRD(pw_gzrftag1a)), 
		    pw_rftag1,ia_rftag1);
      }
  }
    ...
    setWaveformPurpose(gzrftag1a, gzrftag1.purpose);
    setWaveformPurpose(gzrftag1d, gzrftag1.purpose);
    trapezoid((WF_PROCESSOR)wg_gzrftag1, "gzrftag1", &gzrftag1, &gzrftag1a,
              &gzrftag1d, pw_gzrftag1, pw_gzrftag1a, pw_gzrftag1d,
              ia_gzrftag1, 0, 0, 0, 0, RUP_GRD(pw_gzrftag1a)-pw_gzrftag1a, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gzrftag1ra, gzrftag1r.purpose);
    setWaveformPurpose(gzrftag1rd, gzrftag1r.purpose);
    trapezoid((WF_PROCESSOR)wg_gzrftag1r, "gzrftag1r", &gzrftag1r, &gzrftag1ra,
              &gzrftag1rd, pw_gzrftag1r, pw_gzrftag1ra, pw_gzrftag1rd,
              ia_gzrftag1r, 0, 0, 0, 0, RUP_GRD(pendall(&gzrftag1,0)+pw_gzrftag1ra)-pw_gzrftag1ra, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gxrftag1a, gxrftag1.purpose);
    setWaveformPurpose(gxrftag1d, gxrftag1.purpose);
    trapezoid((WF_PROCESSOR)wg_gxrftag1, "gxrftag1", &gxrftag1, &gxrftag1a,
              &gxrftag1d, pw_gxrftag1, pw_gxrftag1a, pw_gxrftag1d,
              ia_gxrftag1, 0, 0, 0, 0, RUP_GRD(pendall(&gzrftag1,0)+pw_gxrftag1a)-pw_gxrftag1a, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gyrftag1a, gyrftag1.purpose);
    setWaveformPurpose(gyrftag1d, gyrftag1.purpose);
    trapezoid((WF_PROCESSOR)wg_gyrftag1, "gyrftag1", &gyrftag1, &gyrftag1a,
              &gyrftag1d, pw_gyrftag1, pw_gyrftag1a, pw_gyrftag1d,
              ia_gyrftag1, 0, 0, 0, 0, RUP_GRD(pendall(&gzrftag1,0)+pw_gyrftag1a)-pw_gyrftag1a, TRAP_ALL,
              &loggrd);
  ...
  {
    pulsename(&rftag2,"rftag2");
    createextwave(&rftag2,(WF_PROCESSOR)wg_rftag2,
                  res_rftag2,fileloc_rftag2);
    if ((wg_rftag2==TYPRHO1)||(wg_rftag2==TYPRHO2) ||
	(wg_rftag2==TYPTHETA)||(wg_rftag2==TYPOMEGA))
      {
	createinstr( &rftag2,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2a)) + psd_rf_wait, 
		    pw_rftag2,ia_rftag2);
	addrfbits(&rftag2,off_rftag2,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2a)) + psd_rf_wait,
		  pw_rftag2);
      }
    else
      {
	createinstr( &rftag2,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2a)), 
		    pw_rftag2,ia_rftag2);
      }
  }
    ...
    setWaveformPurpose(gzrftag2a, gzrftag2.purpose);
    setWaveformPurpose(gzrftag2d, gzrftag2.purpose);
    trapezoid((WF_PROCESSOR)wg_gzrftag2, "gzrftag2", &gzrftag2, &gzrftag2a,
              &gzrftag2d, pw_gzrftag2, pw_gzrftag2a, pw_gzrftag2d,
              ia_gzrftag2, 0, 0, 0, 0, RUP_GRD(t_rfrepeat+pw_gzrftag2a)-pw_gzrftag2a, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gzrftag2ra, gzrftag2r.purpose);
    setWaveformPurpose(gzrftag2rd, gzrftag2r.purpose);
    trapezoid((WF_PROCESSOR)wg_gzrftag2r, "gzrftag2r", &gzrftag2r, &gzrftag2ra,
              &gzrftag2rd, pw_gzrftag2r, pw_gzrftag2ra, pw_gzrftag2rd,
              ia_gzrftag2r, 0, 0, 0, 0, RUP_GRD(pendall(&gzrftag2,0)+pw_gzrftag2ra)-pw_gzrftag2ra, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gxrftag2a, gxrftag2.purpose);
    setWaveformPurpose(gxrftag2d, gxrftag2.purpose);
    trapezoid((WF_PROCESSOR)wg_gxrftag2, "gxrftag2", &gxrftag2, &gxrftag2a,
              &gxrftag2d, pw_gxrftag2, pw_gxrftag2a, pw_gxrftag2d,
              ia_gxrftag2, 0, 0, 0, 0, RUP_GRD(pendall(&gzrftag2,0)+pw_gxrftag2a)-pw_gxrftag2a, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gyrftag2a, gyrftag2.purpose);
    setWaveformPurpose(gyrftag2d, gyrftag2.purpose);
    trapezoid((WF_PROCESSOR)wg_gyrftag2, "gyrftag2", &gyrftag2, &gyrftag2a,
              &gyrftag2d, pw_gyrftag2, pw_gyrftag2a, pw_gyrftag2d,
              ia_gyrftag2, 0, 0, 0, 0, RUP_GRD(pendall(&gzrftag2,0)+pw_gyrftag2a)-pw_gyrftag2a, TRAP_ALL,
              &loggrd);
  ...
  {
    pulsename(&astcore,"astcore");
    createseq(&astcore,astseqtime+textra_astcore-timessi, off_astcore);
#if defined(HOST_TGT)
    /* Update sequence counter and get current sequence entry index */
    updateIndex( &idx_astcore );
    printDebug( DBLEVEL1, (dbLevel_t)seg_debug, "SEQLENGTH",
                "idx_astcore = %d\n", idx_astcore );
#endif
  }
  ...
  {
    pulsename(&rftag1c,"rftag1c");
    createextwave(&rftag1c,(WF_PROCESSOR)wg_rftag1c,
                  res_rftag1c,fileloc_rftag1c);
    if ((wg_rftag1c==TYPRHO1)||(wg_rftag1c==TYPRHO2) ||
	(wg_rftag1c==TYPTHETA)||(wg_rftag1c==TYPOMEGA))
      {
	createinstr( &rftag1c,(long)(RUP_GRD(pw_gzrftag1ca+0)) + psd_rf_wait, 
		    pw_rftag1c,ia_rftag1c);
	addrfbits(&rftag1c,off_rftag1c,(long)(RUP_GRD(pw_gzrftag1ca+0)) + psd_rf_wait,
		  pw_rftag1c);
      }
    else
      {
	createinstr( &rftag1c,(long)(RUP_GRD(pw_gzrftag1ca+0)), 
		    pw_rftag1c,ia_rftag1c);
      }
  }
    ...
    setWaveformPurpose(gzrftag1ca, gzrftag1c.purpose);
    setWaveformPurpose(gzrftag1cd, gzrftag1c.purpose);
    trapezoid((WF_PROCESSOR)wg_gzrftag1c, "gzrftag1c", &gzrftag1c, &gzrftag1ca,
              &gzrftag1cd, pw_gzrftag1c, pw_gzrftag1ca, pw_gzrftag1cd,
              ia_gzrftag1c, 0, 0, 0, 0, RUP_GRD(pw_gzrftag1ca)-pw_gzrftag1ca, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gzrftag1rca, gzrftag1rc.purpose);
    setWaveformPurpose(gzrftag1rcd, gzrftag1rc.purpose);
    trapezoid((WF_PROCESSOR)wg_gzrftag1rc, "gzrftag1rc", &gzrftag1rc, &gzrftag1rca,
              &gzrftag1rcd, pw_gzrftag1rc, pw_gzrftag1rca, pw_gzrftag1rcd,
              ia_gzrftag1rc, 0, 0, 0, 0, RUP_GRD(pendall(&gzrftag1c,0)+pw_gzrftag1rca)-pw_gzrftag1rca, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gxrftag1ca, gxrftag1c.purpose);
    setWaveformPurpose(gxrftag1cd, gxrftag1c.purpose);
    trapezoid((WF_PROCESSOR)wg_gxrftag1c, "gxrftag1c", &gxrftag1c, &gxrftag1ca,
              &gxrftag1cd, pw_gxrftag1c, pw_gxrftag1ca, pw_gxrftag1cd,
              ia_gxrftag1c, 0, 0, 0, 0, RUP_GRD(pendall(&gzrftag1c,0)+pw_gxrftag1ca)-pw_gxrftag1ca, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gyrftag1ca, gyrftag1c.purpose);
    setWaveformPurpose(gyrftag1cd, gyrftag1c.purpose);
    trapezoid((WF_PROCESSOR)wg_gyrftag1c, "gyrftag1c", &gyrftag1c, &gyrftag1ca,
              &gyrftag1cd, pw_gyrftag1c, pw_gyrftag1ca, pw_gyrftag1cd,
              ia_gyrftag1c, 0, 0, 0, 0, RUP_GRD(pendall(&gzrftag1c,0)+pw_gyrftag1ca)-pw_gyrftag1ca, TRAP_ALL,
              &loggrd);
  ...
  {
    pulsename(&rftag2c,"rftag2c");
    createextwave(&rftag2c,(WF_PROCESSOR)wg_rftag2c,
                  res_rftag2c,fileloc_rftag2c);
    if ((wg_rftag2c==TYPRHO1)||(wg_rftag2c==TYPRHO2) ||
	(wg_rftag2c==TYPTHETA)||(wg_rftag2c==TYPOMEGA))
      {
	createinstr( &rftag2c,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2ca+0)) + psd_rf_wait, 
		    pw_rftag2c,ia_rftag2c);
	addrfbits(&rftag2c,off_rftag2c,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2ca+0)) + psd_rf_wait,
		  pw_rftag2c);
      }
    else
      {
	createinstr( &rftag2c,(long)(RUP_GRD(t_rfrepeat+pw_gzrftag2ca+0)), 
		    pw_rftag2c,ia_rftag2c);
      }
  }
    ...
    setWaveformPurpose(gzrftag2ca, gzrftag2c.purpose);
    setWaveformPurpose(gzrftag2cd, gzrftag2c.purpose);
    trapezoid((WF_PROCESSOR)wg_gzrftag2c, "gzrftag2c", &gzrftag2c, &gzrftag2ca,
              &gzrftag2cd, pw_gzrftag2c, pw_gzrftag2ca, pw_gzrftag2cd,
              ia_gzrftag2c, 0, 0, 0, 0, RUP_GRD(t_rfrepeat+pw_gzrftag2ca)-pw_gzrftag2ca, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gzrftag2rca, gzrftag2rc.purpose);
    setWaveformPurpose(gzrftag2rcd, gzrftag2rc.purpose);
    trapezoid((WF_PROCESSOR)wg_gzrftag2rc, "gzrftag2rc", &gzrftag2rc, &gzrftag2rca,
              &gzrftag2rcd, pw_gzrftag2rc, pw_gzrftag2rca, pw_gzrftag2rcd,
              ia_gzrftag2rc, 0, 0, 0, 0, RUP_GRD(pendall(&gzrftag2c,0)+pw_gzrftag2rca)-pw_gzrftag2rca, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gxrftag2ca, gxrftag2c.purpose);
    setWaveformPurpose(gxrftag2cd, gxrftag2c.purpose);
    trapezoid((WF_PROCESSOR)wg_gxrftag2c, "gxrftag2c", &gxrftag2c, &gxrftag2ca,
              &gxrftag2cd, pw_gxrftag2c, pw_gxrftag2ca, pw_gxrftag2cd,
              ia_gxrftag2c, 0, 0, 0, 0, RUP_GRD(pendall(&gzrftag2c,0)+pw_gxrftag2ca)-pw_gxrftag2ca, TRAP_ALL,
              &loggrd);
    ...
    setWaveformPurpose(gyrftag2ca, gyrftag2c.purpose);
    setWaveformPurpose(gyrftag2cd, gyrftag2c.purpose);
    trapezoid((WF_PROCESSOR)wg_gyrftag2c, "gyrftag2c", &gyrftag2c, &gyrftag2ca,
              &gyrftag2cd, pw_gyrftag2c, pw_gyrftag2ca, pw_gyrftag2cd,
              ia_gyrftag2c, 0, 0, 0, 0, RUP_GRD(pendall(&gzrftag2c,0)+pw_gyrftag2ca)-pw_gyrftag2ca, TRAP_ALL,
              &loggrd);
  ...
  {
    pulsename(&controlcore,"controlcore");
    createseq(&controlcore,astseqtime+textra_astcore-timessi, off_controlcore);
#if defined(HOST_TGT)
    /* Update sequence counter and get current sequence entry index */
    updateIndex( &idx_controlcore );
    printDebug( DBLEVEL1, (dbLevel_t)seg_debug, "SEQLENGTH",
                "idx_controlcore = %d\n", idx_controlcore );
#endif
  }
  ...
  {
    pulsename(&BS1rf,"BS1rf");
    createextwave(&BS1rf,(WF_PROCESSOR)wg_BS1rf,
                  res_BS1rf,fileloc_BS1rf);
    if ((wg_BS1rf==TYPRHO1)||(wg_BS1rf==TYPRHO2) ||
	(wg_BS1rf==TYPTHETA)||(wg_BS1rf==TYPOMEGA))
      {
	createinstr( &BS1rf,(long)(RUP_RF(BS1_time-pw_BS1rf/2+0)) + psd_rf_wait, 
		    pw_BS1rf,ia_BS1rf);
	addrfbits(&BS1rf,off_BS1rf,(long)(RUP_RF(BS1_time-pw_BS1rf/2+0)) + psd_rf_wait,
		  pw_BS1rf);
      }
    else
      {
	createinstr( &BS1rf,(long)(RUP_RF(BS1_time-pw_BS1rf/2+0)), 
		    pw_BS1rf,ia_BS1rf);
      }
  }
  ...
  {
    pulsename(&BS1rf_theta,"BS1rf_theta");
    createextwave(&BS1rf_theta,(WF_PROCESSOR)wg_BS1rf_theta,
                  res_BS1rf_theta,fileloc_BS1rf_theta);
    if ((wg_BS1rf_theta==TYPRHO1)||(wg_BS1rf_theta==TYPRHO2) ||
	(wg_BS1rf_theta==TYPTHETA)||(wg_BS1rf_theta==TYPOMEGA))
      {
	createinstr( &BS1rf_theta,(long)(RUP_RF(BS1_time-pw_BS1rf/2+0)) + psd_rf_wait, 
		    pw_BS1rf_theta,ia_BS1rf_theta);
	addrfbits(&BS1rf_theta,off_BS1rf_theta,(long)(RUP_RF(BS1_time-pw_BS1rf/2+0)) + psd_rf_wait,
		  pw_BS1rf_theta);
      }
    else
      {
	createinstr( &BS1rf_theta,(long)(RUP_RF(BS1_time-pw_BS1rf/2+0)), 
		    pw_BS1rf_theta,ia_BS1rf_theta);
      }
  }
  ...
  {
    pulsename(&BS2rf,"BS2rf");
    createextwave(&BS2rf,(WF_PROCESSOR)wg_BS2rf,
                  res_BS2rf,fileloc_BS2rf);
    if ((wg_BS2rf==TYPRHO1)||(wg_BS2rf==TYPRHO2) ||
	(wg_BS2rf==TYPTHETA)||(wg_BS2rf==TYPOMEGA))
      {
	createinstr( &BS2rf,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2+0)) + psd_rf_wait, 
		    pw_BS2rf,ia_BS2rf);
	addrfbits(&BS2rf,off_BS2rf,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2+0)) + psd_rf_wait,
		  pw_BS2rf);
      }
    else
      {
	createinstr( &BS2rf,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2+0)), 
		    pw_BS2rf,ia_BS2rf);
      }
  }
  ...
  {
    pulsename(&BS2rf_theta,"BS2rf_theta");
    createextwave(&BS2rf_theta,(WF_PROCESSOR)wg_BS2rf_theta,
                  res_BS2rf_theta,fileloc_BS2rf_theta);
    if ((wg_BS2rf_theta==TYPRHO1)||(wg_BS2rf_theta==TYPRHO2) ||
	(wg_BS2rf_theta==TYPTHETA)||(wg_BS2rf_theta==TYPOMEGA))
      {
	createinstr( &BS2rf_theta,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2+0)) + psd_rf_wait, 
		    pw_BS2rf_theta,ia_BS2rf_theta);
	addrfbits(&BS2rf_theta,off_BS2rf_theta,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2+0)) + psd_rf_wait,
		  pw_BS2rf_theta);
      }
    else
      {
	createinstr( &BS2rf_theta,(long)(RUP_RF(BS1_time+BS2_time-pw_BS2rf/2+0)), 
		    pw_BS2rf_theta,ia_BS2rf_theta);
      }
  }
  ...
  {
    pulsename(&rf0,"rf0");
    createsinc(&rf0,(WF_PROCESSOR)wg_rf0,res_rf0,
               MAX_PG_WAMP,cyc_rf0,alpha_rf0);
    if ((wg_rf0==TYPRHO1)||(wg_rf0==TYPRHO2) ||
        (wg_rf0==TYPTHETA)||(wg_rf0==TYPOMEGA))
      {
        createinstr( &rf0,(long)(RUP_GRD(t_delay-fatsattime+0)),
                    pw_rf0,ia_rf0);
        addrfbits(&rf0,off_rf0,(long)(RUP_GRD(t_delay-fatsattime+0)),
                  pw_rf0);
      }
    else
      {
    ...
    setWaveformPurpose(gz0a, gz0.purpose);
    setWaveformPurpose(gz0d, gz0.purpose);
    trapezoid((WF_PROCESSOR)wg_gz0, "gz0", &gz0, &gz0a,
              &gz0d, pw_gz0, pw_gz0a, pw_gz0d,
              ia_gz0, 0, 0, 0, 0, RUP_GRD(t_delay-fatsattime+pwrf0+pw_gz0a)-pw_gz0a, TRAP_ALL,
              &loggrd);
  ...
  {
    pulsename(&tdelaycore,"tdelaycore");
    createseq(&tdelaycore,t_delay-timessi, off_tdelaycore);
#if defined(HOST_TGT)
    /* Update sequence counter and get current sequence entry index */
    updateIndex( &idx_tdelaycore );
    printDebug( DBLEVEL1, (dbLevel_t)seg_debug, "SEQLENGTH",
                "idx_tdelaycore = %d\n", idx_tdelaycore );
#endif
  }
  ...
  {
    pulsename(&trigon,"trigon");
    createbits(&trigon,TYPSSP,sizeof(trigonpkt)/2,trigonpkt);
    createinstr( &trigon,(long)(trigloc+waitloc),
		3  ,ia_trigon);
  }

		    
  {
    pulsename(&trigoff,"trigoff");
    createbits(&trigoff,TYPSSP,sizeof(trigoffpkt)/2,trigoffpkt);
    createinstr( &trigoff,(long)(trigloc+waitloc+triglen),
		3  ,ia_trigoff);
  }
  ...
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_TRdelay || TYPYGRAD == (WF_PROCESSOR)wg_TRdelay || TYPZGRAD == (WF_PROCESSOR)wg_TRdelay
          || TYPBXGRAD == (WF_PROCESSOR)wg_TRdelay || TYPBYGRAD == (WF_PROCESSOR)wg_TRdelay || TYPBZGRAD == (WF_PROCESSOR)wg_TRdelay )
      {
          setWaveformPurpose(TRdelay, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_TRdelay || TYPRHO2 == (WF_PROCESSOR)wg_TRdelay || TYPTHETA == (WF_PROCESSOR)wg_TRdelay
               || TYPBRHO1 == (WF_PROCESSOR)wg_TRdelay || TYPBRHO2 == (WF_PROCESSOR)wg_TRdelay || TYPBTHETA == (WF_PROCESSOR)wg_TRdelay
               || TYPOMEGA == (WF_PROCESSOR)wg_TRdelay || TYPBOMEGA == (WF_PROCESSOR)wg_TRdelay )
      {
          setWaveformPurpose(TRdelay, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_TRdelay || TYPBSSP == (WF_PROCESSOR)wg_TRdelay )
      {
          setWaveformPurpose(TRdelay, WAIT_SSP);
      }
    pulsename(&TRdelay,"TRdelay");
    createconst(&TRdelay,(WF_PROCESSOR)wg_TRdelay,pw_TRdelay,(short)0); 
    createinstr( &TRdelay,(long)(RUP_GRD(24  )),pw_TRdelay,0);
  }
  ...
  {
    pulsename(&tadjustcore,"tadjustcore");
    createseq(&tadjustcore,RUP_RF(t_adjust-timessi), off_tadjustcore);
#if defined(HOST_TGT)
    /* Update sequence counter and get current sequence entry index */
    updateIndex( &idx_tadjustcore );
    printDebug( DBLEVEL1, (dbLevel_t)seg_debug, "SEQLENGTH",
                "idx_tadjustcore = %d\n", idx_tadjustcore );
#endif
  }
  ...
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_waitStart || TYPYGRAD == (WF_PROCESSOR)wg_waitStart || TYPZGRAD == (WF_PROCESSOR)wg_waitStart
          || TYPBXGRAD == (WF_PROCESSOR)wg_waitStart || TYPBYGRAD == (WF_PROCESSOR)wg_waitStart || TYPBZGRAD == (WF_PROCESSOR)wg_waitStart )
      {
          setWaveformPurpose(waitStart, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_waitStart || TYPRHO2 == (WF_PROCESSOR)wg_waitStart || TYPTHETA == (WF_PROCESSOR)wg_waitStart
               || TYPBRHO1 == (WF_PROCESSOR)wg_waitStart || TYPBRHO2 == (WF_PROCESSOR)wg_waitStart || TYPBTHETA == (WF_PROCESSOR)wg_waitStart
               || TYPOMEGA == (WF_PROCESSOR)wg_waitStart || TYPBOMEGA == (WF_PROCESSOR)wg_waitStart )
      {
          setWaveformPurpose(waitStart, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_waitStart || TYPBSSP == (WF_PROCESSOR)wg_waitStart )
      {
          setWaveformPurpose(waitStart, WAIT_SSP);
      }
    pulsename(&waitStart,"waitStart");
    createconst(&waitStart,(WF_PROCESSOR)wg_waitStart,pw_waitStart,(short)0); 
    createinstr( &waitStart,(long)(24  ),pw_waitStart,0);
  }

	  
  {
    pulsename(&waitpass,"waitpass");
    createseq(&waitpass,10000, off_waitpass);
#if defined(HOST_TGT)
    /* Update sequence counter and get current sequence entry index */
    updateIndex( &idx_waitpass );
    printDebug( DBLEVEL1, (dbLevel_t)seg_debug, "SEQLENGTH",
                "idx_waitpass = %d\n", idx_waitpass );
#endif
  }
  ...
  {
      if( TYPXGRAD == (WF_PROCESSOR)wg_waitEnd || TYPYGRAD == (WF_PROCESSOR)wg_waitEnd || TYPZGRAD == (WF_PROCESSOR)wg_waitEnd
          || TYPBXGRAD == (WF_PROCESSOR)wg_waitEnd || TYPBYGRAD == (WF_PROCESSOR)wg_waitEnd || TYPBZGRAD == (WF_PROCESSOR)wg_waitEnd )
      {
          setWaveformPurpose(waitEnd, WAIT_GRAD);
      }
      else if( TYPRHO1 == (WF_PROCESSOR)wg_waitEnd || TYPRHO2 == (WF_PROCESSOR)wg_waitEnd || TYPTHETA == (WF_PROCESSOR)wg_waitEnd
               || TYPBRHO1 == (WF_PROCESSOR)wg_waitEnd || TYPBRHO2 == (WF_PROCESSOR)wg_waitEnd || TYPBTHETA == (WF_PROCESSOR)wg_waitEnd
               || TYPOMEGA == (WF_PROCESSOR)wg_waitEnd || TYPBOMEGA == (WF_PROCESSOR)wg_waitEnd )
      {
          setWaveformPurpose(waitEnd, WAIT_RF);
      }
      else if( TYPSSP == (WF_PROCESSOR)wg_waitEnd || TYPBSSP == (WF_PROCESSOR)wg_waitEnd )
      {
          setWaveformPurpose(waitEnd, WAIT_SSP);
      }
    pulsename(&waitEnd,"waitEnd");
    createconst(&waitEnd,(WF_PROCESSOR)wg_waitEnd,pw_waitEnd,(short)0); 
    createinstr( &waitEnd,(long)(24  ),pw_waitEnd,0);
  }

	  
  {
    pulsename(&waitend,"waitend");
    createseq(&waitend,endtime, off_waitend);
#if defined(HOST_TGT)
    /* Update sequence counter and get current sequence entry index */
    updateIndex( &idx_waitend );
    printDebug( DBLEVEL1, (dbLevel_t)seg_debug, "SEQLENGTH",
                "idx_waitend = %d\n", idx_waitend );
#endif
  }
...
#define RESERVED_IPG_MEMORY (0xbfff00)
	...
	if(rhuser14>0 && !pre)  {	/* first shot is delayed for map */
		...
		if(gtype<2)  {
			setperiod(mapdel+4  , &mapx, 0);
			setperiod(mapdel+4  , &mapy, 0);
			setperiod(mapdel+4  , &mapz, 0);
			setperiod(mapdel+4  , &mapt, 0);
			setperiod(mapdel+4  , &maps1, 0);  /*LHG 10/16/12  */
		}  else  {
			setperiod(mapdel+4  , &mapx2, 0);
			setperiod(mapdel+4  , &mapy2, 0);
			setperiod(mapdel+4  , &mapz2, 0);
			setperiod(mapdel+4  , &mapt2, 0);
		}
		if(bmapnav==0)  {         /* a/d window follows readout grads */
			if(gtype==2)
				setperiod(mapdel+4  , &maps2, 0);
			else
				setperiod(mapdel+4  , &maps1, 0);
			setperiod(4  , &maps3, 0);
		}
		fprintf(stderr,"Done");
	}
...
void get_rfamp(int ntab, int *rfamp)
{
	...
	E1 = exp(-(float)seqtr/(float)1300000);
	fprintf(stderr,"\nget_rfamp: E1 = %f", E1);
