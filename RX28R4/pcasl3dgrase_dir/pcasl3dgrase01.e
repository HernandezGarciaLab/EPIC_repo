...
*   pcasl3dgrase01  7/10/19	major change:  making the stack of spirals in a RARE (3DGRASE) 
...
int t_seqcore; 	/* time it takes to play the 180, readout, spoilers until the next 180 */
...
float areax = 0.;      /* calculated x dephasing amplitude for spiral in-out */
float areay = 0.;      /* calculated y dephasing amplitude for spiral in-out */
...
/*int  	myramptime = 100; /* lhg 9/21/12   ramp times for the pcasl pulses */
int  	myramptime = 40;  /*lhg 9/21/12   ramp times for the pcasl pulses */
...
double 	area_gxrftag1;
double 	area_gxrftag2;
double 	area_gxrftag1c;
double 	area_gxrftag2c;
double 	area_gyrftag1;
double 	area_gyrftag2;
double 	area_gyrftag1c;
double 	area_gyrftag2c;
double	a_gxyrftag;
double 	myphase_increment = 0;
double 	myphase_increment_test = 0;
double 	my_radians_per_CM;
double 	my_notch_distance;
int 	closest_notch;
double  manual_phase_correction = 0;

/*CVs for rotating tagging location (03/11/16)*/
float 	x_tof = 0.0; /* x vessel position based on TOF */
float 	y_tof = 0.0; /* y vessel position based on TOF */
/*float 	x_tag = 0.0; /* x distance between ISO and tag position*/
/*float 	y_tag = 0.0; /* y distance between ISO and tag position*/
int 	rot_steps = 32; /* number of sinusoidal rot steps*/
...
int 	BS2_time = 1230000;  /* delay between second BS inversion pulse and imaging, default to 850 ms after the first pulse */
...
abstract("Real Time, interactive, Pseudo CASL with 3D GRASE, Spiral acquisition for fMRI sequence with GRAPPA-Z, optimizedi BGS");
psdname("pcasl3dgrase01");
...
int cveval()
{
	...
	piuset += use20+use21+use22+use23+use24+use25+use26+use27+use28+use29+use30;
	/*
	   pititle = 2;
	...
	cvdesc(opuser30,"vessel-selective gradient a_gxyrftag  [cm]");
	cvmin(opuser30,-8);
	cvmax(opuser30, 8);
	cvdef(opuser30,0);
	opuser30 = 0;
	...
	a_rftag1 = 0.222; /* 08/2019 JS scaled based on b1max = 0.2943 G and peak B1 for rftag1 (25deg) = 0.0654 G*/
	a_rftag1 = 0.40; /* 0i7/2021 LHG scaled based on empirical test- pretty sure B1max is 0.147 */
	a_rftag2 = a_rftag1;
	a_rftag1c = a_rftag1;
	a_rftag2c = -a_rftag1;
	...
	/*Additional tagging gradient gx*/

	pw_gxrftag1 = pw_gzrftag1r; 
	pw_gxrftag1a = pw_gzrftag1ra;
	pw_gxrftag1d = pw_gzrftag1ra;

	pw_gxrftag2 = pw_gzrftag1r; 
	pw_gxrftag2a = pw_gzrftag1ra;
	pw_gxrftag2d = pw_gzrftag1ra;

	pw_gxrftag1c = pw_gzrftag1r; 
	pw_gxrftag1ca = pw_gzrftag1ra;
	pw_gxrftag1cd = pw_gzrftag1ra;

	pw_gxrftag2c = pw_gzrftag1r; 

	pw_gxrftag2ca = pw_gzrftag1ra;
	pw_gxrftag2cd = pw_gzrftag1ra;
	
	/*Additional tagging gradient gy*/
	pw_gyrftag1 = pw_gzrftag1r; 
	pw_gyrftag1a = pw_gzrftag1ra;
	pw_gyrftag1d = pw_gzrftag1ra;

	pw_gyrftag2 = pw_gzrftag1r; 
	pw_gyrftag2a = pw_gzrftag1ra;
	pw_gyrftag2d = pw_gzrftag1ra;

	pw_gyrftag1c =pw_gzrftag1r; 
	pw_gyrftag1ca = pw_gzrftag1ra;
	pw_gyrftag1cd = pw_gzrftag1ra;

	pw_gyrftag2c = pw_gzrftag1r; 
	pw_gyrftag2ca = pw_gzrftag1ra;
	pw_gyrftag2cd = pw_gzrftag1ra;
	...
	/* Compute amplitude of x and y gradients */
	/*a_gxyrftag = 0.0;*/
	a_gyrftag1 = a_gxyrftag;
	a_gyrftag2 = a_gxyrftag;
	a_gxrftag1 = a_gxyrftag;
	a_gxrftag2 = a_gxyrftag;
	a_gxrftag1c = a_gxrftag1;
	a_gxrftag2c = a_gxrftag2;
	a_gyrftag1c = a_gyrftag1;
	a_gyrftag2c = a_gyrftag2;


	/* compute as of the slice refocusers */
	...
	/* compute the areas of the vessel selective gradients gx and gy */
	area_gxrftag1 =  (double)(a_gxrftag1  * (pw_gxrftag1  + pw_gxrftag1a));
	area_gxrftag2 =  (double)(a_gxrftag2  * (pw_gxrftag2  + pw_gxrftag2a));
	area_gyrftag1 =  (double)(a_gyrftag1  * (pw_gyrftag1  + pw_gyrftag1a));
	area_gyrftag2 =  (double)(a_gyrftag2  * (pw_gyrftag2  + pw_gyrftag2a));
	area_gxrftag1c =  (double)(a_gxrftag1c  * (pw_gxrftag1c  + pw_gxrftag1ca));
	area_gxrftag2c =  (double)(a_gxrftag2c  * (pw_gxrftag2c  + pw_gxrftag2ca));
	area_gyrftag1c =  (double)(a_gyrftag1c  * (pw_gyrftag1c  + pw_gyrftag1ca));
	area_gyrftag2c =  (double)(a_gyrftag2c  * (pw_gyrftag2c  + pw_gyrftag2ca));
	...
	myphase_increment_test = myphase_increment;
...
i	*/
	...
	ampGzstep = 1 / ((pwGzstep + Gzramp) *1e-6 * GAMMA_H1/(2*PI) * zfov);  /* z phase-ecncode readout gradient for this zfov G/cm*/

	if (doZgrappa) 
		ampGzstep *= 2;
	
	areaGzstep = ampGzstep * (pwGzstep + Gzramp) ;        /* max area of z encoding gradient in G/cm*usec */
	...
	pw_gzphase1a= Gzramp;/*careful not to exceed slew rate */
	pw_gzphase1d= Gzramp;
	...
	a_gzBS0rfspoiler = (float)doBS; /*DO 1 G/cm */
	...
	pw_gz180crush1d = pw_gz180crush1a;
	pw_gz180crush2d = pw_gz180crush1d;

	/* 08/2019 JS Caluclate crusher amplitude based on volume*/
	/*Area_gz180crush = (double)2.0/(42.57*zfov)*10; /* G/cm*ms */
	/*a_gz180crush1 = (double)Area_gz180crush*1000/(pw_gz180crush1 + pw_gz180crush1a); /*G/cm*/
	

	a_gz180crush1 = 1.0;
	a_gz180crush2 = a_gz180crush1;

	BStime = BS1_time + BS2_time + pw_BS1rf + pw_BS2rf ;

	fatsattime = pw_rf0 + 2*pw_gz0d +pw_gz0 + 2*timessi;

	astseqtime2 = t_tag + t_delay;  /*duration of tagging + postabeling delay */
	
	t_tipdown_core = RUP_GRD(opte/2 - pw_gz180crush1 - 2*pw_gz180crush1a );
	t_seqcore = opte;	
	...
	/*seqtr = t_tipdown_core + t_seqcore * opslquant;
	...
	fprintf(stderr,"\nEnded cveval");
        ...
        /*JS 01/28/19 turn on cardiac-triggering by default*/
	ophrep=3; 
...
so don't change the duration of pw_rf1 without adjusting this calculation ...*/
	...
	*/
	a_rf1 = opflip/180 ;
	ia_rf1 = a_rf1 * max_pg_iamp;
	/*ia_rf1 = max_pg_iamp*(*rfpulse[0].amp);*/
	/*flip_rf1 = opflip;*/

	a_rf2 = flip_rf2/180;
	ia_rf2 = a_rf2 * max_pg_iamp;
	//a_rf2 = max_pg_iamp*(*rfpulse[0].amp);
	...
	/*JS 08/09/18 switched values */
	satoff = (cffield==15000)? 220 : -520;
	satBW = (cffield==15000)? -260 : 440;  /* offset  down a little */
	...
	pw_rf0 = pwrf0;
	a_rf0 = arf0;		
        /*LHG 6/12/2018: empirical calibration for fat sat */
        a_rf0 = 0.28;

	/*JS optimized fatsat amplitude*/
	a_rf0 = 0.14;/*0.28;*/ /* 08/19 JS scaled based on b1max = 0.2943 G and peak B1 for fatsat RF (90) = 0.0306 G*/
	/*actually ended up scaling based on experiment, slightly different from calculated value*/
	a_gz0 = 0.5;
	/*a_gx0 = a_gz0;
	a_gy0 = a_gz0;*/
...
short chopamp;
int view, slice, dabop, excitation, seqCount, ec, rf1Phase;
...
STATUS pulsegen(void)
{
	...
	SLICESELZ(rf1, 
			RUP_GRD(tlead + pw_gzrf1a + 0), 
			pwrf1, 
			zfov * 10 * slab_fraction,  /* this is for FOV reduction (mm) */ 
			opflip,
			cycrf1,, 
			loggrd);
	...
	SEQLENGTH(tipdown_core, RUP_GRD(t_tipdown_core) , tipdown_core);
	...
	TRAPEZOID(ZGRAD,
			gz180crush1,
			RUP_GRD(tlead + pw_gz180crush1a + 0), 
			0,
			0,loggrd);
	...
	fprintf(stderr,"\n start of gzphase2  = %d",  RUP_GRD(pbegall(&gzphase2,0)));
	fprintf(stderr,"\n end of gzphase2 =%d ",  RUP_GRD(pendall(&gzphase2,0)));
	fprintf(stderr,"\n start of gxpre =%d ",  RUP_GRD(pbegall(&gxpre,0)));
	fprintf(stderr,"\n end of gxpre = %d",  RUP_GRD(pendall(&gxpre,0)));
	fprintf(stderr, "\n t_seqcore =%d, ", t_seqcore);
	fprintf(stderr,"\n textra180 = %d, ", textra180);
	fprintf(stderr,"\n textra90 = %d, ", textra90);
	fprintf(stderr,"\n time_90_180 = %d ", time_90_180);
	fprintf(stderr,"\n time_180_180 = %d ", time_180_180); 

	/*------------------------------------------------------*/

	SEQLENGTH(seqcore, t_seqcore + textra , seqcore);
	...
	fprintf(stderr, " \n... finished the BS core that goes in front of the labeling train ");
	...
	TRAPEZOID(XGRAD,
			gxrftag1,
			RUP_GRD(pendall(&gzrftag1,0) + pw_gxrftag1a),
			0,
			0, loggrd);
	fprintf(stderr, "\n ... gxrftag1 done ." );
	...
	TRAPEZOID(YGRAD,
			gyrftag1,
			RUP_GRD(pendall(&gzrftag1,0) + pw_gyrftag1a),
			0,
			0, loggrd);
	fprintf(stderr, "\n ... gyrftag1 done ." );
	...
	TRAPEZOID(XGRAD,
			gxrftag2,
			RUP_GRD(pendall(&gzrftag2,0) + pw_gxrftag2a),
			0,
			0, loggrd);
	fprintf(stderr, "\n ... gxrftag2 done ." );
	...
	TRAPEZOID(YGRAD,
			gyrftag2,
			RUP_GRD(pendall(&gzrftag2,0) + pw_gyrftag2a),
			0,
			0, loggrd);
	fprintf(stderr, "\n ... gryrftag2 done ." );
	...
	TRAPEZOID(XGRAD,
			gxrftag1c,
			RUP_GRD(pendall(&gzrftag1c,0) + pw_gxrftag1ca),
			0,
			0, loggrd);
	fprintf(stderr, "\n ... gxrftag1c done ." );
	...
	TRAPEZOID(YGRAD,
			gyrftag1c,
			RUP_GRD(pendall(&gzrftag1c,0) + pw_gyrftag1ca),
			0,
			0, loggrd);
	fprintf(stderr, "\n ... gyrftag1c done ." );
	...
	EXTWAVE(RHO,
			rftag2c,
			RUP_GRD(t_rfrepeat + pw_gzrftag2ca + 0),
			pw_gzrftag1c,
			a_rftag2c,
			res_rftag2c,
			/usr/g/bin/myhanning.rho,
	...
	TRAPEZOID(XGRAD,
			gxrftag2c,
			RUP_GRD(pendall(&gzrftag2c,0) + pw_gxrftag2ca),
			0,
			0, loggrd);
	fprintf(stderr, "\n ... gxrftag2c done ." );
	...
	TRAPEZOID(YGRAD,
			gyrftag2c,
			RUP_GRD(pendall(&gzrftag2c,0) + pw_gyrftag2ca),
			0,
			0, loggrd);
	fprintf(stderr, "\n ... gxrftag1c done ." );
	...
	fprintf(stderr," start: %d	end: %d", 
			RUP_RF(BS1_time - pw_BS1rf/2 + 0),
			RUP_RF(BS1_time - pw_BS1rf/2 + pw_BS1rf  + 0 ));

	fprintf(stderr, "\npulsegen: generating BS2  ... ");
	EXTWAVE(RHO,
			BS2rf,
			RUP_RF(BS1_time +  BS2_time - pw_BS2rf/2 + 0),
	...
	fprintf(stderr," start: %d	end: %d", 
			RUP_RF(BS1_time +  BS2_time - pw_BS2rf/2 + 0),
			RUP_RF(BS1_time +  BS2_time - pw_BS2rf/2 + 0 + pw_BS2rf));
	...
	SINC2(RHO, 
			rf0,  
			RUP_GRD(t_delay - fatsattime + 0 ), 
			pw_rf0, 
			a_rf0,
			,0.5,,,loggrd);
	fprintf(stderr," start: %d	end: %d", 
			RUP_GRD(t_delay - fatsattime + 0 ), 
			RUP_GRD(t_delay - fatsattime + 0 + pw_rf0 )); 
...
/*---------------------------------------------------------
  ...
  ----------------------------------------------------*/
void doast(int* trig, int isRFon, int* pcasl_iphase,float* a_gxrftag_rot, float* a_gyrftag_rot);
void rt_updates(void);
void dodelay(int* trig); 
void doadjust(int* trig);

void get_rfamp(int ntab, int *rfamp);
void get_pcasl_phases(int *pcasl_iphase, double myphase_increment, int nreps, float* a_gxrftag_rot, float* a_gyrftag_rot, float x_tof, float y_tof);
void get_pcasl_rotating_gradient_amp(float* a_gxrftag_rot, float* a_gyrftag_rot);
/*---------------------------------------------------------*/
...
#define RESERVED_IPG_MEMORY (0xbfff00)
	...
	/*variables for rotating x,y gradients (03/08/2016)*/
	float *a_gyrftag_rot;
	float *a_gxrftag_rot;
	...
	fprintf(stderr, "myphase_increment = %.3f \n", myphase_increment_test);
	fprintf(stderr, "B1tag_distance = %.3f \n", B1tag_distance); 
	fprintf(stderr, "piscancenter = %.3f \n", (float)piscancenter);
	fprintf(stderr, "GAMMA_H1 = %.3f \n", GAMMA_H1);
	...
	/*allocate space for rotating gradient vectors (03/10/2016)*/
	a_gyrftag_rot = (float *) AllocNode(rot_steps*sizeof(float));
	a_gxrftag_rot = (float *) AllocNode(rot_steps*sizeof(float));

	fprintf(stderr,"\nSetting up PCASL rotating gradient amplitude table  ...");
	get_pcasl_rotating_gradient_amp(a_gxrftag_rot, a_gyrftag_rot);

	fprintf(stderr,"\nSetting up PCASL pulse Phase table  ...");
	get_pcasl_phases(pcasl_iphase, myphase_increment, nreps, a_gxrftag_rot, a_gyrftag_rot, x_tof, y_tof);
	...
	if(pre)  {
		...
		for (iv = 0; iv < ndisdaq; iv++) {	/*  disdaqs  */
			...
			/* rt_updates(); */
			doadjust(&trig);
			doast(&trig, isRFon, pcasl_iphase, a_gxrftag_rot, a_gyrftag_rot);
			dodelay(&trig);
	...
	if(((int)opuser2)==3)  {           /* wait for StartScan to exist */
	...
	for (ifr = 0; ifr < nframes; ifr++)  {
		...
		for (iv = 0; iv < nl; iv++)  {
			...
			if (ifr < M0frames ) 
				fprintf(stderr,"\ncollecting M0 images and the GRAPPA-Z cal data at the odd frames: ifr=%d isOdd=%d", ifr, isOdd); 
...
void doast(int* trig, int isRFon, int* pcasl_iphase, float* a_gxrftag_rot, float* a_gyrftag_rot)
{
	...
	/* turn the Back. Supp.  off - JS 08/08/18 */
	if (ifr<M0frames){
		setiamp(0, &BS0rf, 0);	
		/*setiampt(0, &gzBS0rfspoiler, 0);*/
	}else
	{
		/* turning them back on - use DAC units */
		setiamp(ia_BS0rf, &BS0rf, 0);
		/*setiampt(a_gzBS0rfspoiler, &gzBS0rfspoiler, 0);*/
	...
	if (isRFon)
	{
		...
		for (n=0; n<nreps; n++) {
			...
			/*Set x,y gradient amplitude*/
			setiampt(a_gxrftag_rot[(n*2)%(rot_steps-1)], &gxrftag1, 0);
			setiampt(a_gxrftag_rot[(n*2+1)%(rot_steps-1)], &gxrftag2, 0);
			setiampt(a_gyrftag_rot[(n*2)%(rot_steps-1)], &gyrftag1, 0);
			setiampt(a_gyrftag_rot[(n*2+1)%(rot_steps-1)], &gyrftag2, 0);
	...
	else
	{
		...
		for (n = 0; n < nreps; n++) {
			...
			/*Set x,y gradient amplitude*/
			setiampt(a_gxrftag_rot[(n*2)%(rot_steps-1)], &gxrftag1c, 0);
			setiampt(a_gxrftag_rot[(n*2+1)%(rot_steps-1)], &gxrftag2c, 0);
			setiampt(a_gyrftag_rot[(n*2)%(rot_steps-1)], &gyrftag1c, 0);
			setiampt(a_gyrftag_rot[(n*2+1)%(rot_steps-1)], &gyrftag2c, 0);			
...
int doleaf(int leafn, int framen, int slicen, int* trig, int* bangn, int dabop, int dtype)
{
	...
	/*fprintf(stderr,"\nslcphastab: %d ", slcphastab[slicen]);*/
	

	/* Alternate  Tx phase in CPMG  7/7/21 */

	setiamp(ia_rf2*rf_sign, &rf2, 0);
	rf_sign *= -1;

	/* Alternate  Rx phase in CPMG  7/7/21 */
	getphase(&phase , &echo1, 0);
	if (slicen == 0) phase = 0.0;
	//setphase(phase + M_PI , &echo1, 0);
	//setphase(phase + 0.5* rf_sign , &echo1, 0); // very clear Nyquist ghost
	//setphase(0 , &echo1, 0); // very clear Nyquist ghost
	//setphase(phase + 1 , &echo1, 0); 
...
*/
	...
	/*setiampt(0,&gzphase1,0);*/
	setiampt( -i_zpeamp, &gzphase2, 0);
	/*setiampt(0,&gzphase2,0);*/

	//fprintf(stderr,"\nkz = %d, gz_amp = %d", slicen, i_zpeamp);  
...
//LHG 7/1/21 :  change this: 
	...
	if(gtype==2 && pre)  {	/* no first echo acq */
		loaddab(&echo1, slordtab[slicen], echon, dabop, viewn, (TYPDAB_PACKETS)DABOFF, dabmask);
	}
	else  {
	...
	/*  01/24/2019 JS: stop fatsat spoilers from switching between acqusitions  */
	/*ia_gx0 = (cphi + sphi)*(a_gx0/loggrd.xfs)*max_pg_iamp;
	ia_gy0 = (cphi - sphi)*(a_gy0/loggrd.yfs)*max_pg_iamp;
	setiampt(ia_gx0, &gx0, 0);
	setiampt(ia_gy0, &gy0, 0);*/
	...
	float y_tofi)
{
	...
	for (n=0; n<nreps*2; n++)
	{
		...
		pcasl_rfphase +=myphase_increment; /*phase increment due to z-gradient and manual phase correction*/


		/*Additional phase increment due to rotating x,y gradient (03/11/16)*/
		area_gxrftag = (double)(a_gxrftag_rot[n%(rot_steps-1)]*loggrd.xfs/max_pg_iamp  * (pw_gxrftag1  + pw_gxrftag1a));
		area_gyrftag = (double)(a_gyrftag_rot[n%(rot_steps-1)]*loggrd.yfs/max_pg_iamp  * (pw_gyrftag1  + pw_gyrftag1a));
		
		if (n==4) {
			printf(" \n area_gyrftag = %f \t area_gxrftag = %f \n", area_gyrftag, area_gxrftag);
		}
		
		x_tag = -y_tof;
		y_tag = -x_tof;
		
		pcasl_rfphase += GAMMA_H1 * (double)(area_gxrftag)/ (1000000) * x_tag; /*phase increment due to x-gradient*/
		pcasl_rfphase += GAMMA_H1 * (double)(area_gyrftag)/ (1000000) * y_tag; /*phase increment due to y-gradient*/

	}
}

/* Setting up pcasl rotating gradient amplitudes (03/10/2016)*/
void get_pcasl_rotating_gradient_amp(float a_gxrftag_rot[], float a_gyrftag_rot[])
{
	int ii;
	float x_rot[rot_steps];
	float y_rot[rot_steps];
	

	/* Scheme sinusoidal */

	for (ii=0; ii<rot_steps; ii++) {   
		x_rot[ii] = sin(PI/(rot_steps/2)*(ii+1));
		y_rot[ii] = cos(PI/(rot_steps/2)*(ii+1));
	} 
											
	
	for (ii=0; ii<rot_steps; ii++){ 
		a_gxrftag_rot[ii] = a_gxrftag1*x_rot[ii]/loggrd.xfs*max_pg_iamp;
		a_gyrftag_rot[ii] = a_gyrftag1*y_rot[ii]/loggrd.yfs*max_pg_iamp;
	}
...
void get_rfamp(int ntab, int *rfamp)
{
	...
	switch (rfamp_flag)  {
		...
		default:           /* some power */
			for (i=0;i<ntab;i++) {
				rfamp[i] = (int)(opflip +  (pow(i,rfamp_flag)*(90-opflip)/pow(ntab-1,rfamp_flag)));
