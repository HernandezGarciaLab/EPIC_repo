...
float area_gxrftag1 = 0;
float area_gxrftag2 = 0;
float area_gxrftag1c = 0;
float area_gxrftag2c = 0;
float area_gyrftag1 = 0;
float area_gyrftag2 = 0;
float area_gyrftag1c = 0;
float area_gyrftag2c = 0;
float a_gxyrftag = 0;
float myphase_increment = 0;
float myphase_increment_test = 0;
