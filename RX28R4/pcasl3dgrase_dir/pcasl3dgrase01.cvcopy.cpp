 ...
 * these variables.
 *
 * Generated on Tue Sep  7 11:06:14 2021 
 */

#ifndef h_pcasl3dgrase01_cvcopy_cpp
#define h_pcasl3dgrase01_cvcopy_cpp

#include "cvcopy_proto.h"

#if defined(PSD_HW) && defined(HOST_TGT)
/* Include endian converter functions */
#include "pcasl3dgrase01.cnvendian.globalvar.h"
#include "pcasl3dgrase01.cnvendian.c"
...
static const cvcopy_table_entry cvcopy_table[] = {
    ...
    { &debug, sizeof(debug) },
    { &nl, sizeof(nl) },
    { &scluster, sizeof(scluster) },
    { &nextra, sizeof(nextra) },
    { &nframes, sizeof(nframes) },
    { &total_views, sizeof(total_views) },
    { &gating, sizeof(gating) },
    { &psdseqtime, sizeof(psdseqtime) },
    { &psdtottime, sizeof(psdtottime) },
    { &t_tipdown_core, sizeof(t_tipdown_core) },
    { &t_seqcore, sizeof(t_seqcore) },
    { &timessi, sizeof(timessi) },
    { &trerror, sizeof(trerror) },
    { &nerror, sizeof(nerror) },
    { &gtype, sizeof(gtype) },
    { &gslew, sizeof(gslew) },
    { &gamp, sizeof(gamp) },
    { &gfov, sizeof(gfov) },
    { &gres, sizeof(gres) },
    { &gmax, sizeof(gmax) },
    { &rtimescale, sizeof(rtimescale) },
    { &nramp, sizeof(nramp) },
    { &agxpre, sizeof(agxpre) },
    { &agypre, sizeof(agypre) },
    { &areax, sizeof(areax) },
    { &areay, sizeof(areay) },
    { &prefudge, sizeof(prefudge) },
    { &pwgpre, sizeof(pwgpre) },
    { &tadmax, sizeof(tadmax) },
    { &tlead, sizeof(tlead) },
    { &daqdeloff, sizeof(daqdeloff) },
    { &daqdel, sizeof(daqdel) },
    { &thetdeloff, sizeof(thetdeloff) },
    { &espace, sizeof(espace) },
    { &readpos, sizeof(readpos) },
    { &daqpos, sizeof(daqpos) },
    { &minte, sizeof(minte) },
    { &seqtr, sizeof(seqtr) },
    { &endtime, sizeof(endtime) },
    { &vdflag, sizeof(vdflag) },
    { &alpha, sizeof(alpha) },
    { &kmaxfrac, sizeof(kmaxfrac) },
    { &slord, sizeof(slord) },
    { &satBW, sizeof(satBW) },
    { &satoff, sizeof(satoff) },
    { &pwrf0, sizeof(pwrf0) },
    { &arf0, sizeof(arf0) },
    { &fuzz, sizeof(fuzz) },
    { &fatsattime, sizeof(fatsattime) },
    { &pwrf1, sizeof(pwrf1) },
    { &cycrf1, sizeof(cycrf1) },
    { &domap, sizeof(domap) },
    { &mapdel, sizeof(mapdel) },
    { &bmapnav, sizeof(bmapnav) },
    { &off_fov, sizeof(off_fov) },
    { &tsp, sizeof(tsp) },
    { &bandwidth, sizeof(bandwidth) },
    { &decimation, sizeof(decimation) },
    { &filter_aps2, sizeof(filter_aps2) },
    { &psfrsize, sizeof(psfrsize) },
    { &queue_size, sizeof(queue_size) },
    { &seed, sizeof(seed) },
    { &nbang, sizeof(nbang) },
    { &zref, sizeof(zref) },
    { &trigloc, sizeof(trigloc) },
    { &triglen, sizeof(triglen) },
    { &trigfreq, sizeof(trigfreq) },
    { &maketrig, sizeof(maketrig) },
    { &ndisdaq, sizeof(ndisdaq) },
    { &pos_start, sizeof(pos_start) },
    { &obl_debug, sizeof(obl_debug) },
    { &obl_method, sizeof(obl_method) },
    { &t_tag, sizeof(t_tag) },
    { &t_delay, sizeof(t_delay) },
    { &B1tag_distance, sizeof(B1tag_distance) },
    { &B1tag_offset, sizeof(B1tag_offset) },
    { &astseqtime, sizeof(astseqtime) },
    { &astseqtime2, sizeof(astseqtime2) },
    { &t_adjust, sizeof(t_adjust) },
    { &delta1, sizeof(delta1) },
    { &isRFon, sizeof(isRFon) },
    { &mycrush, sizeof(mycrush) },
    { &crushtype, sizeof(crushtype) },
    { &mycontrol, sizeof(mycontrol) },
    { &xres, sizeof(xres) },
    { &M0frames, sizeof(M0frames) },
    { &isOdd, sizeof(isOdd) },
    { &doZgrappa, sizeof(doZgrappa) },
    { &my_maxB1Seq, sizeof(my_maxB1Seq) },
    { &variable_flip, sizeof(variable_flip) },
    { &doASLcardiacTrig, sizeof(doASLcardiacTrig) },
    { &fractional_moment, sizeof(fractional_moment) },
    { &t_rfrepeat, sizeof(t_rfrepeat) },
    { &tmin_rfrepeat, sizeof(tmin_rfrepeat) },
    { &nreps, sizeof(nreps) },
    { &pcasl_flip, sizeof(pcasl_flip) },
    { &myramptime, sizeof(myramptime) },
    { &pcasl_Gmax, sizeof(pcasl_Gmax) },
    { &pcasl_Gave, sizeof(pcasl_Gave) },
    { &area_gzrftag1, sizeof(area_gzrftag1) },
    { &area_gzrftag2, sizeof(area_gzrftag2) },
    { &area_gzrftag1c, sizeof(area_gzrftag1c) },
    { &area_gzrftag2c, sizeof(area_gzrftag2c) },
    { &area_gzrftag1r, sizeof(area_gzrftag1r) },
    { &area_gzrftag2r, sizeof(area_gzrftag2r) },
    { &area_gzrftag1rc, sizeof(area_gzrftag1rc) },
    { &area_gzrftag2rc, sizeof(area_gzrftag2rc) },
    { &area_gxrftag1, sizeof(area_gxrftag1) },
    { &area_gxrftag2, sizeof(area_gxrftag2) },
    { &area_gxrftag1c, sizeof(area_gxrftag1c) },
    { &area_gxrftag2c, sizeof(area_gxrftag2c) },
    { &area_gyrftag1, sizeof(area_gyrftag1) },
    { &area_gyrftag2, sizeof(area_gyrftag2) },
    { &area_gyrftag1c, sizeof(area_gyrftag1c) },
    { &area_gyrftag2c, sizeof(area_gyrftag2c) },
    { &a_gxyrftag, sizeof(a_gxyrftag) },
    { &myphase_increment, sizeof(myphase_increment) },
    { &myphase_increment_test, sizeof(myphase_increment_test) },
    { &my_radians_per_CM, sizeof(my_radians_per_CM) },
    { &my_notch_distance, sizeof(my_notch_distance) },
    { &closest_notch, sizeof(closest_notch) },
    { &manual_phase_correction, sizeof(manual_phase_correction) },
    { &x_tof, sizeof(x_tof) },
    { &y_tof, sizeof(y_tof) },
    { &rot_steps, sizeof(rot_steps) },
    { &tdelaycore_fix, sizeof(tdelaycore_fix) },
    { &myphase_increment_0, sizeof(myphase_increment_0) },
    { &myPhaseCorr, sizeof(myPhaseCorr) },
    { &doRT, sizeof(doRT) },
    { &ia_gzrftag1r_0, sizeof(ia_gzrftag1r_0) },
    { &multiphsFlag, sizeof(multiphsFlag) },
    { &nfr_phs, sizeof(nfr_phs) },
    { &time_90_180, sizeof(time_90_180) },
    { &time_180_180, sizeof(time_180_180) },
    { &rf_sign, sizeof(rf_sign) },
    { &spgr_flag, sizeof(spgr_flag) },
    { &rfamp_flag, sizeof(rfamp_flag) },
    { &rf_spoil_seed, sizeof(rf_spoil_seed) },
    { &target, sizeof(target) },
    { &rtime, sizeof(rtime) },
    { &ftime, sizeof(ftime) },
    { &zfov, sizeof(zfov) },
    { &ampGzstep, sizeof(ampGzstep) },
    { &areaGzstep, sizeof(areaGzstep) },
    { &iampGzstep, sizeof(iampGzstep) },
    { &pwGzstep, sizeof(pwGzstep) },
    { &Gzramp, sizeof(Gzramp) },
    { &dopresat, sizeof(dopresat) },
    { &rf1maxTime, sizeof(rf1maxTime) },
    { &area_gzrf1, sizeof(area_gzrf1) },
    { &area_gzrf1r, sizeof(area_gzrf1r) },
    { &rf1_bw, sizeof(rf1_bw) },
    { &slab_fraction, sizeof(slab_fraction) },
    { &se_slab_fraction, sizeof(se_slab_fraction) },
    { &BStime, sizeof(BStime) },
    { &BS1_time, sizeof(BS1_time) },
    { &BS2_time, sizeof(BS2_time) },
    { &rfscalesech, sizeof(rfscalesech) },
    { &doBS, sizeof(doBS) },
    { &t_preBS, sizeof(t_preBS) },
    { &area_gzBSOrfspoiler, sizeof(area_gzBSOrfspoiler) },
    { &slwid180, sizeof(slwid180) },
    { &tpre, sizeof(tpre) },
    { &tdel, sizeof(tdel) },
    { &mytpre, sizeof(mytpre) },
    { &tcs, sizeof(tcs) },
    { &echoshift, sizeof(echoshift) },
    { &textra_tadjust, sizeof(textra_tadjust) },
    { &textra_astcore, sizeof(textra_astcore) },
    { &textra_controlcore, sizeof(textra_controlcore) },
    { &textra_nothingcore, sizeof(textra_nothingcore) },
    { &textra_delaycore, sizeof(textra_delaycore) },
    { &textra90, sizeof(textra90) },
    { &textra180, sizeof(textra180) },
    { &textra, sizeof(textra) },
    { &fat_chemshift, sizeof(fat_chemshift) },
    ...
    { &a_gzrf1r, sizeof(a_gzrf1r) },
    { &ia_gzrf1r, sizeof(ia_gzrf1r) },
    { &pw_gzrf1ra, sizeof(pw_gzrf1ra) },
    { &pw_gzrf1rd, sizeof(pw_gzrf1rd) },
    { &pw_gzrf1r, sizeof(pw_gzrf1r) },
    { &wg_gzrf1r, sizeof(wg_gzrf1r) },
    { &a_gz180crush1, sizeof(a_gz180crush1) },
    { &ia_gz180crush1, sizeof(ia_gz180crush1) },
    { &pw_gz180crush1a, sizeof(pw_gz180crush1a) },
    { &pw_gz180crush1d, sizeof(pw_gz180crush1d) },
    { &pw_gz180crush1, sizeof(pw_gz180crush1) },
    { &wg_gz180crush1, sizeof(wg_gz180crush1) },
    ...
    { &a_gz180crush2, sizeof(a_gz180crush2) },
    { &ia_gz180crush2, sizeof(ia_gz180crush2) },
    { &pw_gz180crush2a, sizeof(pw_gz180crush2a) },
    { &pw_gz180crush2d, sizeof(pw_gz180crush2d) },
    { &pw_gz180crush2, sizeof(pw_gz180crush2) },
    { &wg_gz180crush2, sizeof(wg_gz180crush2) },
    { &a_gzphase1, sizeof(a_gzphase1) },
    { &ia_gzphase1, sizeof(ia_gzphase1) },
    { &pw_gzphase1a, sizeof(pw_gzphase1a) },
    { &pw_gzphase1d, sizeof(pw_gzphase1d) },
    { &pw_gzphase1, sizeof(pw_gzphase1) },
    { &wg_gzphase1, sizeof(wg_gzphase1) },
    { &pw_mapx, sizeof(pw_mapx) },
    { &wg_mapx, sizeof(wg_mapx) },
    { &pw_mapy, sizeof(pw_mapy) },
    { &wg_mapy, sizeof(wg_mapy) },
    { &pw_mapz, sizeof(pw_mapz) },
    { &wg_mapz, sizeof(wg_mapz) },
    { &pw_mapt, sizeof(pw_mapt) },
    { &wg_mapt, sizeof(wg_mapt) },
    { &a_gx, sizeof(a_gx) },
    { &ia_gx, sizeof(ia_gx) },
    { &pw_gx, sizeof(pw_gx) },
    { &res_gx, sizeof(res_gx) },
    { &a_gy, sizeof(a_gy) },
    { &ia_gy, sizeof(ia_gy) },
    { &pw_gy, sizeof(pw_gy) },
    { &res_gy, sizeof(res_gy) },
    { &pw_maps1, sizeof(pw_maps1) },
    { &wg_maps1, sizeof(wg_maps1) },
    { &filter_echo1, sizeof(filter_echo1) },
    { &pw_mapx2, sizeof(pw_mapx2) },
    { &wg_mapx2, sizeof(wg_mapx2) },
    { &pw_mapy2, sizeof(pw_mapy2) },
    { &wg_mapy2, sizeof(wg_mapy2) },
    { &pw_mapz2, sizeof(pw_mapz2) },
    { &wg_mapz2, sizeof(wg_mapz2) },
    { &pw_mapt2, sizeof(pw_mapt2) },
    { &wg_mapt2, sizeof(wg_mapt2) },
    { &a_gx2, sizeof(a_gx2) },
    { &ia_gx2, sizeof(ia_gx2) },
    { &pw_gx2, sizeof(pw_gx2) },
    { &res_gx2, sizeof(res_gx2) },
    { &a_gy2, sizeof(a_gy2) },
    { &ia_gy2, sizeof(ia_gy2) },
    { &pw_gy2, sizeof(pw_gy2) },
    { &res_gy2, sizeof(res_gy2) },
    { &pw_maps2, sizeof(pw_maps2) },
    { &wg_maps2, sizeof(wg_maps2) },
    { &filter_echo2, sizeof(filter_echo2) },
    { &pw_maps3, sizeof(pw_maps3) },
    { &wg_maps3, sizeof(wg_maps3) },
    { &a_gzphase2, sizeof(a_gzphase2) },
    { &ia_gzphase2, sizeof(ia_gzphase2) },
    { &pw_gzphase2a, sizeof(pw_gzphase2a) },
    { &pw_gzphase2d, sizeof(pw_gzphase2d) },
    { &pw_gzphase2, sizeof(pw_gzphase2) },
    { &wg_gzphase2, sizeof(wg_gzphase2) },
    { &ia_gxprew, sizeof(ia_gxprew) },
    { &a_gxpre, sizeof(a_gxpre) },
    { &ia_gxpre, sizeof(ia_gxpre) },
    { &pw_gxpre, sizeof(pw_gxpre) },
    { &res_gxpre, sizeof(res_gxpre) },
    { &phs_gxpre, sizeof(phs_gxpre) },
    { &phl_gxpre, sizeof(phl_gxpre) },
    { &off_gxpre, sizeof(off_gxpre) },
    { &wg_gxpre, sizeof(wg_gxpre) },
    { &ia_gyprew, sizeof(ia_gyprew) },
    { &a_gypre, sizeof(a_gypre) },
    { &ia_gypre, sizeof(ia_gypre) },
    { &pw_gypre, sizeof(pw_gypre) },
    { &res_gypre, sizeof(res_gypre) },
    { &phs_gypre, sizeof(phs_gypre) },
    { &phl_gypre, sizeof(phl_gypre) },
    { &off_gypre, sizeof(off_gypre) },
    { &wg_gypre, sizeof(wg_gypre) },
    { &a_BS0rf, sizeof(a_BS0rf) },
    { &ia_BS0rf, sizeof(ia_BS0rf) },
    { &pw_BS0rf, sizeof(pw_BS0rf) },
    { &res_BS0rf, sizeof(res_BS0rf) },
    { &off_BS0rf, sizeof(off_BS0rf) },
    { &wg_BS0rf, sizeof(wg_BS0rf) },
    { &a_BS0rf_theta, sizeof(a_BS0rf_theta) },
    { &ia_BS0rf_theta, sizeof(ia_BS0rf_theta) },
    { &pw_BS0rf_theta, sizeof(pw_BS0rf_theta) },
    { &res_BS0rf_theta, sizeof(res_BS0rf_theta) },
    { &off_BS0rf_theta, sizeof(off_BS0rf_theta) },
    { &wg_BS0rf_theta, sizeof(wg_BS0rf_theta) },
    { &a_gzBS0rfspoiler, sizeof(a_gzBS0rfspoiler) },
    { &ia_gzBS0rfspoiler, sizeof(ia_gzBS0rfspoiler) },
    { &pw_gzBS0rfspoilera, sizeof(pw_gzBS0rfspoilera) },
    { &pw_gzBS0rfspoilerd, sizeof(pw_gzBS0rfspoilerd) },
    { &pw_gzBS0rfspoiler, sizeof(pw_gzBS0rfspoiler) },
    { &wg_gzBS0rfspoiler, sizeof(wg_gzBS0rfspoiler) },
    { &a_rftag1, sizeof(a_rftag1) },
    { &ia_rftag1, sizeof(ia_rftag1) },
    { &pw_rftag1, sizeof(pw_rftag1) },
    { &res_rftag1, sizeof(res_rftag1) },
    { &off_rftag1, sizeof(off_rftag1) },
    { &wg_rftag1, sizeof(wg_rftag1) },
    { &a_gzrftag1, sizeof(a_gzrftag1) },
    { &ia_gzrftag1, sizeof(ia_gzrftag1) },
    { &pw_gzrftag1a, sizeof(pw_gzrftag1a) },
    { &pw_gzrftag1d, sizeof(pw_gzrftag1d) },
    { &pw_gzrftag1, sizeof(pw_gzrftag1) },
    { &wg_gzrftag1, sizeof(wg_gzrftag1) },
    { &a_gzrftag1r, sizeof(a_gzrftag1r) },
    { &ia_gzrftag1r, sizeof(ia_gzrftag1r) },
    { &pw_gzrftag1ra, sizeof(pw_gzrftag1ra) },
    { &pw_gzrftag1rd, sizeof(pw_gzrftag1rd) },
    { &pw_gzrftag1r, sizeof(pw_gzrftag1r) },
    { &wg_gzrftag1r, sizeof(wg_gzrftag1r) },
    { &a_gxrftag1, sizeof(a_gxrftag1) },
    { &ia_gxrftag1, sizeof(ia_gxrftag1) },
    { &pw_gxrftag1a, sizeof(pw_gxrftag1a) },
    { &pw_gxrftag1d, sizeof(pw_gxrftag1d) },
    { &pw_gxrftag1, sizeof(pw_gxrftag1) },
    { &wg_gxrftag1, sizeof(wg_gxrftag1) },
    { &a_gyrftag1, sizeof(a_gyrftag1) },
    { &ia_gyrftag1, sizeof(ia_gyrftag1) },
    { &pw_gyrftag1a, sizeof(pw_gyrftag1a) },
    { &pw_gyrftag1d, sizeof(pw_gyrftag1d) },
    { &pw_gyrftag1, sizeof(pw_gyrftag1) },
    { &wg_gyrftag1, sizeof(wg_gyrftag1) },
    { &a_rftag2, sizeof(a_rftag2) },
    { &ia_rftag2, sizeof(ia_rftag2) },
    { &pw_rftag2, sizeof(pw_rftag2) },
    { &res_rftag2, sizeof(res_rftag2) },
    { &off_rftag2, sizeof(off_rftag2) },
    { &wg_rftag2, sizeof(wg_rftag2) },
    { &a_gzrftag2, sizeof(a_gzrftag2) },
    { &ia_gzrftag2, sizeof(ia_gzrftag2) },
    { &pw_gzrftag2a, sizeof(pw_gzrftag2a) },
    { &pw_gzrftag2d, sizeof(pw_gzrftag2d) },
    { &pw_gzrftag2, sizeof(pw_gzrftag2) },
    { &wg_gzrftag2, sizeof(wg_gzrftag2) },
    { &a_gzrftag2r, sizeof(a_gzrftag2r) },
    { &ia_gzrftag2r, sizeof(ia_gzrftag2r) },
    { &pw_gzrftag2ra, sizeof(pw_gzrftag2ra) },
    { &pw_gzrftag2rd, sizeof(pw_gzrftag2rd) },
    { &pw_gzrftag2r, sizeof(pw_gzrftag2r) },
    { &wg_gzrftag2r, sizeof(wg_gzrftag2r) },
    { &a_gxrftag2, sizeof(a_gxrftag2) },
    { &ia_gxrftag2, sizeof(ia_gxrftag2) },
    { &pw_gxrftag2a, sizeof(pw_gxrftag2a) },
    { &pw_gxrftag2d, sizeof(pw_gxrftag2d) },
    { &pw_gxrftag2, sizeof(pw_gxrftag2) },
    { &wg_gxrftag2, sizeof(wg_gxrftag2) },
    { &a_gyrftag2, sizeof(a_gyrftag2) },
    { &ia_gyrftag2, sizeof(ia_gyrftag2) },
    { &pw_gyrftag2a, sizeof(pw_gyrftag2a) },
    { &pw_gyrftag2d, sizeof(pw_gyrftag2d) },
    { &pw_gyrftag2, sizeof(pw_gyrftag2) },
    { &wg_gyrftag2, sizeof(wg_gyrftag2) },
    { &a_rftag1c, sizeof(a_rftag1c) },
    { &ia_rftag1c, sizeof(ia_rftag1c) },
    { &pw_rftag1c, sizeof(pw_rftag1c) },
    { &res_rftag1c, sizeof(res_rftag1c) },
    { &off_rftag1c, sizeof(off_rftag1c) },
    { &wg_rftag1c, sizeof(wg_rftag1c) },
    { &a_gzrftag1c, sizeof(a_gzrftag1c) },
    { &ia_gzrftag1c, sizeof(ia_gzrftag1c) },
    { &pw_gzrftag1ca, sizeof(pw_gzrftag1ca) },
    { &pw_gzrftag1cd, sizeof(pw_gzrftag1cd) },
    { &pw_gzrftag1c, sizeof(pw_gzrftag1c) },
    { &wg_gzrftag1c, sizeof(wg_gzrftag1c) },
    { &a_gzrftag1rc, sizeof(a_gzrftag1rc) },
    { &ia_gzrftag1rc, sizeof(ia_gzrftag1rc) },
    { &pw_gzrftag1rca, sizeof(pw_gzrftag1rca) },
    { &pw_gzrftag1rcd, sizeof(pw_gzrftag1rcd) },
    { &pw_gzrftag1rc, sizeof(pw_gzrftag1rc) },
    { &wg_gzrftag1rc, sizeof(wg_gzrftag1rc) },
    { &a_gxrftag1c, sizeof(a_gxrftag1c) },
    { &ia_gxrftag1c, sizeof(ia_gxrftag1c) },
    { &pw_gxrftag1ca, sizeof(pw_gxrftag1ca) },
    { &pw_gxrftag1cd, sizeof(pw_gxrftag1cd) },
    { &pw_gxrftag1c, sizeof(pw_gxrftag1c) },
    { &wg_gxrftag1c, sizeof(wg_gxrftag1c) },
    { &a_gyrftag1c, sizeof(a_gyrftag1c) },
    { &ia_gyrftag1c, sizeof(ia_gyrftag1c) },
    { &pw_gyrftag1ca, sizeof(pw_gyrftag1ca) },
    { &pw_gyrftag1cd, sizeof(pw_gyrftag1cd) },
    { &pw_gyrftag1c, sizeof(pw_gyrftag1c) },
    { &wg_gyrftag1c, sizeof(wg_gyrftag1c) },
    { &a_rftag2c, sizeof(a_rftag2c) },
    { &ia_rftag2c, sizeof(ia_rftag2c) },
    { &pw_rftag2c, sizeof(pw_rftag2c) },
    { &res_rftag2c, sizeof(res_rftag2c) },
    { &off_rftag2c, sizeof(off_rftag2c) },
    { &wg_rftag2c, sizeof(wg_rftag2c) },
    { &a_gzrftag2c, sizeof(a_gzrftag2c) },
    { &ia_gzrftag2c, sizeof(ia_gzrftag2c) },
    { &pw_gzrftag2ca, sizeof(pw_gzrftag2ca) },
    { &pw_gzrftag2cd, sizeof(pw_gzrftag2cd) },
    { &pw_gzrftag2c, sizeof(pw_gzrftag2c) },
    { &wg_gzrftag2c, sizeof(wg_gzrftag2c) },
    { &a_gzrftag2rc, sizeof(a_gzrftag2rc) },
    { &ia_gzrftag2rc, sizeof(ia_gzrftag2rc) },
    { &pw_gzrftag2rca, sizeof(pw_gzrftag2rca) },
    { &pw_gzrftag2rcd, sizeof(pw_gzrftag2rcd) },
    { &pw_gzrftag2rc, sizeof(pw_gzrftag2rc) },
    { &wg_gzrftag2rc, sizeof(wg_gzrftag2rc) },
    { &a_gxrftag2c, sizeof(a_gxrftag2c) },
    { &ia_gxrftag2c, sizeof(ia_gxrftag2c) },
    { &pw_gxrftag2ca, sizeof(pw_gxrftag2ca) },
    { &pw_gxrftag2cd, sizeof(pw_gxrftag2cd) },
    { &pw_gxrftag2c, sizeof(pw_gxrftag2c) },
    { &wg_gxrftag2c, sizeof(wg_gxrftag2c) },
    { &a_gyrftag2c, sizeof(a_gyrftag2c) },
    { &ia_gyrftag2c, sizeof(ia_gyrftag2c) },
    { &pw_gyrftag2ca, sizeof(pw_gyrftag2ca) },
    { &pw_gyrftag2cd, sizeof(pw_gyrftag2cd) },
    { &pw_gyrftag2c, sizeof(pw_gyrftag2c) },
    { &wg_gyrftag2c, sizeof(wg_gyrftag2c) },
    { &a_BS1rf, sizeof(a_BS1rf) },
    { &ia_BS1rf, sizeof(ia_BS1rf) },
    { &pw_BS1rf, sizeof(pw_BS1rf) },
    { &res_BS1rf, sizeof(res_BS1rf) },
    { &off_BS1rf, sizeof(off_BS1rf) },
    { &wg_BS1rf, sizeof(wg_BS1rf) },
    { &a_BS1rf_theta, sizeof(a_BS1rf_theta) },
    { &ia_BS1rf_theta, sizeof(ia_BS1rf_theta) },
    { &pw_BS1rf_theta, sizeof(pw_BS1rf_theta) },
    { &res_BS1rf_theta, sizeof(res_BS1rf_theta) },
    { &off_BS1rf_theta, sizeof(off_BS1rf_theta) },
    { &wg_BS1rf_theta, sizeof(wg_BS1rf_theta) },
    { &a_BS2rf, sizeof(a_BS2rf) },
    { &ia_BS2rf, sizeof(ia_BS2rf) },
    { &pw_BS2rf, sizeof(pw_BS2rf) },
    { &res_BS2rf, sizeof(res_BS2rf) },
    { &off_BS2rf, sizeof(off_BS2rf) },
    { &wg_BS2rf, sizeof(wg_BS2rf) },
    { &a_BS2rf_theta, sizeof(a_BS2rf_theta) },
    { &ia_BS2rf_theta, sizeof(ia_BS2rf_theta) },
    { &pw_BS2rf_theta, sizeof(pw_BS2rf_theta) },
    { &res_BS2rf_theta, sizeof(res_BS2rf_theta) },
    { &off_BS2rf_theta, sizeof(off_BS2rf_theta) },
    { &wg_BS2rf_theta, sizeof(wg_BS2rf_theta) },
    { &a_rf0, sizeof(a_rf0) },
    ...
    { &a_gz0, sizeof(a_gz0) },
    { &ia_gz0, sizeof(ia_gz0) },
    { &pw_gz0a, sizeof(pw_gz0a) },
    { &pw_gz0d, sizeof(pw_gz0d) },
    { &pw_gz0, sizeof(pw_gz0) },
    { &wg_gz0, sizeof(wg_gz0) },
    { &ia_trigon, sizeof(ia_trigon) },
    { &ia_trigoff, sizeof(ia_trigoff) },
    { &pw_TRdelay, sizeof(pw_TRdelay) },
    { &wg_TRdelay, sizeof(wg_TRdelay) },
    { &pw_waitStart, sizeof(pw_waitStart) },
    { &wg_waitStart, sizeof(wg_waitStart) },
    { &pw_waitEnd, sizeof(pw_waitEnd) },
    { &wg_waitEnd, sizeof(wg_waitEnd) },
...
void cvcopy_cnv_endian( char * data )
{
    ...
    cv_cnv_endian_nl( data );
    data += sizeof(nl);

    cv_cnv_endian_scluster( data );
    data += sizeof(scluster);

    cv_cnv_endian_nextra( data );
    data += sizeof(nextra);

    cv_cnv_endian_nframes( data );
    data += sizeof(nframes);

    cv_cnv_endian_total_views( data );
    data += sizeof(total_views);

    cv_cnv_endian_gating( data );
    data += sizeof(gating);

    cv_cnv_endian_psdseqtime( data );
    data += sizeof(psdseqtime);

    cv_cnv_endian_psdtottime( data );
    data += sizeof(psdtottime);

    cv_cnv_endian_t_tipdown_core( data );
    data += sizeof(t_tipdown_core);

    cv_cnv_endian_t_seqcore( data );
    data += sizeof(t_seqcore);

    cv_cnv_endian_timessi( data );
    data += sizeof(timessi);

    cv_cnv_endian_trerror( data );
    data += sizeof(trerror);

    cv_cnv_endian_nerror( data );
    data += sizeof(nerror);

    cv_cnv_endian_gtype( data );
    data += sizeof(gtype);

    cv_cnv_endian_gslew( data );
    data += sizeof(gslew);

    cv_cnv_endian_gamp( data );
    data += sizeof(gamp);

    cv_cnv_endian_gfov( data );
    data += sizeof(gfov);

    cv_cnv_endian_gres( data );
    data += sizeof(gres);

    cv_cnv_endian_gmax( data );
    data += sizeof(gmax);

    cv_cnv_endian_rtimescale( data );
    data += sizeof(rtimescale);

    cv_cnv_endian_nramp( data );
    data += sizeof(nramp);

    cv_cnv_endian_agxpre( data );
    data += sizeof(agxpre);

    cv_cnv_endian_agypre( data );
    data += sizeof(agypre);

    cv_cnv_endian_areax( data );
    data += sizeof(areax);

    cv_cnv_endian_areay( data );
    data += sizeof(areay);

    cv_cnv_endian_prefudge( data );
    data += sizeof(prefudge);

    cv_cnv_endian_pwgpre( data );
    data += sizeof(pwgpre);

    cv_cnv_endian_tadmax( data );
    data += sizeof(tadmax);

    cv_cnv_endian_tlead( data );
    data += sizeof(tlead);

    cv_cnv_endian_daqdeloff( data );
    data += sizeof(daqdeloff);

    cv_cnv_endian_daqdel( data );
    data += sizeof(daqdel);

    cv_cnv_endian_thetdeloff( data );
    data += sizeof(thetdeloff);

    cv_cnv_endian_espace( data );
    data += sizeof(espace);

    cv_cnv_endian_readpos( data );
    data += sizeof(readpos);

    cv_cnv_endian_daqpos( data );
    data += sizeof(daqpos);

    cv_cnv_endian_minte( data );
    data += sizeof(minte);

    cv_cnv_endian_seqtr( data );
    data += sizeof(seqtr);

    cv_cnv_endian_endtime( data );
    data += sizeof(endtime);

    cv_cnv_endian_vdflag( data );
    data += sizeof(vdflag);

    cv_cnv_endian_alpha( data );
    data += sizeof(alpha);

    cv_cnv_endian_kmaxfrac( data );
    data += sizeof(kmaxfrac);

    cv_cnv_endian_slord( data );
    data += sizeof(slord);

    cv_cnv_endian_satBW( data );
    data += sizeof(satBW);

    cv_cnv_endian_satoff( data );
    data += sizeof(satoff);

    cv_cnv_endian_pwrf0( data );
    data += sizeof(pwrf0);

    cv_cnv_endian_arf0( data );
    data += sizeof(arf0);

    cv_cnv_endian_fuzz( data );
    data += sizeof(fuzz);

    cv_cnv_endian_fatsattime( data );
    data += sizeof(fatsattime);

    cv_cnv_endian_pwrf1( data );
    data += sizeof(pwrf1);

    cv_cnv_endian_cycrf1( data );
    data += sizeof(cycrf1);

    cv_cnv_endian_domap( data );
    data += sizeof(domap);

    cv_cnv_endian_mapdel( data );
    data += sizeof(mapdel);

    cv_cnv_endian_bmapnav( data );
    data += sizeof(bmapnav);

    cv_cnv_endian_off_fov( data );
    data += sizeof(off_fov);

    cv_cnv_endian_tsp( data );
    data += sizeof(tsp);

    cv_cnv_endian_bandwidth( data );
    data += sizeof(bandwidth);

    cv_cnv_endian_decimation( data );
    data += sizeof(decimation);

    cv_cnv_endian_filter_aps2( data );
    data += sizeof(filter_aps2);

    cv_cnv_endian_psfrsize( data );
    data += sizeof(psfrsize);

    cv_cnv_endian_queue_size( data );
    data += sizeof(queue_size);

    cv_cnv_endian_seed( data );
    data += sizeof(seed);

    cv_cnv_endian_nbang( data );
    data += sizeof(nbang);

    cv_cnv_endian_zref( data );
    data += sizeof(zref);

    cv_cnv_endian_trigloc( data );
    data += sizeof(trigloc);

    cv_cnv_endian_triglen( data );
    data += sizeof(triglen);

    cv_cnv_endian_trigfreq( data );
    data += sizeof(trigfreq);

    cv_cnv_endian_maketrig( data );
    data += sizeof(maketrig);

    cv_cnv_endian_ndisdaq( data );
    data += sizeof(ndisdaq);
    ...
    cv_cnv_endian_t_tag( data );
    data += sizeof(t_tag);

    cv_cnv_endian_t_delay( data );
    data += sizeof(t_delay);

    cv_cnv_endian_B1tag_distance( data );
    data += sizeof(B1tag_distance);

    cv_cnv_endian_B1tag_offset( data );
    data += sizeof(B1tag_offset);

    cv_cnv_endian_astseqtime( data );
    data += sizeof(astseqtime);

    cv_cnv_endian_astseqtime2( data );
    data += sizeof(astseqtime2);

    cv_cnv_endian_t_adjust( data );
    data += sizeof(t_adjust);

    cv_cnv_endian_delta1( data );
    data += sizeof(delta1);

    cv_cnv_endian_isRFon( data );
    data += sizeof(isRFon);

    cv_cnv_endian_mycrush( data );
    data += sizeof(mycrush);

    cv_cnv_endian_crushtype( data );
    data += sizeof(crushtype);

    cv_cnv_endian_mycontrol( data );
    data += sizeof(mycontrol);

    cv_cnv_endian_xres( data );
    data += sizeof(xres);

    cv_cnv_endian_M0frames( data );
    data += sizeof(M0frames);

    cv_cnv_endian_isOdd( data );
    data += sizeof(isOdd);

    cv_cnv_endian_doZgrappa( data );
    data += sizeof(doZgrappa);

    cv_cnv_endian_my_maxB1Seq( data );
    data += sizeof(my_maxB1Seq);

    cv_cnv_endian_variable_flip( data );
    data += sizeof(variable_flip);

    cv_cnv_endian_doASLcardiacTrig( data );
    data += sizeof(doASLcardiacTrig);

    cv_cnv_endian_fractional_moment( data );
    data += sizeof(fractional_moment);

    cv_cnv_endian_t_rfrepeat( data );
    data += sizeof(t_rfrepeat);

    cv_cnv_endian_tmin_rfrepeat( data );
    data += sizeof(tmin_rfrepeat);

    cv_cnv_endian_nreps( data );
    data += sizeof(nreps);

    cv_cnv_endian_pcasl_flip( data );
    data += sizeof(pcasl_flip);

    cv_cnv_endian_myramptime( data );
    data += sizeof(myramptime);

    cv_cnv_endian_pcasl_Gmax( data );
    data += sizeof(pcasl_Gmax);

    cv_cnv_endian_pcasl_Gave( data );
    data += sizeof(pcasl_Gave);

    cv_cnv_endian_area_gzrftag1( data );
    data += sizeof(area_gzrftag1);

    cv_cnv_endian_area_gzrftag2( data );
    data += sizeof(area_gzrftag2);

    cv_cnv_endian_area_gzrftag1c( data );
    data += sizeof(area_gzrftag1c);

    cv_cnv_endian_area_gzrftag2c( data );
    data += sizeof(area_gzrftag2c);

    cv_cnv_endian_area_gzrftag1r( data );
    data += sizeof(area_gzrftag1r);

    cv_cnv_endian_area_gzrftag2r( data );
    data += sizeof(area_gzrftag2r);

    cv_cnv_endian_area_gzrftag1rc( data );
    data += sizeof(area_gzrftag1rc);

    cv_cnv_endian_area_gzrftag2rc( data );
    data += sizeof(area_gzrftag2rc);

    cv_cnv_endian_area_gxrftag1( data );
    data += sizeof(area_gxrftag1);

    cv_cnv_endian_area_gxrftag2( data );
    data += sizeof(area_gxrftag2);

    cv_cnv_endian_area_gxrftag1c( data );
    data += sizeof(area_gxrftag1c);

    cv_cnv_endian_area_gxrftag2c( data );
    data += sizeof(area_gxrftag2c);

    cv_cnv_endian_area_gyrftag1( data );
    data += sizeof(area_gyrftag1);

    cv_cnv_endian_area_gyrftag2( data );
    data += sizeof(area_gyrftag2);

    cv_cnv_endian_area_gyrftag1c( data );
    data += sizeof(area_gyrftag1c);

    cv_cnv_endian_area_gyrftag2c( data );
    data += sizeof(area_gyrftag2c);

    cv_cnv_endian_a_gxyrftag( data );
    data += sizeof(a_gxyrftag);

    cv_cnv_endian_myphase_increment( data );
    data += sizeof(myphase_increment);

    cv_cnv_endian_myphase_increment_test( data );
    data += sizeof(myphase_increment_test);

    cv_cnv_endian_my_radians_per_CM( data );
    data += sizeof(my_radians_per_CM);

    cv_cnv_endian_my_notch_distance( data );
    data += sizeof(my_notch_distance);

    cv_cnv_endian_closest_notch( data );
    data += sizeof(closest_notch);

    cv_cnv_endian_manual_phase_correction( data );
    data += sizeof(manual_phase_correction);

    cv_cnv_endian_x_tof( data );
    data += sizeof(x_tof);

    cv_cnv_endian_y_tof( data );
    data += sizeof(y_tof);

    cv_cnv_endian_rot_steps( data );
    data += sizeof(rot_steps);

    cv_cnv_endian_tdelaycore_fix( data );
    data += sizeof(tdelaycore_fix);

    cv_cnv_endian_myphase_increment_0( data );
    data += sizeof(myphase_increment_0);

    cv_cnv_endian_myPhaseCorr( data );
    data += sizeof(myPhaseCorr);

    cv_cnv_endian_doRT( data );
    data += sizeof(doRT);

    cv_cnv_endian_ia_gzrftag1r_0( data );
    data += sizeof(ia_gzrftag1r_0);

    cv_cnv_endian_multiphsFlag( data );
    data += sizeof(multiphsFlag);

    cv_cnv_endian_nfr_phs( data );
    data += sizeof(nfr_phs);

    cv_cnv_endian_time_90_180( data );
    data += sizeof(time_90_180);

    cv_cnv_endian_time_180_180( data );
    data += sizeof(time_180_180);

    cv_cnv_endian_rf_sign( data );
    data += sizeof(rf_sign);

    cv_cnv_endian_spgr_flag( data );
    data += sizeof(spgr_flag);

    cv_cnv_endian_rfamp_flag( data );
    data += sizeof(rfamp_flag);

    cv_cnv_endian_rf_spoil_seed( data );
    data += sizeof(rf_spoil_seed);
    ...
    cv_cnv_endian_zfov( data );
    data += sizeof(zfov);

    cv_cnv_endian_ampGzstep( data );
    data += sizeof(ampGzstep);

    cv_cnv_endian_areaGzstep( data );
    data += sizeof(areaGzstep);

    cv_cnv_endian_iampGzstep( data );
    data += sizeof(iampGzstep);

    cv_cnv_endian_pwGzstep( data );
    data += sizeof(pwGzstep);

    cv_cnv_endian_Gzramp( data );
    data += sizeof(Gzramp);

    cv_cnv_endian_dopresat( data );
    data += sizeof(dopresat);

    cv_cnv_endian_rf1maxTime( data );
    data += sizeof(rf1maxTime);

    cv_cnv_endian_area_gzrf1( data );
    data += sizeof(area_gzrf1);

    cv_cnv_endian_area_gzrf1r( data );
    data += sizeof(area_gzrf1r);

    cv_cnv_endian_rf1_bw( data );
    data += sizeof(rf1_bw);

    cv_cnv_endian_slab_fraction( data );
    data += sizeof(slab_fraction);

    cv_cnv_endian_se_slab_fraction( data );
    data += sizeof(se_slab_fraction);

    cv_cnv_endian_BStime( data );
    data += sizeof(BStime);

    cv_cnv_endian_BS1_time( data );
    data += sizeof(BS1_time);

    cv_cnv_endian_BS2_time( data );
    data += sizeof(BS2_time);

    cv_cnv_endian_rfscalesech( data );
    data += sizeof(rfscalesech);

    cv_cnv_endian_doBS( data );
    data += sizeof(doBS);

    cv_cnv_endian_t_preBS( data );
    data += sizeof(t_preBS);

    cv_cnv_endian_area_gzBSOrfspoiler( data );
    data += sizeof(area_gzBSOrfspoiler);

    cv_cnv_endian_slwid180( data );
    data += sizeof(slwid180);

    cv_cnv_endian_tpre( data );
    data += sizeof(tpre);

    cv_cnv_endian_tdel( data );
    data += sizeof(tdel);

    cv_cnv_endian_mytpre( data );
    data += sizeof(mytpre);

    cv_cnv_endian_tcs( data );
    data += sizeof(tcs);

    cv_cnv_endian_echoshift( data );
    data += sizeof(echoshift);

    cv_cnv_endian_textra_tadjust( data );
    data += sizeof(textra_tadjust);

    cv_cnv_endian_textra_astcore( data );
    data += sizeof(textra_astcore);

    cv_cnv_endian_textra_controlcore( data );
    data += sizeof(textra_controlcore);

    cv_cnv_endian_textra_nothingcore( data );
    data += sizeof(textra_nothingcore);

    cv_cnv_endian_textra_delaycore( data );
    data += sizeof(textra_delaycore);

    cv_cnv_endian_textra90( data );
    data += sizeof(textra90);

    cv_cnv_endian_textra180( data );
    data += sizeof(textra180);

    cv_cnv_endian_textra( data );
    data += sizeof(textra);

    cv_cnv_endian_fat_chemshift( data );
    data += sizeof(fat_chemshift);
    ...
    cv_cnv_endian_a_gzrf1r( data );
    data += sizeof(a_gzrf1r);

    cv_cnv_endian_ia_gzrf1r( data );
    data += sizeof(ia_gzrf1r);

    cv_cnv_endian_pw_gzrf1ra( data );
    data += sizeof(pw_gzrf1ra);

    cv_cnv_endian_pw_gzrf1rd( data );
    data += sizeof(pw_gzrf1rd);

    cv_cnv_endian_pw_gzrf1r( data );
    data += sizeof(pw_gzrf1r);

    cv_cnv_endian_wg_gzrf1r( data );
    data += sizeof(wg_gzrf1r);

    cv_cnv_endian_a_gz180crush1( data );
    data += sizeof(a_gz180crush1);

    cv_cnv_endian_ia_gz180crush1( data );
    data += sizeof(ia_gz180crush1);

    cv_cnv_endian_pw_gz180crush1a( data );
    data += sizeof(pw_gz180crush1a);

    cv_cnv_endian_pw_gz180crush1d( data );
    data += sizeof(pw_gz180crush1d);

    cv_cnv_endian_pw_gz180crush1( data );
    data += sizeof(pw_gz180crush1);

    cv_cnv_endian_wg_gz180crush1( data );
    data += sizeof(wg_gz180crush1);
    ...
    cv_cnv_endian_a_gz180crush2( data );
    data += sizeof(a_gz180crush2);

    cv_cnv_endian_ia_gz180crush2( data );
    data += sizeof(ia_gz180crush2);

    cv_cnv_endian_pw_gz180crush2a( data );
    data += sizeof(pw_gz180crush2a);

    cv_cnv_endian_pw_gz180crush2d( data );
    data += sizeof(pw_gz180crush2d);

    cv_cnv_endian_pw_gz180crush2( data );
    data += sizeof(pw_gz180crush2);

    cv_cnv_endian_wg_gz180crush2( data );
    data += sizeof(wg_gz180crush2);

    cv_cnv_endian_a_gzphase1( data );
    data += sizeof(a_gzphase1);

    cv_cnv_endian_ia_gzphase1( data );
    data += sizeof(ia_gzphase1);

    cv_cnv_endian_pw_gzphase1a( data );
    data += sizeof(pw_gzphase1a);

    cv_cnv_endian_pw_gzphase1d( data );
    data += sizeof(pw_gzphase1d);

    cv_cnv_endian_pw_gzphase1( data );
    data += sizeof(pw_gzphase1);

    cv_cnv_endian_wg_gzphase1( data );
    data += sizeof(wg_gzphase1);

    cv_cnv_endian_pw_mapx( data );
    data += sizeof(pw_mapx);

    cv_cnv_endian_wg_mapx( data );
    data += sizeof(wg_mapx);

    cv_cnv_endian_pw_mapy( data );
    data += sizeof(pw_mapy);

    cv_cnv_endian_wg_mapy( data );
    data += sizeof(wg_mapy);

    cv_cnv_endian_pw_mapz( data );
    data += sizeof(pw_mapz);

    cv_cnv_endian_wg_mapz( data );
    data += sizeof(wg_mapz);

    cv_cnv_endian_pw_mapt( data );
    data += sizeof(pw_mapt);

    cv_cnv_endian_wg_mapt( data );
    data += sizeof(wg_mapt);

    cv_cnv_endian_a_gx( data );
    data += sizeof(a_gx);

    cv_cnv_endian_ia_gx( data );
    data += sizeof(ia_gx);

    cv_cnv_endian_pw_gx( data );
    data += sizeof(pw_gx);

    cv_cnv_endian_res_gx( data );
    data += sizeof(res_gx);

    cv_cnv_endian_a_gy( data );
    data += sizeof(a_gy);

    cv_cnv_endian_ia_gy( data );
    data += sizeof(ia_gy);

    cv_cnv_endian_pw_gy( data );
    data += sizeof(pw_gy);

    cv_cnv_endian_res_gy( data );
    data += sizeof(res_gy);

    cv_cnv_endian_pw_maps1( data );
    data += sizeof(pw_maps1);

    cv_cnv_endian_wg_maps1( data );
    data += sizeof(wg_maps1);

    cv_cnv_endian_filter_echo1( data );
    data += sizeof(filter_echo1);

    cv_cnv_endian_pw_mapx2( data );
    data += sizeof(pw_mapx2);

    cv_cnv_endian_wg_mapx2( data );
    data += sizeof(wg_mapx2);

    cv_cnv_endian_pw_mapy2( data );
    data += sizeof(pw_mapy2);

    cv_cnv_endian_wg_mapy2( data );
    data += sizeof(wg_mapy2);

    cv_cnv_endian_pw_mapz2( data );
    data += sizeof(pw_mapz2);

    cv_cnv_endian_wg_mapz2( data );
    data += sizeof(wg_mapz2);

    cv_cnv_endian_pw_mapt2( data );
    data += sizeof(pw_mapt2);

    cv_cnv_endian_wg_mapt2( data );
    data += sizeof(wg_mapt2);

    cv_cnv_endian_a_gx2( data );
    data += sizeof(a_gx2);

    cv_cnv_endian_ia_gx2( data );
    data += sizeof(ia_gx2);

    cv_cnv_endian_pw_gx2( data );
    data += sizeof(pw_gx2);

    cv_cnv_endian_res_gx2( data );
    data += sizeof(res_gx2);

    cv_cnv_endian_a_gy2( data );
    data += sizeof(a_gy2);

    cv_cnv_endian_ia_gy2( data );
    data += sizeof(ia_gy2);

    cv_cnv_endian_pw_gy2( data );
    data += sizeof(pw_gy2);

    cv_cnv_endian_res_gy2( data );
    data += sizeof(res_gy2);

    cv_cnv_endian_pw_maps2( data );
    data += sizeof(pw_maps2);

    cv_cnv_endian_wg_maps2( data );
    data += sizeof(wg_maps2);

    cv_cnv_endian_filter_echo2( data );
    data += sizeof(filter_echo2);

    cv_cnv_endian_pw_maps3( data );
    data += sizeof(pw_maps3);

    cv_cnv_endian_wg_maps3( data );
    data += sizeof(wg_maps3);

    cv_cnv_endian_a_gzphase2( data );
    data += sizeof(a_gzphase2);

    cv_cnv_endian_ia_gzphase2( data );
    data += sizeof(ia_gzphase2);

    cv_cnv_endian_pw_gzphase2a( data );
    data += sizeof(pw_gzphase2a);

    cv_cnv_endian_pw_gzphase2d( data );
    data += sizeof(pw_gzphase2d);

    cv_cnv_endian_pw_gzphase2( data );
    data += sizeof(pw_gzphase2);

    cv_cnv_endian_wg_gzphase2( data );
    data += sizeof(wg_gzphase2);

    cv_cnv_endian_ia_gxprew( data );
    data += sizeof(ia_gxprew);

    cv_cnv_endian_a_gxpre( data );
    data += sizeof(a_gxpre);

    cv_cnv_endian_ia_gxpre( data );
    data += sizeof(ia_gxpre);

    cv_cnv_endian_pw_gxpre( data );
    data += sizeof(pw_gxpre);

    cv_cnv_endian_res_gxpre( data );
    data += sizeof(res_gxpre);

    cv_cnv_endian_phs_gxpre( data );
    data += sizeof(phs_gxpre);

    cv_cnv_endian_phl_gxpre( data );
    data += sizeof(phl_gxpre);

    cv_cnv_endian_off_gxpre( data );
    data += sizeof(off_gxpre);

    cv_cnv_endian_wg_gxpre( data );
    data += sizeof(wg_gxpre);

    cv_cnv_endian_ia_gyprew( data );
    data += sizeof(ia_gyprew);

    cv_cnv_endian_a_gypre( data );
    data += sizeof(a_gypre);

    cv_cnv_endian_ia_gypre( data );
    data += sizeof(ia_gypre);

    cv_cnv_endian_pw_gypre( data );
    data += sizeof(pw_gypre);

    cv_cnv_endian_res_gypre( data );
    data += sizeof(res_gypre);

    cv_cnv_endian_phs_gypre( data );
    data += sizeof(phs_gypre);

    cv_cnv_endian_phl_gypre( data );
    data += sizeof(phl_gypre);

    cv_cnv_endian_off_gypre( data );
    data += sizeof(off_gypre);

    cv_cnv_endian_wg_gypre( data );
    data += sizeof(wg_gypre);

    cv_cnv_endian_a_BS0rf( data );
    data += sizeof(a_BS0rf);

    cv_cnv_endian_ia_BS0rf( data );
    data += sizeof(ia_BS0rf);

    cv_cnv_endian_pw_BS0rf( data );
    data += sizeof(pw_BS0rf);

    cv_cnv_endian_res_BS0rf( data );
    data += sizeof(res_BS0rf);

    cv_cnv_endian_off_BS0rf( data );
    data += sizeof(off_BS0rf);

    cv_cnv_endian_wg_BS0rf( data );
    data += sizeof(wg_BS0rf);

    cv_cnv_endian_a_BS0rf_theta( data );
    data += sizeof(a_BS0rf_theta);

    cv_cnv_endian_ia_BS0rf_theta( data );
    data += sizeof(ia_BS0rf_theta);

    cv_cnv_endian_pw_BS0rf_theta( data );
    data += sizeof(pw_BS0rf_theta);

    cv_cnv_endian_res_BS0rf_theta( data );
    data += sizeof(res_BS0rf_theta);

    cv_cnv_endian_off_BS0rf_theta( data );
    data += sizeof(off_BS0rf_theta);

    cv_cnv_endian_wg_BS0rf_theta( data );
    data += sizeof(wg_BS0rf_theta);

    cv_cnv_endian_a_gzBS0rfspoiler( data );
    data += sizeof(a_gzBS0rfspoiler);

    cv_cnv_endian_ia_gzBS0rfspoiler( data );
    data += sizeof(ia_gzBS0rfspoiler);

    cv_cnv_endian_pw_gzBS0rfspoilera( data );
    data += sizeof(pw_gzBS0rfspoilera);

    cv_cnv_endian_pw_gzBS0rfspoilerd( data );
    data += sizeof(pw_gzBS0rfspoilerd);

    cv_cnv_endian_pw_gzBS0rfspoiler( data );
    data += sizeof(pw_gzBS0rfspoiler);

    cv_cnv_endian_wg_gzBS0rfspoiler( data );
    data += sizeof(wg_gzBS0rfspoiler);

    cv_cnv_endian_a_rftag1( data );
    data += sizeof(a_rftag1);

    cv_cnv_endian_ia_rftag1( data );
    data += sizeof(ia_rftag1);

    cv_cnv_endian_pw_rftag1( data );
    data += sizeof(pw_rftag1);

    cv_cnv_endian_res_rftag1( data );
    data += sizeof(res_rftag1);

    cv_cnv_endian_off_rftag1( data );
    data += sizeof(off_rftag1);

    cv_cnv_endian_wg_rftag1( data );
    data += sizeof(wg_rftag1);

    cv_cnv_endian_a_gzrftag1( data );
    data += sizeof(a_gzrftag1);

    cv_cnv_endian_ia_gzrftag1( data );
    data += sizeof(ia_gzrftag1);

    cv_cnv_endian_pw_gzrftag1a( data );
    data += sizeof(pw_gzrftag1a);

    cv_cnv_endian_pw_gzrftag1d( data );
    data += sizeof(pw_gzrftag1d);

    cv_cnv_endian_pw_gzrftag1( data );
    data += sizeof(pw_gzrftag1);

    cv_cnv_endian_wg_gzrftag1( data );
    data += sizeof(wg_gzrftag1);

    cv_cnv_endian_a_gzrftag1r( data );
    data += sizeof(a_gzrftag1r);

    cv_cnv_endian_ia_gzrftag1r( data );
    data += sizeof(ia_gzrftag1r);

    cv_cnv_endian_pw_gzrftag1ra( data );
    data += sizeof(pw_gzrftag1ra);

    cv_cnv_endian_pw_gzrftag1rd( data );
    data += sizeof(pw_gzrftag1rd);

    cv_cnv_endian_pw_gzrftag1r( data );
    data += sizeof(pw_gzrftag1r);

    cv_cnv_endian_wg_gzrftag1r( data );
    data += sizeof(wg_gzrftag1r);

    cv_cnv_endian_a_gxrftag1( data );
    data += sizeof(a_gxrftag1);

    cv_cnv_endian_ia_gxrftag1( data );
    data += sizeof(ia_gxrftag1);

    cv_cnv_endian_pw_gxrftag1a( data );
    data += sizeof(pw_gxrftag1a);

    cv_cnv_endian_pw_gxrftag1d( data );
    data += sizeof(pw_gxrftag1d);

    cv_cnv_endian_pw_gxrftag1( data );
    data += sizeof(pw_gxrftag1);

    cv_cnv_endian_wg_gxrftag1( data );
    data += sizeof(wg_gxrftag1);

    cv_cnv_endian_a_gyrftag1( data );
    data += sizeof(a_gyrftag1);

    cv_cnv_endian_ia_gyrftag1( data );
    data += sizeof(ia_gyrftag1);

    cv_cnv_endian_pw_gyrftag1a( data );
    data += sizeof(pw_gyrftag1a);

    cv_cnv_endian_pw_gyrftag1d( data );
    data += sizeof(pw_gyrftag1d);

    cv_cnv_endian_pw_gyrftag1( data );
    data += sizeof(pw_gyrftag1);

    cv_cnv_endian_wg_gyrftag1( data );
    data += sizeof(wg_gyrftag1);

    cv_cnv_endian_a_rftag2( data );
    data += sizeof(a_rftag2);

    cv_cnv_endian_ia_rftag2( data );
    data += sizeof(ia_rftag2);

    cv_cnv_endian_pw_rftag2( data );
    data += sizeof(pw_rftag2);

    cv_cnv_endian_res_rftag2( data );
    data += sizeof(res_rftag2);

    cv_cnv_endian_off_rftag2( data );
    data += sizeof(off_rftag2);

    cv_cnv_endian_wg_rftag2( data );
    data += sizeof(wg_rftag2);

    cv_cnv_endian_a_gzrftag2( data );
    data += sizeof(a_gzrftag2);

    cv_cnv_endian_ia_gzrftag2( data );
    data += sizeof(ia_gzrftag2);

    cv_cnv_endian_pw_gzrftag2a( data );
    data += sizeof(pw_gzrftag2a);

    cv_cnv_endian_pw_gzrftag2d( data );
    data += sizeof(pw_gzrftag2d);

    cv_cnv_endian_pw_gzrftag2( data );
    data += sizeof(pw_gzrftag2);

    cv_cnv_endian_wg_gzrftag2( data );
    data += sizeof(wg_gzrftag2);

    cv_cnv_endian_a_gzrftag2r( data );
    data += sizeof(a_gzrftag2r);

    cv_cnv_endian_ia_gzrftag2r( data );
    data += sizeof(ia_gzrftag2r);

    cv_cnv_endian_pw_gzrftag2ra( data );
    data += sizeof(pw_gzrftag2ra);

    cv_cnv_endian_pw_gzrftag2rd( data );
    data += sizeof(pw_gzrftag2rd);

    cv_cnv_endian_pw_gzrftag2r( data );
    data += sizeof(pw_gzrftag2r);

    cv_cnv_endian_wg_gzrftag2r( data );
    data += sizeof(wg_gzrftag2r);

    cv_cnv_endian_a_gxrftag2( data );
    data += sizeof(a_gxrftag2);

    cv_cnv_endian_ia_gxrftag2( data );
    data += sizeof(ia_gxrftag2);

    cv_cnv_endian_pw_gxrftag2a( data );
    data += sizeof(pw_gxrftag2a);

    cv_cnv_endian_pw_gxrftag2d( data );
    data += sizeof(pw_gxrftag2d);

    cv_cnv_endian_pw_gxrftag2( data );
    data += sizeof(pw_gxrftag2);

    cv_cnv_endian_wg_gxrftag2( data );
    data += sizeof(wg_gxrftag2);

    cv_cnv_endian_a_gyrftag2( data );
    data += sizeof(a_gyrftag2);

    cv_cnv_endian_ia_gyrftag2( data );
    data += sizeof(ia_gyrftag2);

    cv_cnv_endian_pw_gyrftag2a( data );
    data += sizeof(pw_gyrftag2a);

    cv_cnv_endian_pw_gyrftag2d( data );
    data += sizeof(pw_gyrftag2d);

    cv_cnv_endian_pw_gyrftag2( data );
    data += sizeof(pw_gyrftag2);

    cv_cnv_endian_wg_gyrftag2( data );
    data += sizeof(wg_gyrftag2);

    cv_cnv_endian_a_rftag1c( data );
    data += sizeof(a_rftag1c);

    cv_cnv_endian_ia_rftag1c( data );
    data += sizeof(ia_rftag1c);

    cv_cnv_endian_pw_rftag1c( data );
    data += sizeof(pw_rftag1c);

    cv_cnv_endian_res_rftag1c( data );
    data += sizeof(res_rftag1c);

    cv_cnv_endian_off_rftag1c( data );
    data += sizeof(off_rftag1c);

    cv_cnv_endian_wg_rftag1c( data );
    data += sizeof(wg_rftag1c);

    cv_cnv_endian_a_gzrftag1c( data );
    data += sizeof(a_gzrftag1c);

    cv_cnv_endian_ia_gzrftag1c( data );
    data += sizeof(ia_gzrftag1c);

    cv_cnv_endian_pw_gzrftag1ca( data );
    data += sizeof(pw_gzrftag1ca);

    cv_cnv_endian_pw_gzrftag1cd( data );
    data += sizeof(pw_gzrftag1cd);

    cv_cnv_endian_pw_gzrftag1c( data );
    data += sizeof(pw_gzrftag1c);

    cv_cnv_endian_wg_gzrftag1c( data );
    data += sizeof(wg_gzrftag1c);

    cv_cnv_endian_a_gzrftag1rc( data );
    data += sizeof(a_gzrftag1rc);

    cv_cnv_endian_ia_gzrftag1rc( data );
    data += sizeof(ia_gzrftag1rc);

    cv_cnv_endian_pw_gzrftag1rca( data );
    data += sizeof(pw_gzrftag1rca);

    cv_cnv_endian_pw_gzrftag1rcd( data );
    data += sizeof(pw_gzrftag1rcd);

    cv_cnv_endian_pw_gzrftag1rc( data );
    data += sizeof(pw_gzrftag1rc);

    cv_cnv_endian_wg_gzrftag1rc( data );
    data += sizeof(wg_gzrftag1rc);

    cv_cnv_endian_a_gxrftag1c( data );
    data += sizeof(a_gxrftag1c);

    cv_cnv_endian_ia_gxrftag1c( data );
    data += sizeof(ia_gxrftag1c);

    cv_cnv_endian_pw_gxrftag1ca( data );
    data += sizeof(pw_gxrftag1ca);

    cv_cnv_endian_pw_gxrftag1cd( data );
    data += sizeof(pw_gxrftag1cd);

    cv_cnv_endian_pw_gxrftag1c( data );
    data += sizeof(pw_gxrftag1c);

    cv_cnv_endian_wg_gxrftag1c( data );
    data += sizeof(wg_gxrftag1c);

    cv_cnv_endian_a_gyrftag1c( data );
    data += sizeof(a_gyrftag1c);

    cv_cnv_endian_ia_gyrftag1c( data );
    data += sizeof(ia_gyrftag1c);

    cv_cnv_endian_pw_gyrftag1ca( data );
    data += sizeof(pw_gyrftag1ca);

    cv_cnv_endian_pw_gyrftag1cd( data );
    data += sizeof(pw_gyrftag1cd);

    cv_cnv_endian_pw_gyrftag1c( data );
    data += sizeof(pw_gyrftag1c);

    cv_cnv_endian_wg_gyrftag1c( data );
    data += sizeof(wg_gyrftag1c);

    cv_cnv_endian_a_rftag2c( data );
    data += sizeof(a_rftag2c);

    cv_cnv_endian_ia_rftag2c( data );
    data += sizeof(ia_rftag2c);

    cv_cnv_endian_pw_rftag2c( data );
    data += sizeof(pw_rftag2c);

    cv_cnv_endian_res_rftag2c( data );
    data += sizeof(res_rftag2c);

    cv_cnv_endian_off_rftag2c( data );
    data += sizeof(off_rftag2c);

    cv_cnv_endian_wg_rftag2c( data );
    data += sizeof(wg_rftag2c);

    cv_cnv_endian_a_gzrftag2c( data );
    data += sizeof(a_gzrftag2c);

    cv_cnv_endian_ia_gzrftag2c( data );
    data += sizeof(ia_gzrftag2c);

    cv_cnv_endian_pw_gzrftag2ca( data );
    data += sizeof(pw_gzrftag2ca);

    cv_cnv_endian_pw_gzrftag2cd( data );
    data += sizeof(pw_gzrftag2cd);

    cv_cnv_endian_pw_gzrftag2c( data );
    data += sizeof(pw_gzrftag2c);

    cv_cnv_endian_wg_gzrftag2c( data );
    data += sizeof(wg_gzrftag2c);

    cv_cnv_endian_a_gzrftag2rc( data );
    data += sizeof(a_gzrftag2rc);

    cv_cnv_endian_ia_gzrftag2rc( data );
    data += sizeof(ia_gzrftag2rc);

    cv_cnv_endian_pw_gzrftag2rca( data );
    data += sizeof(pw_gzrftag2rca);

    cv_cnv_endian_pw_gzrftag2rcd( data );
    data += sizeof(pw_gzrftag2rcd);

    cv_cnv_endian_pw_gzrftag2rc( data );
    data += sizeof(pw_gzrftag2rc);

    cv_cnv_endian_wg_gzrftag2rc( data );
    data += sizeof(wg_gzrftag2rc);

    cv_cnv_endian_a_gxrftag2c( data );
    data += sizeof(a_gxrftag2c);

    cv_cnv_endian_ia_gxrftag2c( data );
    data += sizeof(ia_gxrftag2c);

    cv_cnv_endian_pw_gxrftag2ca( data );
    data += sizeof(pw_gxrftag2ca);

    cv_cnv_endian_pw_gxrftag2cd( data );
    data += sizeof(pw_gxrftag2cd);

    cv_cnv_endian_pw_gxrftag2c( data );
    data += sizeof(pw_gxrftag2c);

    cv_cnv_endian_wg_gxrftag2c( data );
    data += sizeof(wg_gxrftag2c);

    cv_cnv_endian_a_gyrftag2c( data );
    data += sizeof(a_gyrftag2c);

    cv_cnv_endian_ia_gyrftag2c( data );
    data += sizeof(ia_gyrftag2c);

    cv_cnv_endian_pw_gyrftag2ca( data );
    data += sizeof(pw_gyrftag2ca);

    cv_cnv_endian_pw_gyrftag2cd( data );
    data += sizeof(pw_gyrftag2cd);

    cv_cnv_endian_pw_gyrftag2c( data );
    data += sizeof(pw_gyrftag2c);

    cv_cnv_endian_wg_gyrftag2c( data );
    data += sizeof(wg_gyrftag2c);

    cv_cnv_endian_a_BS1rf( data );
    data += sizeof(a_BS1rf);

    cv_cnv_endian_ia_BS1rf( data );
    data += sizeof(ia_BS1rf);

    cv_cnv_endian_pw_BS1rf( data );
    data += sizeof(pw_BS1rf);

    cv_cnv_endian_res_BS1rf( data );
    data += sizeof(res_BS1rf);

    cv_cnv_endian_off_BS1rf( data );
    data += sizeof(off_BS1rf);

    cv_cnv_endian_wg_BS1rf( data );
    data += sizeof(wg_BS1rf);

    cv_cnv_endian_a_BS1rf_theta( data );
    data += sizeof(a_BS1rf_theta);

    cv_cnv_endian_ia_BS1rf_theta( data );
    data += sizeof(ia_BS1rf_theta);

    cv_cnv_endian_pw_BS1rf_theta( data );
    data += sizeof(pw_BS1rf_theta);

    cv_cnv_endian_res_BS1rf_theta( data );
    data += sizeof(res_BS1rf_theta);

    cv_cnv_endian_off_BS1rf_theta( data );
    data += sizeof(off_BS1rf_theta);

    cv_cnv_endian_wg_BS1rf_theta( data );
    data += sizeof(wg_BS1rf_theta);

    cv_cnv_endian_a_BS2rf( data );
    data += sizeof(a_BS2rf);

    cv_cnv_endian_ia_BS2rf( data );
    data += sizeof(ia_BS2rf);

    cv_cnv_endian_pw_BS2rf( data );
    data += sizeof(pw_BS2rf);

    cv_cnv_endian_res_BS2rf( data );
    data += sizeof(res_BS2rf);

    cv_cnv_endian_off_BS2rf( data );
    data += sizeof(off_BS2rf);

    cv_cnv_endian_wg_BS2rf( data );
    data += sizeof(wg_BS2rf);

    cv_cnv_endian_a_BS2rf_theta( data );
    data += sizeof(a_BS2rf_theta);

    cv_cnv_endian_ia_BS2rf_theta( data );
    data += sizeof(ia_BS2rf_theta);

    cv_cnv_endian_pw_BS2rf_theta( data );
    data += sizeof(pw_BS2rf_theta);

    cv_cnv_endian_res_BS2rf_theta( data );
    data += sizeof(res_BS2rf_theta);

    cv_cnv_endian_off_BS2rf_theta( data );
    data += sizeof(off_BS2rf_theta);

    cv_cnv_endian_wg_BS2rf_theta( data );
    data += sizeof(wg_BS2rf_theta);
    ...
    cv_cnv_endian_a_gz0( data );
    data += sizeof(a_gz0);

    cv_cnv_endian_ia_gz0( data );
    data += sizeof(ia_gz0);

    cv_cnv_endian_pw_gz0a( data );
    data += sizeof(pw_gz0a);

    cv_cnv_endian_pw_gz0d( data );
    data += sizeof(pw_gz0d);

    cv_cnv_endian_pw_gz0( data );
    data += sizeof(pw_gz0);

    cv_cnv_endian_wg_gz0( data );
    data += sizeof(wg_gz0);

    cv_cnv_endian_ia_trigon( data );
    data += sizeof(ia_trigon);

    cv_cnv_endian_ia_trigoff( data );
    data += sizeof(ia_trigoff);

    cv_cnv_endian_pw_TRdelay( data );
    data += sizeof(pw_TRdelay);

    cv_cnv_endian_wg_TRdelay( data );
    data += sizeof(wg_TRdelay);

    cv_cnv_endian_pw_waitStart( data );
    data += sizeof(pw_waitStart);

    cv_cnv_endian_wg_waitStart( data );
    data += sizeof(wg_waitStart);

    cv_cnv_endian_pw_waitEnd( data );
    data += sizeof(pw_waitEnd);

    cv_cnv_endian_wg_waitEnd( data );
    data += sizeof(wg_waitEnd);
    ...
    cv_cnv_endian_Gx( data );
    data += sizeof(Gx);

    cv_cnv_endian_Gy( data );
    data += sizeof(Gy);
...
#endif /* h_pcasl3dgrase01_cvcopy_cpp */
