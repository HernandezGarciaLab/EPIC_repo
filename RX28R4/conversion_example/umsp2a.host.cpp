...
#include "umsp2a.hostdecl.h"
#include "umsp2a.exportstr.h"
#include "umsp2a.runtime.h"
...
#include "cvinit.in"	/* Runs the code generated by macros in preproc.*/
    ...
    cvmax(oprbw, 250);		
    cvdef(oprbw, 125);		
    oprbw  = _oprbw.fixedflag ?  ((void)(125.), oprbw) : 125.;		
...
/* label FOV buttons */
    ...
    if (opuser5 > 0.5) {
      nextra  = _nextra.fixedflag ?  ((void)(opuser5-1), nextra) : opuser5-1;
      nframes  = _nframes.fixedflag ?  ((void)(opuser1+1), nframes) : opuser1+1;
    } else {
    ...
    cvdef(opuser6, 2);
    opuser6  = _opuser6.fixedflag ?  ((void)(2), opuser6) : 2;
    cvmin(opuser6, 0);
    cvmax(opuser6, 2);
    ...
    switch ((int)opuser16)  {
      case 0:           
        ...
        break;
      case 1:
        slord  = _slord.fixedflag ?  ((void)(TYPNCAT), slord) : TYPNCAT;
        break;
    }
...
/*  figure out some params depending on system/grads  */
    gamp  = _gamp.fixedflag ?  ((void)(loggrd.xfs), gamp) : loggrd.xfs;
    gslew  = _gslew.fixedflag ?  ((void)(MIN(cfsrmode,150.0)), gslew) : MIN(cfsrmode,150.0);   /* can't use it all  */

    if((fpin=fopen("daqdeloff.sprl", "r"))) {     /* look for ext. file */
      fscanf(fpin, "%f", _daqdeloff.fixedflag ? (_temp0_daqdeloff=daqdeloff,&_temp0_daqdeloff) : &daqdeloff);
      fscanf(fpin, "%f", _daqdelrev.fixedflag ? (_temp1_daqdelrev=daqdelrev,&_temp1_daqdelrev) : &daqdelrev);
      fclose(fpin);
    }  
/*  try to make tr check */
    ...
    tmin  = _tmin.fixedflag ?           
        ...
        ((void)(RUP_GRD(tlead+pw_rf0+pw_gz0+2*pw_gz0a+pw_gzrf1a+pw_rf1/2+opte+pw_gx+daqdel+mapdel+pw_gzspoil+2*pw_gzspoila)+timessi), tmin) : RUP_GRD(tlead+pw_rf0+pw_gz0+2*pw_gz0a+pw_gzrf1a+pw_rf1/2+opte+pw_gx+daqdel+mapdel+pw_gzspoil+2*pw_gzspoila)+timessi;
    ...
    psdseqtime  = _psdseqtime.fixedflag ?         ((void)((scluster==0)?RUP_GRD(optr/opslquant):tmin+460), psdseqtime) : (scluster==0)?RUP_GRD(optr/opslquant):tmin+460;	/* add some time */
...
/* adjust grads, tsp, to reflect bandwidth  */
    ...
    calcvalidrbw((double)oprbw,_bandwidth.fixedflag ? (_temp2_bandwidth=bandwidth,&_temp2_bandwidth) : &bandwidth,&max_rbw,_decimation.fixedflag ? (_temp3_decimation=decimation,&_temp3_decimation) : &decimation,OVERWRITE_OPRBW,0);
...
/* set up RF pulse  */
    a_rf1  = _a_rf1.fixedflag ?  ((void)(cyc_rf1*(6400/pw_rf1)*opflip/360), a_rf1) : cyc_rf1*(6400/pw_rf1)*opflip/360;
...
/*  spoilers to return the readout grads to a constant state  */
    ...
    pw_gzspoil  = _pw_gzspoil.fixedflag ?    ((void)(800), pw_gzspoil) : 800;
    a_gzspoil  = _a_gzspoil.fixedflag ?  ((void)(.5*loggrd.zfs), a_gzspoil) : .5*loggrd.zfs;
    ...
    minte  = _minte.fixedflag ?    ((void)(pw_rf1/2+pw_gzrf1d+pw_gz2+2*pw_gz2a), minte) : pw_rf1/2+pw_gzrf1d+pw_gz2+2*pw_gz2a;
    ...
    rhuser16  = _rhuser16.fixedflag ?  ((void)(nextra), rhuser16) : nextra;  /* number of disdaqs */
    rhuser19  = _rhuser19.fixedflag ?    ((void)(opuser5-nextra), rhuser19) : opuser5-nextra; /* =1 if map acq is part of disdaq */
    rhuser20  = _rhuser20.fixedflag ?  ((void)(alpha), rhuser20) : alpha;	/* for vd trajectory  */
    rhuser21  = _rhuser21.fixedflag ?  ((void)(gtype), rhuser21) : gtype; /* for compatability */
    ...
    rhuser32 = _rhuser32.fixedflag ? ((void)(daqdeloff), rhuser32) : daqdeloff;
    rhuser33 = _rhuser33.fixedflag ? ((void)(daqdelrev), rhuser33) : daqdelrev; 
...
/* set up receiver */
   ...
   initfilter();
    ...
    daqdel  = _daqdel.fixedflag ?      ((void)(psd_grd_wait+daqdelrev+0.5), daqdel) : psd_grd_wait+daqdelrev+0.5;
    daqdel2  = _daqdel2.fixedflag ?      ((void)(psd_grd_wait+daqdeloff+0.5), daqdel2) : psd_grd_wait+daqdeloff+0.5;
    if (gtype == 0) daqdel  = _daqdel.fixedflag ?      ((void)(psd_grd_wait+daqdeloff+0.5), daqdel) : psd_grd_wait+daqdeloff+0.5;
...
{ /* Start of code inlined from Prescan.e PSpredownload */
    ...
    phys_record_channelsel  = _phys_record_channelsel.fixedflag ?  ((void)(15), phys_record_channelsel) : 15;        /* PG wave,trig & RESP */
