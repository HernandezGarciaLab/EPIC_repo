...
#ifndef h_umsp2a_allcv_h
#define h_umsp2a_allcv_h
...
float daqdeloff = 0.0  ; /* MR750 */
float daqdelrev = 5.0  ; /* MR750 - reverse spiral has diff delay */
int daqdel = 128  ; /*  gradient delay vs readout */
int daqdel2 = 128  ; /*  gradient delay vs readout */
int thetdeloff = 0  ;
int espace = 140   ;
