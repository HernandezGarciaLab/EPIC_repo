 ...
 * these variables.
 *
 * Generated on Mon Jun 21 21:26:56 2021 
 */

#ifndef h_umsp2a_cvcopy_cpp
#define h_umsp2a_cvcopy_cpp

#include "cvcopy_proto.h"

#if defined(PSD_HW) && defined(HOST_TGT)
/* Include endian converter functions */
#include "umsp2a.cnvendian.globalvar.h"
#include "umsp2a.cnvendian.c"
...
static const cvcopy_table_entry cvcopy_table[] = {
    ...
    { &daqdelrev, sizeof(daqdelrev) },
    { &daqdel, sizeof(daqdel) },
    { &daqdel2, sizeof(daqdel2) },
    ...
    { &a_gz2, sizeof(a_gz2) },
    { &ia_gz2, sizeof(ia_gz2) },
    { &pw_gz2a, sizeof(pw_gz2a) },
    { &pw_gz2d, sizeof(pw_gz2d) },
    { &pw_gz2, sizeof(pw_gz2) },
    { &wg_gz2, sizeof(wg_gz2) },
...
void cvcopy_cnv_endian( char * data )
{
    ...
    cv_cnv_endian_daqdelrev( data );
    data += sizeof(daqdelrev);

    cv_cnv_endian_daqdel( data );
    data += sizeof(daqdel);

    cv_cnv_endian_daqdel2( data );
    data += sizeof(daqdel2);
    ...
    cv_cnv_endian_a_gz2( data );
    data += sizeof(a_gz2);

    cv_cnv_endian_ia_gz2( data );
    data += sizeof(ia_gz2);

    cv_cnv_endian_pw_gz2a( data );
    data += sizeof(pw_gz2a);

    cv_cnv_endian_pw_gz2d( data );
    data += sizeof(pw_gz2d);

    cv_cnv_endian_pw_gz2( data );
    data += sizeof(pw_gz2);

    cv_cnv_endian_wg_gz2( data );
    data += sizeof(wg_gz2);
