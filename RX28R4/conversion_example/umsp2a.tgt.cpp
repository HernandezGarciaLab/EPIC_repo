 ...
 */
        
  {
    ...
    if ((wg_rf0==TYPRHO1)||(wg_rf0==TYPRHO2) ||
      ...
      {
        createinstr( &rf0,(long)(tlead),
                    pw_rf0,ia_rf0);
        addrfbits(&rf0,off_rf0,(long)(tlead),
                  pw_rf0);
      }
    else
      {
    ...
    trapezoid((WF_PROCESSOR)wg_gz0, "gz0", &gz0, &gz0a,
              ...
              ia_gz0, 0, 0, 0, 0, pend(&rf0,"rf0",0)+pw_gz0a-pw_gz0a, TRAP_ALL,
              &loggrd);
          ...
          
    {
        ...
        createinstr( &gzrf1a,(long)(pend(&gz0d,"gz0d",0)+pw_gzrf1a-pw_gzrf1a),
                     pw_gzrf1a,ia_gzrf1);
        createconst(&gzrf1,ZGRAD,pw_gzrf1,MAX_PG_WAMP);
        createinstr( &gzrf1,(long)(pend(&gz0d,"gz0d",0)+pw_gzrf1a),
                     pw_gzrf1,ia_gzrf1);
        createramp(&gzrf1d,ZGRAD,pw_gzrf1d,MAX_PG_WAMP,
                   (short)0,(short)(maxGradRes*(pw_gzrf1d/GRAD_UPDATE_TIME)),
                   pg_beta);
        createinstr( &gzrf1d,(long)(pend(&gz0d,"gz0d",0)+pw_gzrf1a+pw_gzrf1),
                     pw_gzrf1d,ia_gzrf1);

        /* Now create the rf pulse */
        createsinc(&rf1,(WF_PROCESSOR)wg_rf1,res_rf1,
                   MAX_PG_WAMP,cyc_rf1, alpha_rf1);
        createinstr( &rf1,(long)(pend(&gz0d,"gz0d",0)+pw_gzrf1a) + psd_rf_wait,
                     pw_rf1,ia_rf1);
        linkpulses(4,&rf1,&gzrf1,&gzrf1a,
                   &gzrf1d);
        addrfbits(&rf1,off_rf1,(long)(pend(&gz0d,"gz0d",0)+pw_gzrf1a) + psd_rf_wait,
                  pw_rf1);
    }

           

    setWaveformPurpose(gz2a, gz2.purpose);
    setWaveformPurpose(gz2d, gz2.purpose);
    trapezoid((WF_PROCESSOR)wg_gz2, "gz2", &gz2, &gz2a,
              &gz2d, pw_gz2, pw_gz2a, pw_gz2d,
              ia_gz2, 0, 0, 0, 0, RUP_GRD(pend(&gzrf1d,"gzrf1d",0)+pw_gz2a)-pw_gz2a, TRAP_ALL,
              &loggrd);
           ...
           
  {
      ...
      
    {
        ...
        acqq(&echo1, (long)(daqpos+daqdel),(long)(DEFAULTPOS),
...
/* spiral out as echo 2 */
             ...
             
  {
        ...
        
    {
        ...
        acqq(&echo2, (long)(readpos+daqdel2),(long)(DEFAULTPOS),
       ...
       
  {
    ...
    createinstr( &maps3,(long)(waitloc2+daqdel+20  ),pw_maps3,0);
  }
...
/* Fov offset  */
    ...
    trapezoid((WF_PROCESSOR)wg_gzspoil, "gzspoil", &gzspoil, &gzspoila,
              ...
              ia_gzspoil, 0, 0, 0, 0, RUP_GRD(waitloc2+pw_gzspoila)-pw_gzspoila, TRAP_ALL,
              &loggrd);
...
/*  make a little trig on DABOUT6 J12  */
    ...
    
  {
    ...
    createseq(&seqcore,psdseqtime-timessi, off_seqcore);
#if defined(HOST_TGT)
